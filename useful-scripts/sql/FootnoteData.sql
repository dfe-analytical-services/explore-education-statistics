...
VALUES (@footnote_id_1, 'State-funded primary schools include all primary academies, including free schools.', @absence_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_2,
        'State-funded secondary schools include city technology colleges and all secondary academies, including all-through academies and free schools.', @absence_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_3,
        'Special schools include maintained special schools, non-maintained special schools and special academies.  Excludes general hospital schools, independent special schools and independent schools approved for SEN pupils.', @absence_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_4, 'x - 1 or 2 enrolments, or a percentage based on 1 or 2 enrolments.', @absence_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_5,
        'There may be discrepancies between totals and the sum of constituent parts  as national and regional totals and totals across school types have been rounded to the nearest 5.', @absence_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_6,
        'Absence rates are the number of absence sessions expressed as a percentage of the total number of possible sessions.', @absence_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_7,
        'Pupil enrolments missing 10 percent or more of their own possible sessions (due to authorised or unauthorised absence) are classified as persistent absentees.', @absence_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_8,
        'The definition of persistent absence changed from the 2015/16 academic year - The information presented for years prior to 2015/16 has been produced using the same methodology in order to allow users to make comparisons on a consistent basis over time.', @absence_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_9,
        'The persistent absentee rate is the number of persistent absentees expressed as a percentage of the total number of enrolments.', @absence_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_10,
        'Number of enrolments includes pupils on the school roll for at least one session who are aged between 5 and 15, excluding boarders. Some pupils may be counted more than once (if they moved schools during the academic year or are registered in more than one school).', @absence_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_11, 'The number of enrolments with one or more session of absence for specific reason.', @absence_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_12,
        'The number of sessions missed in each band expressed as a percentage of the total number of sessions missed for that category of absence overall.', @absence_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_13, 'Includes all schools with at least six enrolments who reported absence information via the school census for the associated academic year.', @absence_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_14,
        'See "Guide to absence statistics" for more information on how absence and pupil characteristic data have been linked.', @absence_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_15,
        'Figures for pupils with unclassified or missing characteristics information should be interpreted with caution.', @absence_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_16,
        'In September 2014 the Special Educational Needs and Disability (SEND) provisions were introduced in the Children and Families Act 2014. This reform caused changes to SEN categories - Education, Health and Care (EHC) plans were introduced and SEN support replaces school action and school action plus but some pupils remain with these provision types in first year of transition (2014/15).', @absence_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_17,
        'Minority ethnic group includes pupils who have been classified according to their ethnic group, excluding White British.', @absence_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_18,
        'From 2015 SEN support replaced school action and School Action plus but some pupils remain with these provision types. Those who were formerly School Action did not provide type of need in previous years. Those who remain on school action provision are not included here but have been included within the SEN support category in other tables.', @absence_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_19,
        'Social Emotional and Mental Health was added as a new type of need in 2015, the previous type of need Behaviour, Emotional and Social Difficulties has been removed although it is not expected it should be a direct replacement.', @absence_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_20,
        'Includes pupils on the school roll for at least one session who are aged 4, excluding boarders. Some pupils may be counted more than once (if they moved schools during the academic year or are registered at more than one school).', @absence_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_21,
        'Only overall absence is recorded for pupils aged 4, absences are not categorised as authorised or unauthorised.', @absence_release);
...
VALUES (@footnote_id_22,
        'The number of permanent exclusions expressed as a percentage of the number of pupils in January each year.', @exclusions_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_23,
        'The number of pupil enrolments receiving one or more fixed period exclusion expressed as a percentage of the number of pupils in January each year.', @exclusions_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_24,
        'The number of fixed period exclusions expressed as a percentage of the number of pupils in January each year.', @exclusions_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_25,
        'Includes pupils who are sole or dual main registrations. Includes boarding pupils.', @exclusions_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_26,
        'SEN status is as recorded at the time of exclusion. For enrolments the SEN status at the time of the most recent exclusion is used.', @exclusions_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_27,
        'Education, Health and Care (EHC) plans were introduced from September 2014 as part of a range of SEND reforms.', @exclusions_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_28,
        'Figures are presented for pupils with a Statement of SEN, Education, Health and Care plan or SEN support and recorded primary need. This excludes those with SEN support who are yet to be assessed for a type of need and those with school action provision. SEN status is as recorded at the time of exclusion. For enrolments the SEN status at the time of the most recent exclusion is used.', @exclusions_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_29,
        'For enrolments the national curriculum year of the most recent exclusion is used.', @exclusions_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_30,
        'Free school meal eligibility as at January each year.', @exclusions_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_31,
        'Pupils who have been classified according to their ethnic group, excluding White British.', @exclusions_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_32,
        'Ethnic group is at January each year.', @exclusions_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_33,
        'Includes pupils whose ethnic information was not sought or was refused or could not be determined.', @exclusions_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_34,
        'Income Deprivation Affecting Children Index at Super Output Area level based on the location of the school. Includes all schools which returned information on exclusions.', @exclusions_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_35,
        'Length of exclusion in days is derived from the number of sessions where one session equates to half a school day. Part days have been counted as one school day.', @exclusions_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_36,
        'The number of open schools as at January plus the number of schools which opened after January but reported exclusions.', @exclusions_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_37,
        'State-funded primary schools include all primary academies, including free schools.', @exclusions_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_38,
        'State-funded secondary schools include city technology colleges and all secondary academies, including all-through academies and free schools.', @exclusions_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_39,
        'Special schools include maintained special schools, non-maintained special schools and special academies. Excludes general hospital schools.', @exclusions_release);

INSERT INTO Footnote (Id, Content, ReleaseId)
VALUES (@footnote_id_40,
        'x - 1 or 2 pupils, or a percentage based on 1 or 2.', @exclusions_release);
