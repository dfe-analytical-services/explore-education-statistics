...
ap.add_argument(
    "-f", "--file", required=True, help="the datablocks csv to use to generate the robot test script from the template"
)
...
with open(
    ...
    logger.warn(generated_test_script)
