...
*** Variables ***
${DETAILS_HEADING}  Academic Year Q1 2020/21
${PUBLICATION_NAME}  Publish Release and Amend 2 Publication %{RUN_IDENTIFIER}
${SUBJECT_NAME}  SevenFiltersTestSubject
${SECOND_SUBJECT}  Upload file test subject
${METHODOLOGY_NAME}  newMethodology-%{RUN_IDENTIFIER}
...
Select "SevenFiltersTestSubject" subject
    [Tags]  HappyPath
...
Edit methodology
    ...
    user clicks link  Manage content
    user waits until page contains button  ${METHODOLOGY_NAME}
