...
Delete subject files
    [Tags]  HappyPath
    user goes to url  https://localhost:5021/publication/61962739-bc9b-485e-fcfc-08d881046362/release/a6e7300d-c9d1-4201-b37b-ff212406e829/data#data-uploads
    # NOTE: DO NOT REMOVE SLEEP ELSE THIS TEST BREAKS
    # get element is not interacble
    # Watching the test locally and Delete files is clearly visible
    # however on the screenshot that seleneium captures the Delete files button is clearly not visible
    Sleep  5
    user opens accordion section  Dates test subject-123
    Execute Javascript  window.scrollTo(0, 6000)
    Sleep  5
    user waits until button is enabled  Delete files
