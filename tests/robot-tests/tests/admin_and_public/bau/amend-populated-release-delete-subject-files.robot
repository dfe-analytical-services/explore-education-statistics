...
${PUBLICATION_NAME}  delete content UI test Publication %{RUN_IDENTIFIER}
${TOPIC_NAME}  %{TEST_TOPIC_NAME}
${SUBJECT_NAME}   Delete content subject
...
Delete subject files
    ...
    user opens accordion section  Delete content subject
    user clicks button  Delete files
    user clicks button  Confirm

Approve & publish the release
    [Tags]  HappyPath
    user clicks link  Release status
    user clicks button  Edit release status
    user waits until h2 is visible  Edit release status
