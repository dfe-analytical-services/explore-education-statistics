...
Verify newly published release is on Find Statistics page
    ...
    user waits until accordion section contains text   %{TEST_THEME_NAME}   %{TEST_TOPIC_NAME}  %{WAIT_120_SECONDS}

    user opens details dropdown  %{TEST_TOPIC_NAME}
    user waits until details dropdown contains publication    %{TEST_TOPIC_NAME}  ${PUBLICATION_NAME}   %{WAIT_120_SECONDS}
...
Navigate to data replacement page
    [Tags]  HappyPath
    user clicks link  Data and files
    user waits until h2 is visible  Uploaded data files  %{WAIT_120_SECONDS}
    user waits until page contains accordion section   Dates test subject
    user opens accordion section   Dates test subject
    ...
    user checks headed table body row contains  Status           Complete   wait=%{WAIT_180_SECONDS}

Upload replacement data
    [Tags]  HappyPath
    user waits until h2 is visible  Upload replacement data  %{WAIT_120_SECONDS}
    ...
    user checks headed table body row cell contains  Status          1  Data replacement in progress   wait=%{WAIT_180_SECONDS}
    ...
    user checks headed table body row cell contains  Status          2  Complete   wait=%{WAIT_180_SECONDS}
