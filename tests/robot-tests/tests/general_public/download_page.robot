...
Validate Pupil absence data downloads are available
    ...
    user checks page contains link with text and url  All files  %{CONTENT_API_URL}/download/pupil-absence-in-schools-in-england/2016-17/ancillary/pupil-absence-in-schools-in-england_2016-17.zip
...
Validate Exclusions data downloads are available
    ...
    user checks page contains link with text and url  All files  %{CONTENT_API_URL}/download/permanent-and-fixed-period-exclusions-in-england/2016-17/ancillary/permanent-and-fixed-period-exclusions-in-england_2016-17.zip
