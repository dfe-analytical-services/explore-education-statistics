...
Open and validate "COVID-19" accordion section
    ...
    user waits until accordion section contains text    COVID-19
    ...    Confirmed cases reported by Higher Education providers
...
Open and validate "School and college outcomes and performance" accordion section
    ...
    user waits until accordion section contains text    School and college outcomes and performance
    ...    16 to 19 attainment
...
Open and validate "UK education and training statistics" accordion section
    ...
    user waits until accordion section contains text    UK education and training statistics
