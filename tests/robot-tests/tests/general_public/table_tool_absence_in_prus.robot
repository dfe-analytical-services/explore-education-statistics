...
Validate "Absence in prus" subject details
    [Tags]  HappyPath
    user opens details dropdown  More details  testid:Radio item for Absence in prus
    ${details}=  user gets details content element  More details  testid:Radio item for Absence in prus
