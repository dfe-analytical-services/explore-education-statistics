...
Validate Extra Information section headings
    [Tags]  HappyPath
    user waits until page contains element  css:[data-testid="extra-information"]+div [data-testid="SectionHeader Pupil absence data and statistics for schools in England: methodology"]
