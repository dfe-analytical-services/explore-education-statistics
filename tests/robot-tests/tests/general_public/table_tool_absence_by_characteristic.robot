...
Reorder Gender male and Gender female to be column
    [Tags]  HappyPath
...
Reorder Gender female to be first
    [Tags]  HappyPath
...
Validate Gender female rows after reordering
    [Tags]  HappyPath
    ...
    user checks results table cell contains  2    1     4.5%
    user checks results table cell contains  2    2     4.6%
    user checks results table cell contains  2    3     4.5%
    user checks results table cell contains  2    4     5.3%
...
Validate Gender male rows after reordering
    [Tags]  HappyPath
    # Unauthorised absence rate
    ...
    # Overall absence rate
    user checks results table cell contains  5    1     4.5%
    user checks results table cell contains  5    2     4.6%
    user checks results table cell contains  5    3     4.6%
    user checks results table cell contains  5    4     5.2%

    # Authorised absence rate
    user checks results table cell contains  6    1     3.4%
    user checks results table cell contains  6    2     3.6%
    user checks results table cell contains  6    3     3.5%
    user checks results table cell contains  6    4     4.2%

Validate Gender female Authorised absence rate row after reordering
