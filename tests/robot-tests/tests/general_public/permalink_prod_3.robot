...
Validate miscellaneous
    ...
    user waits until element contains  testid:dataTableCaption  Table showing 'Exclusions by geographic level' in Barking and Dagenham and Barnet between 2014/15 and 2016/17
