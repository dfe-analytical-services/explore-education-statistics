...
Check can see the "Add or remove publication contributors" functionality of the "Team access" page
    user waits until page contains link    Add or remove publication contributors
