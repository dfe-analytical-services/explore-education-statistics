...
Force Tags          Admin    Local    AltersData    Dev
...
Validate changing data sets
    ...
    user checks chart inline legend item contains    id:chartBuilderPreview    Admission Numbers(Syon)
    user checks chart inline legend item contains    id:chartBuilderPreview    Admission Numbers(Barnsley)
...
Validate line chart embeds correctly
    ...
    user checks chart inline legend item contains    ${datablock}    Admission Numbers(Nailsea Youngwood)
