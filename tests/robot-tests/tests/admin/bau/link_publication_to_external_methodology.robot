...
Link Publication to External Methodology
    ...
    ${accordion}=  user opens publication on the admin dashboard   ${PUBLICATION_NAME}
    user checks page contains link with text and url  ${PUBLICATION_NAME} (external methodology)  https://example.com  ${accordion}
...
Edit the External Methodology of the Publication
    ...
    ${accordion}=  user opens publication on the admin dashboard   ${PUBLICATION_NAME}
    user checks page contains link with text and url    ${PUBLICATION_NAME} updated (external methodology)  https://example.com/updated  ${accordion}
