...
${METHODOLOGY_CONTENT_ACCORDION}=       xpath://div[div[div[@id="methodologyAccordion-content"]]]
${METHODOLOGY_ANNEXES_ACCORDION}=       xpath://div[div[div[@id="methodologyAccordion-annexes"]]]
...
Update Methodology Content
    ...
    user creates new content section    1    Methodology content section 1    ${METHODOLOGY_CONTENT_ACCORDION}
    user adds text block to editable accordion section    Methodology content section 1
    ...    ${METHODOLOGY_CONTENT_ACCORDION}
    user adds content to accordion section text block    Methodology content section 1    1
    ...    Adding Methodology content    ${METHODOLOGY_CONTENT_ACCORDION}
    user adds image to accordion section text block    Methodology content section 1    1    test-infographic.png
    ...    Alt text for the uploaded content image    ${METHODOLOGY_CONTENT_ACCORDION}

    user creates new content section    1    Methodology annex section 1    ${METHODOLOGY_ANNEXES_ACCORDION}
    user adds text block to editable accordion section    Methodology annex section 1    ${METHODOLOGY_ANNEXES_ACCORDION}
    user adds content to accordion section text block    Methodology annex section 1    1    Adding Methodology annex
    ...    ${METHODOLOGY_ANNEXES_ACCORDION}
    user adds image to accordion section text block    Methodology annex section 1    1    dfe-logo.jpg
    ...    Alt text for the uploaded annex image    ${METHODOLOGY_ANNEXES_ACCORDION}
