...
Navigate to Manage data tab
    [Tags]  HappyPath
    user waits until page contains element   xpath://a[text()="Manage data"]
...
Navigate to File uploads tab
    [Tags]  HappyPath
    user waits until page contains element   xpath://a[text()="File uploads"]
    user clicks element  xpath://a[text()="File uploads"]
