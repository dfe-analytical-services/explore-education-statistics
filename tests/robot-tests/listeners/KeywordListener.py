...
class KeywordListener:
    ...
    def start_keyword(self, name, attributes):
        if attributes["type"].lower() == "keyword" and not attributes["libname"] in ["BuiltIn", "SeleniumLibrary"] and not attributes["source"] is None:
            ...
            print(f'\033[94m\tfile://{attributes["source"]} line {attributes["lineno"]}\t{attributes["kwname"]}\t\t{args_and_value_string}')
