...
parser.add_argument("--enable-slack", dest="enable_slack", action="store_true", required=False)
...
parser.add_argument(
    "--fail-fast", dest="fail_fast", action="store_true", help="stop test execution on failure", required=False
)
...
"""
parser.add_argument(
    "--slack-webhook-url", dest="slack_webhook_url", default=None, help="URL for Slack webhook", required=False
)

parser.add_argument(
    "--admin-pass", dest="admin_pass", default=None, help="manually specify the admin password", required=False
)

parser.add_argument(
    "--analyst-pass", dest="analyst_pass", default=None, help="manually specify the analyst password", required=False
)
