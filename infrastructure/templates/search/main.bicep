...
module searchDocsFunctionAppModule 'application/searchDocsFunctionApp.bicep' = {
  ...
  params: {
    ...
    searchDocumentsContainerName: searchServiceModule.outputs.searchStorageDocumentContainerNames.searchDocuments
...
output searchDocumentsContainerName string = searchServiceModule.outputs.searchStorageDocumentContainerNames.searchDocuments
output nlSearchDocumentsContainerName string = searchServiceModule.outputs.searchStorageDocumentContainerNames.nlSearchDocuments
output nlDatasetSearchDocumentsContainerName string = searchServiceModule.outputs.searchStorageDocumentContainerNames.nlDatasetSearchDocuments
