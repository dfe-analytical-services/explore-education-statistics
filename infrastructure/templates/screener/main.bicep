...
@description('Does the Screener API Function need creating or updating?')
param deployScreenerFunctionApp bool = false
...
module screenerFunctionAppModule 'application/screenerContainerisedFunctionApp.bicep' = if (deployScreenerFunctionApp) {
...
output screener_endpoint string = deployScreenerFunctionApp ? screenerFunctionAppModule.outputs.screener_endpoint : ''
