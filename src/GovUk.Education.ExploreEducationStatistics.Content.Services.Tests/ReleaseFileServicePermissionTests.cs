...
public class ReleaseFileServicePermissionTests
{
    ...
    public async Task StreamFile()
    {
        await PolicyCheckBuilder<ContentSecurityPolicies>()
            ...
            {
                var persistenceHelper = MockPersistenceHelper<ContentDbContext, ReleaseFile>(
                    ReleaseFile
                );
    ...
    {
        return MockPersistenceHelper<ContentDbContext, ReleaseVersion>(
            ReleaseVersion.Id,
            ReleaseVersion
        );
    }
