...
const PrototypeMethodologySection = () => {
  return (
    <>
      ...
      <p>
        This might include duplicates if schools have recorded duplicated
        pupils.
      </p>
      <p>
      ...
      <p>
        It's a school's responsibility to record absence data correctly in their
        school census return and the parent's responsibility to truthfully
