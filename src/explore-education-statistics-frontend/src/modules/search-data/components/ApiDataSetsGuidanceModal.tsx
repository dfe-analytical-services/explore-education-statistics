    ...
    >
      ...
      <ul>
        ...
        <li>
          ...
          optimised for API access. Note that while many data sets are available
          via the API, some older or highly specialised files may only be
          available as manual downloads under "All data sets".
        </li>
      </ul>
      ...
      <p>
        ...
        statistics. This includes every data file available for download on the
        service, ranging from large-scale national trends to specific local
        authority breakdowns.
      </p>

      <ul>
        <li>
          Best for: General users, researchers, and policy analysts who want to
          download CSV or ZIP files to use in Excel, SQL, or other desktop
          analysis tools.
        </li>
