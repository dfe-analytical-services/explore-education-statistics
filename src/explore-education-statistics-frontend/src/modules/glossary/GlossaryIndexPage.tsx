      ...
      <Page breadcrumbs={[{ name: 'Glossary' }]}>
        ...
        <Accordion id="a-z">
          <AccordionSection heading="A">
            ...
            <p>
              Upper case. Activation PIN has been changed to Activation Code on
              outgoing correspondence from the Government Gateway. Until all
              hard-coded instances of Activation PIN have been removed from the
              Online Services pages, use ‘Activation Code (also known as
              Activation PIN)’.
            </p>
            ...
            <p>
              ...
              example (this is not actually an Americanism but is often seen as
              such).
            </p>
          ...
          <AccordionSection heading="B">
            ...
            <p>
              Acronym should come first as it’s more widely known than the full
              name. Please note that the acronym has changed to Bacs.
            </p>
            ...
            <p>
              Lower case. Do not use upper case even in the title of a business
              plan publication.
            </p>
          ...
          <AccordionSection heading="C">
            <div>
              ...
              <p>
                The acronym should come first as it’s more widely known than the
                full name.
              </p>
          ...
          <AccordionSection heading="D">
            ...
            <ul>
              ...
              <li>
                we use ‘to’ in date ranges - not hyphens, en rules or em dashes.
                For example:
                <ul>
              ...
              <li>
                when referring to today (as in a news article) include the date:
            ...
            <p>
              Lower case except when in the title: the Department of Health and
              Social Care.
            </p>
            ...
            <p>
              Lower case in text. Upper case in titles: Spencer Tracy, Director,
              GDS.
            </p>
          ...
          <AccordionSection heading="E">
            ...
            <p>Lower case.</p>
            <h3 id="early-years-teacher-status">early years teacher status</h3>
            <p>Lower case.</p>
            ...
            <p>
              Lower case in text. Upper case in titles: Spencer Tracy, Executive
              Director, GDS.
            </p>
          ...
          <AccordionSection heading="F">
            ...
            <p>
              ...
              you’ll get points on your licence, go to court and so on. Only say
              ‘civil penalty’ if there’s evidence users are searching for the
              term.
            </p>
            <p>
            ...
            <p>Lower case.</p>
            <h3 id="the-free-schools-programme">the free schools programme</h3>
            <p>Lower case.</p>
          ...
          <AccordionSection heading="G">
            ...
            <p>
              Upper case because Gypsies are recognised as an ethnic group under
          ...
          <AccordionSection heading="H">
            ...
            <p>
              Upper case. No need to explain the acronym if it’s used in content
          ...
          <AccordionSection heading="I">
            <div>
              <h3 id="iaas">IaaS</h3>
              <p>
                Stands for “Infrastructure as a Service”. Explain the acronym at
                first use.
              </p>
              <h3 id="id">ID</h3>
              <p>
          ...
          <AccordionSection heading="K">
            <div>
              ...
              <p>
                Upper case when referring to The Kanban Method, otherwise lower
                case.
              </p>
          ...
          <AccordionSection heading="L">
            ...
            <p>
              Lower case otherwise: the legislative competence orders (LCOs) are
          ...
          <AccordionSection heading="M">
            ...
            <p>
              Abbreviating kilograms to kg is fine - you do not need to spell it
              out.
            </p>
            <p>
            ...
            <h3 id="mileage-allowance-payments">Mileage Allowance Payments</h3>
            <p>Upper case.</p>
            ...
            <p>
              Write out pence in full: calls will cost 4 pence per minute from a
              landline.
            </p>
            <p>Currencies are lower case.</p>
            <h3 id="money-laundering">money laundering</h3>
            <p>Lower case when referring to the activity not the regulation.</p>
          ...
          <AccordionSection heading="N">
            ...
            <p>
              Use ‘one’ unless you’re talking about a step, a point in a list or
              another situation where using the numeral makes more sense: ‘in
              point 1 of the design instructions’, for example. Or this:
            </p>
            ...
            <p>
              ...
              for example) except where it starts a title or subheading.
            </p>
          ...
          <AccordionSection heading="O">
            ...
            <p>
              ...
              sentence so the user knows what action they can take. For example:
              You can{' '}
            ...
            <p>
              Only use upper case if the name of the service you’re referring to
              contains named thing. For example:{' '}
            ...
            <p>
              All organisations are singular: The government has decided to sell
              assets.
            </p>
            <p>
              ‘They’ should be used as a pronoun: ‘HMPO is the sole issuer of UK
          ...
          <AccordionSection heading="P">
            ...
            <p>Parliamentary is upper case and committees is in lower case.</p>
            ...
            <p>
              This can be abbreviated to PAYE Online within the PAYE Online for
              employers area of the website.
            </p>
          ...
          <AccordionSection heading="S">
            ...
            <h3 id="secretary-of-state-for-xxx">Secretary of State for XXX</h3>
            <p>
            ...
            <p>
              Upper case when referring to government security classifications,
            ...
            <p>Upper case.</p>
            <h3 id="self-assessment-tax-return">Self Assessment tax return</h3>
            <p>
            ...
            <p>
              Do not use long sentences. Check sentences with more than 25 words
            ...
            <p>
              The Shadow Secretary of State for XXX is upper case whether or not
              it’s used with the holder’s name because there is only one. Use
              common sense to capitalise shortened versions of the Secretary of
              State titles: the Shadow Health Secretary.
            </p>
            <p>
            ...
            <h3 id="smes">SMEs</h3>
            <p>
              This acronym means small and medium-sized enterprises. Use SME for
              the singular.
            </p>
            <h3 id="south-the-south-of-england">south, the south of England</h3>
            <p>Lower case.</p>
            ...
            <p>
              Upper case. When not using the full title in subsequent mentions,
              refer to it in lower case: the code of practice or the code.
            </p>
            ...
            <p>
              Upper case for the 5-year view of the government’s spending plans.
              Lower case in other contexts: we are conducting a spending review.
            </p>
            ...
            <p>
              ...
              mark. Lower case for anything else, including statistics that are
              national in scope.
            </p>
            ...
            <p>
              Upper case because it’s the name of a programme, but programme is
              lower case.
            </p>
          </AccordionSection>
          <AccordionSection heading="T">
            ...
            <p>
              Lower case and plural. Working Tax Credit and Child Tax Credit are
              specific benefits, so are upper case and singular.
            </p>
            ...
            <p>Lower case.</p>
            <h3 id="team">team</h3>
            <p>Lower case: youth offending team, Behavioural Insights team.</p>
            ...
            <p>
              Use spaces between city and local exchange. Here are the different
              formats to use:
            </p>
            <p>01273 800 900</p>
            <p>020 7450 4000</p>
          ...
          <AccordionSection heading="V">
            ...
            <p>Upper case.</p>
            <h3 id="vat-registration-threshold">VAT registration threshold</h3>
            <p>Lower case.</p>
            ...
            <h3 id="vpn">VPN</h3>
            <p>
              Upper case. No need to explain the acronym. When describing a VPN
              that is always on, write it like this: ‘always-on’ VPN. Note the
              single quotes and hyphen.
            </p>
          </AccordionSection>
          <AccordionSection heading="W">
            <h3 id="walkaround">walkaround</h3>
            <p>
              When it’s the daily check that lorry and bus drivers do, it’s one
              word - a vehicle walkaround.
            </p>
            ...
            <ul>
              ...
              <li>combating</li>
              <li>
                commit/pledge (we need to be more specific - we’re either doing
                something or we’re not)
              </li>
              <li>countering</li>
              <li>
            ...
            <p>
              Avoid using metaphors – they do not say what you actually mean and
            ...
            <p>
              With all of these words you can generally replace them by breaking
              the term into what you’re actually doing. Be open and specific.
            </p>
            <p>
              <a href="https://www.gov.uk/guidance/content-design/writing-for-gov-uk#plain-english">
