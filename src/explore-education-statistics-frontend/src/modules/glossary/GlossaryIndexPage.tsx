          ...
          <div className="govuk-grid-column-one-third">
            ...
            <Accordion id="a-z">
              <AccordionSection heading="A">
                ...
                <p>
                  The first time you use an abbreviation or acronym explain it
                  in full on each page unless it’s well known, like UK, DVLA,
                  US, EU, VAT and MP. This includes government departments or
                  schemes. Then refer to it by initials, and use{' '}
                ...
                <p>
                  Upper case when referring to the business area covered by
                  Money Laundering Regulations. Do not use the acronym.
                </p>
                ...
                <p>
                  ...
                  from the Online Services pages, use ‘Activation Code (also
                  known as Activation PIN)’.
                </p>
                ...
                <p>
                  Lower case in subsequent mentions that do not use the full
                  term: the register.
                </p>
                ...
                <p>
                  ...
                  course’ can be written as ‘15 students aged 16 took the A
                  level course’.
                </p>
                <h3 id="agile">agile</h3>
                <p>
                  Upper case when referring to the Agile Manifesto and
                  principles and processes, otherwise use lower case.
                </p>
                ...
                <p>
                  Use the -ise rather than -ize suffix: organise not organize,
                  for example (this is not actually an Americanism but is often
                  seen as such).
                </p>
              ...
              <AccordionSection heading="B">
                ...
                <h3 id="behavioural-insights-team">
                  Behavioural Insights team
                </h3>
                <p>
                  Upper case if it’s a specific, named team. Always lower case
                  for team and generic names like research team, youth offending
                  team.
                </p>
                ...
                <p>
                  Use 2 words when referring to an article published on a blog.
                  A ‘blog’ is the site on which a blog post is published.
                </p>
                ...
                <p>
                  Use (round brackets), not [square brackets]. The only
                  acceptable use of square brackets is for explanatory notes in
                  reported speech:
                </p>
                <p>“Thank you [Foreign Minister] Mr Smith.”</p>
                <p>
                  Do not use round brackets to refer to something that could
                  either be singular or plural, like ‘Check which document(s)
                  you need to send to DVLA.’
                </p>
                <p>
                ...
                <p>
                  You can use bullet points to make text easier to read. Make
                  sure that:
                </p>
                <ul>
                ...
                <p>
                  Bullets should normally form a complete sentence following
                  from the lead text. But it’s sometimes necessary to add a
                  short phrase to clarify whether all or some of the points
                  apply. For example, ‘You can only register a pension scheme
              ...
              <AccordionSection heading="C">
                <div>
                  ...
                  <p>
                    Always use lower case, even in page titles. The exceptions
                    to this are proper nouns, and:
                  </p>
                  <ul>
                    <li>
                    ...
                    <li>
                      titles like Mr, Mrs, Dr, the Duke of Cambridge (the duke
                      at second mention); Pope Francis, but the pope
                    </li>
                    ...
                    <li>
                      ...
                      use ‘the act’ or ‘the bill’ after the first time you use
                      the full act or bill title)
                    </li>
                    <li>
                      names of specific, named government schemes known to
                      people outside government: Right to Buy, Queen’s Awards
                      for Enterprise
                    </li>
                    <li>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      unless referring to a specific one: Ministry of Justice,
                      for example
                    </li>
                    <li>
                    ...
                    <li>
                      budget, autumn statement, spring statement, unless
                      referring to and using the full name of a specific
                      statement - for example, “2016 Budget”
                    </li>
                    <li>
                    ...
                    <li>
                      group and directorate, unless referring to a specific
                      group or directorate: the Commercial Directorate, for
                      example
                    </li>
                  ...
                  <p>Upper case.</p>
                  <h3 id="childminder-childminding">
                  ...
                  <p>
                    Not “third-party software”. Also use “commercial” for types
                    of software, for example “commercial word processor”.
                  </p>
                  ...
                  <ul>
                    <li>
                      negative contractions like can’t and don’t - many users
                      find them harder to read, or misread them as the opposite
                      of what they say
                    </li>
                    <li>
                  ...
                  <p>
                    Use upper case Online if referring to the actual service,
                    not if you’re describing using the service: ‘you can pay
                    your Corporation Tax online or at the Post Office.’
                  </p>
                  <h3 id="cots">COTS</h3>
                  <p>
                  ...
                  <p>
                    When referring to a country or territory, use the names
                    listed in the{' '}
              ...
              <AccordionSection heading="D">
                <h3 id="data">data</h3>
                <p>
                  Treat as a singular noun: The data is stored on a secure
                  server.
                </p>
                ...
                <ul>
                  ...
                  <li>
                    when space is an issue - in tables or publication titles,
                    for example - you can use truncated months: Jan, Feb
                  </li>
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        Monday to Friday, 9am to 5pm (put different days on a
                        new line, do not separate with a comma)
                      </li>
              ...
              <AccordionSection heading="E">
                ...
                <p>
                  etc can usually be avoided. Try using ‘for example’ or ‘such
                  as’ or ‘like’ or ‘including’. Never use etc at the end of a
                  list starting with these words.
                </p>
                <p>
                  ie - used to clarify a sentence - is not always well
                  understood. Try (re)writing sentences to avoid the need to use
                  it. If that is not possible, use an alternative such as
                  ‘meaning’ or ‘that is’.
                </p>
                <h3 id="eg-etc-ie">
                ...
                <p>
                  Leave unabbreviated to distinguish from the European
                  Community. Write out in full at first mention, then call it
                  the Commission.
                </p>
              ...
              <AccordionSection heading="F">
                ...
                <p>
                  Do not use FAQs on GOV.UK. If you write content by starting
                  with user needs, you will not need to use FAQs.
                </p>
                <p>
                ...
                <p>
                  ...
                  - you’ll get points on your licence, go to court and so on.
                  Only say ‘civil penalty’ if there’s evidence users are
                ...
                <p>
                  Lower case unless the full name of the foundation trust is
                  being used: Salisbury NHS Foundation Trust.
                </p>
              ...
              <AccordionSection heading="G">
                ...
                <p>
                  No full stops between the initials. No apostrophe in the
                  plural.
                </p>
                ...
                <p>
                  ...
                  south-west, north-east Scotland, south Wales, the west,
                  western Europe, the far east, south-east Asia.
                </p>
                <p>
                ...
                <p>
                  ...
                  government’, but ‘Her Majesty’s Government of the United
                ...
                <p>
                  Lower case unless part of a school name: The Manchester
                  Grammar School.
                </p>
                ...
                <p>
                  If you’re telling users about multiple areas, use (for
                ...
                <p>
                  Upper case for names of groups, directorates and
                  organisations: Knowledge and Innovation Group.
                </p>
                <p>
              ...
              <AccordionSection heading="H">
                ...
                <p>
                  Lower case unless it’s the title of an organisation: North
                  East and Central London Health Protection Unit.
                </p>
                ...
                <p>
                  ...
                  example, a little used-car is different from a little-used
                  car. You can also refer to{' '}
                  <a
                    rel="external"
              ...
              <AccordionSection heading="I">
                <div>
                  <h3 id="iaas">IaaS</h3>
                  <p>
                    Stands for “Infrastructure as a Service”. Explain the
                    acronym at first use.
                  </p>
                  <h3 id="id">ID</h3>
                  <p>
                    In technical writing, don’t write ‘identification’ or
                    ‘identifier’, unless it’s part of a standard abbreviation.
                    For example, ‘unique identifier (UID)’.
                  </p>
                  <h3 id="ie">ie</h3>
                  <p>
                  ...
                  <p>Lower case.</p>
                  <h3 id="initial-teacher-training">
                  ...
                  <p>Lower case.</p>
                  <h3 id="instrument-of-government">
                  ...
                  <p>
                    Do not use italics. Use ‘single quotation marks’ if
                    referring to a document, scheme or initiative.
                  </p>
                </div>
              </AccordionSection>
              ...
              <AccordionSection heading="L">
                ...
                <p>
                  If you have to publish legal jargon, it will be a publication
                  so write a plain English summary.
                </p>
                <p>
                ...
                <p>
                  Upper case if used as the full title: the National Assembly
                  for Wales (Legislative Competence) (Social Welfare) Order
                  2008.
                </p>
                <p>
                ...
                <p>
                  Front-load your link text with the relevant terms and make
                  them active and specific. Always link to online services
                  first. Offer offline alternatives afterwards, when possible.
                </p>
                ...
                <p>
                  ...
                  sentence if it looks better: ‘The following countries are in
                  the EU: Spain, France, Italy…’
                </p>
              ...
              <AccordionSection heading="M">
                ...
                <p>
                  One space each side of symbols: +, –, ×, ÷ and = (so: 2 + 2 =
                  4)
                </p>
                <p>
                ...
                <p>
                  Abbreviating kilograms to kg is fine - you do not need to
                  spell it out.
                </p>
                <p>
                ...
                <p>
                  When used without the name, shortened titles are lower case:
                  The health minister welcomed the research team.
                </p>
                ...
                <p>
                  Write out pence in full: calls will cost 4 pence per minute
                  from a landline.
                </p>
              ...
              <AccordionSection heading="N">
                ...
                <p>Lower case.</p>
                <h3 id="national-curriculum-tests">
                ...
                <p>Upper case.</p>
                <h3 id="national-insurance-number">
                ...
                <p>Lower case.</p>
                <h3 id="national-scholarship-fund">
                ...
                <p>
                  Use ‘one’ unless you’re talking about a step, a point in a
                  list or another situation where using the numeral makes more
                  sense: ‘in point 1 of the design instructions’, for example.
                  Or this:
                </p>
                <p>
                ...
                <p>
                  ...
                  where it’s part of a common expression like ‘one or two of
                  them’ where numerals would look strange.
                </p>
                <p>
              ...
              <AccordionSection heading="O">
                ...
                <p>
                  ...
                  pension schemes. Only use this term if explaining tax rules
                  that are specific to occupational pension schemes.
                </p>
                ...
                <p>
                  Only use upper case if the name of the service you’re
                  referring to contains named thing. For example:{' '}
                ...
                <p>
                  ‘They’ should be used as a pronoun: ‘HMPO is the sole issuer
                  of UK passports. They will send your new passport within 3
                  weeks.’
                </p>
                <p>
                  ...
                  Vehicle Standards Agency if…’ but ‘You should contact DVSA
                  if…’
                </p>
                <p>
                  Use local council, instead of local authority, where possible.
              ...
              <AccordionSection heading="P">
                <h3 id="paas">PaaS</h3>
                <p>
                  Stands for “Platform as a Service”. Explain the acronym at
                  first use.
                </p>
                ...
                <p>
                  When referring to the product/relief/regime, then say the
                  Patent Box. Occasionally the definite article will be dropped,
                  for example in calculations, where we use ‘Patent Box
                  deduction’ and when using phrases like ‘Answers to your Patent
                  Box questions’.
                </p>
                ...
                <p>Upper case.</p>
                <h3 id="paye-online-for-employers">
                ...
                <p>
                  ...
                  . You should also make sure you use language your audience
                  will understand - check which{' '}
                ...
                <p>
                  ...
                  template or form, for example. Be specific about what to do
                  with it.
                </p>
                ...
                <p>
                  Lowercase, the same as GitHub does in its documentation.
              ...
              <AccordionSection heading="Q">
                ...
                <p>
                  In long passages of speech, open quotes for every new
                  paragraph, but close quotes only at the end of the final
                  paragraph.
                </p>
              ...
              <AccordionSection heading="S">
                <h3 id="saas">SaaS</h3>
                <p>
                  Stands for “Software as a Service”. Explain the acronym at
                  first use.
                </p>
                ...
                <p>
                  Upper case. After the first mention you can refer to it in
                  lower case: the admissions code or the code.
                </p>
                ...
                <p>
                  Capitalise the first letter of the first part of the
                  scientific name. Do not use italics.
                </p>
                ...
                <p>
                  The Secretary of State for XXX is upper case whether or not
                  it’s used with the holder’s name because there is only one.
                  Use common sense to capitalise shortened versions of the SoS
                  titles such as Health Secretary. The rule for ministers is
                  different because there is more than one.
                </p>
                ...
                <p>
                  If it’s not clear from the context, you may need to clarify
                  that it’s a classification not a general description:
                  ‘information classified as Official’ rather than ‘Official
                  information’.
                </p>
                ...
                <p>
                  Do not use semicolons as they are often mis-read. Long
                  sentences using semicolons should be broken up into separate
                  sentences instead.
                </p>
                ...
                <p>
                  Lower case, even when referring to the armed forces services
                  or the services.
                </p>
                ...
                <p>
                  ...
                  not it’s used with the holder’s name because there is only
                  one. Use common sense to capitalise shortened versions of the
                ...
                <p>
                  Use sign in rather than log in (verb) for calls-to-action
                  where users enter their details to access a service.
                </p>
                <p>
                  Do not use login as a noun - say what the user actually needs
                  to enter (like username, password, National Insurance number).
                </p>
                ...
                <p>
                  ...
                  mentions, refer to it in lower case: the code of practice or
                  the code.
                </p>
                ...
                <p>
                  See{' '}
                  <a href="#quotes-speech-marks">‘Quotes and speech marks’</a>
                </p>
                ...
                <p>Lower case.</p>
                <h3 id="statistical-first-release">
                ...
                <p>
                  ...
                  quality mark. Lower case for anything else, including
                  statistics that are national in scope.
                </p>
                ...
                <p>
                  Lower case. Do not capitalise a named strategy: national
              ...
              <AccordionSection heading="T">
                ...
                <p>
                  ...
                  just need to explain what they mean the first time you use
                  them.
                </p>
                <p>
                ...
                <p>
                  For example, “You must register by 11:59pm on Tuesday 14
                  June.” can only be read one way, but “You must register by
                  midnight on Tuesday 14 June” can be read in two ways (the end
                  of Monday 13, or end of Tuesday 14).
                </p>
                <h3 id="tied-oils-enquiry-service">
                ...
                <p>
                  Upper case because Irish Travellers are recognised as an
                  ethnic group under the Race Relations Act. New age travellers
                  is lower case.
                </p>
              ...
              <AccordionSection heading="V">
                ...
                <p>
                  ...
                  VPN that is always on, write it like this: ‘always-on’ VPN.
                  Note the single quotes and hyphen.
                </p>
              </AccordionSection>
              <AccordionSection heading="W">
                ...
                <p>
                  Subsequent references would be the assembly. Lower case is
                  also used for the second assembly, the third assembly.
                </p>
                ...
                <p>Lower case.</p>
                <h3 id="widowed-parents-allowance">
                ...
                <ul>
                  ...
                  <li>
                    impact (do not use this as a synonym for have an effect on,
                    or influence)
                  </li>
                  <li>initiate</li>
                  <li>
                ...
                <ul>
                  ...
                  <li>
                    going forward (it’s unlikely we are giving travel
                    directions)
                  </li>
