    ...
    return (
      <Page breadcrumbs={[{ name: 'Privacy Policy' }]}>
        ...
        <div>
          ...
          <p>
            We receive your personal data when you visit our service, complete
            our feedback survey or tell us if something is wrong. We use this
        ...
        <div>
          ...
          <p>
            Transmitting information over the internet is generally not
            completely secure, and we cannot guarantee the security of your
            data. Any data you transmit is at your own risk.
          </p>
          <p>
            We have appropriate procedures and security features in place to
            keep your data secure once we receive it.
          </p>
          <p>
            We won't share your information with any other organisations for
            marketing, market research or commercial purposes, and we do not
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              to restrict our processing of your personal data (ie permitting
        ...
        <div>
          ...
          <p>
            ...
            recommend that you revisit this information from time to time. This
            version was last updated on DD/MM/YY.
          </p>
        </div>
        <div>
          ...
          <p>
            ...
            personal information about you from the other website. You should
            read the privacy policy of the website you came from to find out
            more about this.
          </p>
        </div>
        <div>
          ...
          <p>
            ...
            internet-enabled device when you visit our service. Cookies are
            stored by your browser and hard drive and are used to distinguish
            you from other visitors to our servie, to collect information about
            how you browse our service and for security and monitoring of our
            service.
          </p>
          <p>
        ...
        <div>
          ...
          <p>
            ...
            be processed, contact us at DETAILS TBC.
          </p>
        </div>
      </Page>
    );
