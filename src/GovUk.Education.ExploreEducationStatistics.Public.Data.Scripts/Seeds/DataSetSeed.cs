...
{
    private static readonly Guid ExclusionsPublicationId = new(
        "346fd6f2-3938-4006-9867-08dc1c5c66c3"
    );
    private static readonly Guid PupilAbsencePublicationId = new(
        "d40523f4-50ba-4896-9866-08dc1c5c66c3"
    );
    private static readonly Guid PerformanceTestingPublicationId = new(
