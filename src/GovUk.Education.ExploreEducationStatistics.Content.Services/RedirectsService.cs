        ...
        var methodologyRedirects = (
            await _contentDbContext
                ...
                .Select(mr => new
                {
                    ...
                    LatestPublishedSlug = mr.MethodologyVersion
                        .Methodology
                        .LatestPublishedVersion!
                        .AlternativeSlug ?? mr.MethodologyVersion.Methodology.OwningPublicationSlug,
                })
                .ToListAsync()
        )
            .Select(mr =>
            {
                ...
                return new RedirectViewModel(
                    FromSlug: mr.RedirectSlug,
                    ToSlug: mr.LatestPublishedSlug
                );
            })
            .WhereNotNull()
            .Distinct()
