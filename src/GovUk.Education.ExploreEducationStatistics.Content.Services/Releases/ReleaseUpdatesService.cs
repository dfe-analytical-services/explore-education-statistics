...
{
    public async Task<
        Either<ActionResult, PaginatedListViewModel<ReleaseUpdateDto>>
    > GetReleaseUpdates(
    ...
    private async Task<
        PaginatedListViewModel<ReleaseUpdateDto>
    > GetPaginatedUpdatesForReleaseVersion(
        ...
        var published =
            releaseVersion.Version == 0
                ...
                : await contentDbContext
                    .ReleaseVersions.Where(rv =>
                        rv.ReleaseId == releaseVersion.ReleaseId && rv.Version == 0
                    )
