...
public record ReleaseVersionSummaryDto
{
    ...
    public static ReleaseVersionSummaryDto FromModel(
        ...
        new()
        {
            ...
            PublishingOrganisations = releaseVersion.PublishingOrganisations
                .Select(PublishingOrganisationDto.FromModel)
                .ToArray(),
...
public record PublishingOrganisationDto
{
    ...
    // TODO EES-6404 What about the existing view model?
    public static PublishingOrganisationDto FromModel(Organisation organisation) =>
        new()
        {
            Id = organisation.Id,
