...
public class AnalyticsWriteZipDownloadStrategy(
    IAnalyticsPathResolver analyticsPathResolver,
    ILogger<AnalyticsWriteZipDownloadStrategy> logger
    ) : IAnalyticsWriteStrategy
{
    ...
    public async Task Report(BaseCaptureRequest request, CancellationToken cancellationToken)
    {
        ...
        var filename = $"{DateTime.UtcNow:yyyyMMdd-HHmmss-fffffff}_{zipDownloadRequest.ReleaseVersionId}.json";
