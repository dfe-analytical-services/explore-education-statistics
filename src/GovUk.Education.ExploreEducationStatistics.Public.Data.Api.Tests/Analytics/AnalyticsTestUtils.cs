...
public static class AnalyticsTheoryData
{
    ...
    public static readonly TheoryData<(PreviewTokenSummary?, string?)> PreviewTokensAndRequestedDataSetVersions =
    [
        (null, null),
        (
...
public static class AnalyticsTestAssertions
{
    ...
    {
        await WaitForConditionToBeTrue(() => Task.FromResult(conditionTest()), failureMessage, timeoutMillis);
    }
}
