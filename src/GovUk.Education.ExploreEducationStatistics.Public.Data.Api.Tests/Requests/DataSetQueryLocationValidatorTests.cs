...
public class DataSetQueryLocationValidatorTests
{
    ...
    public void Failure_InvalidLevel(DataSetQueryLocation location)
    {
        ...
        Assert.Equal(Common.Validators.ValidationMessages.AllowedValue.Code, error.ErrorCode);
        Assert.Equal(Common.Validators.ValidationMessages.AllowedValue.Message, error.ErrorMessage);
