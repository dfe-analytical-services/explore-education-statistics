...
public abstract class AnalyticsWriteDataSetVersionCallsStrategyTests
{
    public class ReportTests : AnalyticsWriteDataSetVersionCallsStrategyTests
    {
        private const string SnapshotPrefix =
            $"{nameof(AnalyticsWriteDataSetVersionCallsStrategyTests)}.{nameof(ReportTests)}";
        ...
        public async Task CallWrittenSuccessfully_WithCoreDataSetVersionDetails()
        {
            ...
            var files = Directory.GetFiles(
                pathResolver.BuildOutputDirectory(
            ...
            var filename = filePath.Split(
                $"{pathResolver.BuildOutputDirectory(AnalyticsWriteDataSetVersionCallsStrategy.OutputSubPaths)}{Path.DirectorySeparatorChar}"
            )[1];
        ...
        )
        {
            return new AnalyticsWriteDataSetVersionCallsStrategy(
                ...
                new CommonAnalyticsWriteStrategyWorkflow<CaptureDataSetVersionCallRequest>(
                    ...
                    Mock.Of<
                        ILogger<
                            CommonAnalyticsWriteStrategyWorkflow<CaptureDataSetVersionCallRequest>
                        >
                    >()
                )
            );
