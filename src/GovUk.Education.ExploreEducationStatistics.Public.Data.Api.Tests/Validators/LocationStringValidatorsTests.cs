    ...
    public class LocationStringTests : LocationStringValidatorsTests
    {
        ...
        public void Failure_InvalidProperty(string level, string invalidProperty, params string[] allowedProperties)
        {
            ...
            result.ShouldHaveValidationErrorFor(t => t.Location)
                ...
                .WithCustomState<LocationStringValidators.AllowedPropertyErrorDetail>(s => s.Value == invalidProperty)
                .WithCustomState<LocationStringValidators.AllowedPropertyErrorDetail>(s =>
