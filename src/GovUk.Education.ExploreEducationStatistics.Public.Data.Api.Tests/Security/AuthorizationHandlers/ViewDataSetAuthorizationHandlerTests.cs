...
public class ViewDataSetAuthorizationHandlerTests
{
    ...
    public async Task PreviewTokenForDraftDataSetVersionActive_Success(DataSetStatus status)
    {
        ...
        publicDataDbContext
            ...
            .ReturnsDbSet(dataSetVersion.PreviewTokens);
    ...
    public async Task PreviewTokenForDraftDataSetVersionExpired_DataSetStatusAvailable_Success(
    ...
    public async Task PreviewTokenForDraftDataSetVersionExpired_DataSetStatusUnavailable_Failure(
        DataSetStatus status
    )
    {
        DataSet dataSet = _dataFixture.DefaultDataSet().WithStatus(status);
    ...
    public async Task PreviewTokenActiveButForLiveDataSetVersion_DataSetStatusAvailable_Success(
        DataSetStatus status
    )
    {
        DataSet dataSet = _dataFixture.DefaultDataSet().WithStatus(status);
    ...
    public async Task PreviewTokenActiveButForLiveDataSetVersion_DataSetStatusUnavailable_Failure(
        DataSetStatus status
    )
    {
        DataSet dataSet = _dataFixture.DefaultDataSet().WithStatus(status);
