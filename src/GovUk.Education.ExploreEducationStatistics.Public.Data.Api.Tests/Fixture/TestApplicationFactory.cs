    ...
    protected override IHostBuilder CreateHostBuilder()
    {
        return base.CreateHostBuilder()
                ...
                (_, builder) =>
                {
                    ...
                    _additionalAppsettingsFiles.ForEach(settingsFile =>
                    {
                        configuration.AddJsonFile(
                            Path.Combine(Assembly.GetExecutingAssembly().GetDirectoryPath(), settingsFile),
                            optional: false
                        );
                    });
            ...
            .ConfigureServices(services =>
            {
                ...
                services.ReplaceService<IAnalyticsPathResolver>(new TestAnalyticsPathResolver(), optional: true);
            });
    }
