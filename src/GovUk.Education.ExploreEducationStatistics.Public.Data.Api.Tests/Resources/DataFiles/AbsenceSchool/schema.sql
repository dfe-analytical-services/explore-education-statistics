...
CREATE TABLE filter_options(id INTEGER PRIMARY KEY, "label" VARCHAR, public_id VARCHAR, filter_id VARCHAR, filter_column VARCHAR);
CREATE TABLE indicators(id VARCHAR PRIMARY KEY, "column" VARCHAR, "label" VARCHAR, unit VARCHAR, decimal_places TINYINT);
