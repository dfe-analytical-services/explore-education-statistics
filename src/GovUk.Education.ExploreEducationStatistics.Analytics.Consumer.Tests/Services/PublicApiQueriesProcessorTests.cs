...
public abstract class PublicApiQueriesProcessorTests : ProcessorTestsBase
{
    ...
    public class ProcessTests : PublicApiQueriesProcessorTests
    {
        ...
        public async Task SingleSourceQuery_ProducesOneReportRow()
        {
            ...
            var queryReportFile = reports.Single(file =>
                file.EndsWith("public-api-queries.parquet")
            );
            ...
            Assert.Equal(
                Guid.Parse("01d29401-7274-a871-a8db-d4bc4e98c324"),
                queryReportRow.DataSetId
            );
            Assert.Equal(
                Guid.Parse("01d29401-7974-1276-a06b-b28a6a5385c6"),
                queryReportRow.DataSetVersionId
            );
            ...
            Assert.StartsWith(
                "{\"criteria\":{\"filters\":{\"eq\":\"qOnjG\"}",
                queryReportRow.Query
            );

            var queryAccessReportFile = reports.Single(file =>
                file.EndsWith("public-api-query-access.parquet")
            );
            ...
            Assert.Equal(
                Guid.Parse("01d29401-7974-1276-a06b-b28a6a5385c6"),
                queryAccessReportRow.DataSetVersionId
            );
            Assert.Equal(
                DateTime.Parse("2025-02-24T03:07:44.710Z"),
                queryAccessReportRow.StartTime
            );
        ...
        public async Task TwoDifferentSourceQueries_ProduceTwoDistinctReportRows()
        {
            ...
            Assert.Equal(
                Guid.Parse("01d29401-7274-a871-a8db-d4bc4e98c324"),
                queryReportRow1.DataSetId
            );
            Assert.Equal(
                Guid.Parse("01d29401-7974-1276-a06b-b28a6a5385c6"),
                queryReportRow1.DataSetVersionId
            );
            ...
            Assert.Equal(
                Guid.Parse("8b9da0ae-80e4-43e8-9f39-4f670fd1a45a"),
                queryReportRow2.DataSetId
            );
            Assert.Equal(
                Guid.Parse("5ed5053d-92fc-49a1-b0b1-4c11f3b2c538"),
                queryReportRow2.DataSetVersionId
            );
            ...
            Assert.StartsWith(
                "{\"criteria\":{\"filters\":{\"in\":[\"qOnjG\"",
                queryReportRow2.Query
            );
            ...
            Assert.Equal(
                "b856e997ec5d2c7b445c71ff14859be7",
                queryAccessReportRow1.QueryVersionHash
            );
            Assert.Equal(
                Guid.Parse("5ed5053d-92fc-49a1-b0b1-4c11f3b2c538"),
                queryAccessReportRow1.DataSetVersionId
            );
            Assert.Equal(
                DateTime.Parse("2025-02-23T03:07:44.931Z"),
                queryAccessReportRow1.StartTime
            );
            ...
            Assert.Equal(
                "f89944c2ee4284894962724bc68a1c8e",
                queryAccessReportRow2.QueryVersionHash
            );
            Assert.Equal(
                Guid.Parse("01d29401-7974-1276-a06b-b28a6a5385c6"),
                queryAccessReportRow2.DataSetVersionId
            );
            Assert.Equal(
                DateTime.Parse("2025-02-24T03:07:44.710Z"),
                queryAccessReportRow2.StartTime
            );
        ...
        public async Task MultipleSourceFilesForSameQuery_ProduceSingleQueryRowAndMultipleQueryAccessRows()
        {
            ...
            Assert.Equal(
                DateTime.Parse("2025-02-22T03:07:44.931Z"),
                queryAccessReportRow1.StartTime
            );
            ...
            Assert.Equal(
                "b856e997ec5d2c7b445c71ff14859be7",
                queryAccessReportRow3.QueryVersionHash
            );
            Assert.Equal(
                Guid.Parse("5ed5053d-92fc-49a1-b0b1-4c11f3b2c538"),
                queryAccessReportRow3.DataSetVersionId
            );
            Assert.Equal(
                DateTime.Parse("2025-02-24T03:07:44.931Z"),
                queryAccessReportRow3.StartTime
            );
        ...
        public async Task SameQueryStructureButDifferentDataSetVersion_ProducesTwoDistinctReportRows()
        {
            ...
            Assert.Equal(
                Guid.Parse("68c73c8e-808d-47fd-a2d5-268dc6b3a102"),
                queryReportRow1.DataSetVersionId
            );
            ...
            // Check that the second query access was recorded.
            Assert.Equal(
                "34822b182432c266b7198c243245fd60",
                queryAccessReportRow2.QueryVersionHash
            );
            Assert.Equal(
                Guid.Parse("68c73c8e-808d-47fd-a2d5-268dc6b3a102"),
            ...
            Assert.Equal(
                DateTime.Parse("2025-02-25T03:07:44.710Z"),
                queryAccessReportRow2.StartTime
            );
        ...
        public async Task WithPreviewTokenAndRequestedDataSetVersion_CapturedInReport()
        {
            ...
            Assert.Equal(
                DateTime.Parse("2025-02-23T11:02:44.850Z"),
                queryAccessReportRow.PreviewTokenCreated
            );
            Assert.Equal(
                DateTime.Parse("2025-02-24T11:02:44.850Z"),
                queryAccessReportRow.PreviewTokenExpiry
            );
            Assert.Equal(
                Guid.Parse("01d29401-7974-1276-a06b-b28a6a5385c6"),
                queryAccessReportRow.PreviewTokenDataSetVersionId
            );
        }

        private static async Task<List<QueryReportLine>> ReadQueryReport(
    ...
    {
        return new PublicApiQueriesProcessor(pathResolver: PathResolver, workflow: Workflow);
    }
