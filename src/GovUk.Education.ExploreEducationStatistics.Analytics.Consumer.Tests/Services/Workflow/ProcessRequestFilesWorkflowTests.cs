...
public abstract class ProcessRequestFilesWorkflowTests
{
    ...
    public static readonly string FailuresFolder = Path.Combine(
        SourceFolder,
        "failures",
        "temp-processing-folder"
    );
...
public static class FileAccessorMockBuilderExtensions
{
        ...
        return fileAccessorMockBuilder
            ...
            .WhereFileIsMoved(
                ...
                destinationPath: Path.Combine(
                    ProcessRequestFilesWorkflowTests.FailuresFolder,
    ...
    {
        return fileAccessorMockBuilder.WhereDirectoryIsCreated(
            ProcessRequestFilesWorkflowTests.ReportsFolder
        );
    }
}
...
public static class FileAccessorMockBuilderAsserterExtensions
{
    ...
    {
        return asserter.DeleteDirectoryCalledFor(
            ProcessRequestFilesWorkflowTests.TemporaryProcessingDirectory
        );
    }
