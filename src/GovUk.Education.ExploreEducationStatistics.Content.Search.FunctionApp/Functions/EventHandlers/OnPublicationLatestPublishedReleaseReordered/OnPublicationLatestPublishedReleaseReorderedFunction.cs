...
public class OnPublicationLatestPublishedReleaseReorderedFunction(
            ...
            (payload, _) =>
            {
                if (string.IsNullOrEmpty(payload.Slug) || payload.IsPublicationArchived == true)
                {
                    return Task.FromResult(
                        OnPublicationLatestPublishedReleaseReorderedOutput.Empty
                    );
                }
                ...
                RemoveSearchableDocumentDto[] removeSearchableDocuments =
                    !payload.PreviousReleaseId.IsBlank()
                        ...
                        [
                            ...
                            {
                                ReleaseId = payload.PreviousReleaseId.Value,
                            },
                        ]
                        : [];
