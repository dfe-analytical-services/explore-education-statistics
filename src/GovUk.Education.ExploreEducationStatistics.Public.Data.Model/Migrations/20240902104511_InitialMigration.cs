    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                OldCode = table.Column<string>(
                    type: "character varying(20)",
                    maxLength: 20,
                    nullable: true
                ),
                Urn = table.Column<string>(
                    type: "character varying(20)",
                    maxLength: 20,
                    nullable: true
                ),
                LaEstab = table.Column<string>(
                    type: "character varying(20)",
                    maxLength: 20,
                    nullable: true
                ),
                Ukprn = table.Column<string>(
                    type: "character varying(20)",
                    maxLength: 20,
                    nullable: true
                ),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Published = table.Column<DateTimeOffset>(
                    type: "timestamp with time zone",
                    nullable: true
                ),
                Withdrawn = table.Column<DateTimeOffset>(
                    type: "timestamp with time zone",
                    nullable: true
                ),
                ...
                Updated = table.Column<DateTimeOffset>(
                    type: "timestamp with time zone",
                    nullable: true
                ),
            },
