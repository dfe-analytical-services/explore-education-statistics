...
public sealed class TestApplicationFactory : TestApplicationFactory<Startup>
{
    ...
    /// <summary>
    /// Start the Azurite container. Once started, the test app can be automatically
    /// configured with the correct connection string if it hasn't already been built.
    /// </summary>
    /// <remarks>
