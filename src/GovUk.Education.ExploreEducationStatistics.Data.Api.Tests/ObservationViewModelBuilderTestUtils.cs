...
internal static class ObservationViewModelBuilderTestUtils
{
        ...
        IEnumerable<Indicator> indicators)
    {
        ...
        // Deliberately swap out the location id for a location view model to represent what a permalink would
        // looks like with observations that had a location object prior to location id being added.
