...
public class MethodologyVersionRepository : IMethodologyVersionRepository
{
    ...
    public MethodologyVersionRepository(
    ...
    public async Task<MethodologyVersion> CreateMethodologyForPublication(
        Guid publicationId,
        Guid createdByUserId
    )
    {
        var publication = await _contentDbContext
            .Publications.AsQueryable()
    ...
    public async Task<List<MethodologyVersion>> GetLatestPublishedVersionByPublication(
        Guid publicationId
    )
    {
    ...
    private async Task<bool> PublicationsHaveAtLeastOnePublishedRelease(
