...
public static class UserExtensions
{
    ...
    public static bool IsPendingInvite(this User user) => IsPendingInviteExpression.Compile()(user);

    public static IQueryable<User> WhereIsPendingInvite(this IQueryable<User> query) =>
        query.Where(IsPendingInviteExpression);

    public static bool InviteHasExpired(this User user) => InviteHasExpiredExpression.Compile()(user);
}
