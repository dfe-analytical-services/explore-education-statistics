...
public record DataSetMapping
{
    ...
    public List<CandidateIndicator> CandidateIndicatorReplacements { get; set; } = [];
    ...
    internal class Config : IEntityTypeConfiguration<DataSetMapping>
    {
        ...
        public void Configure(EntityTypeBuilder<DataSetMapping> builder)
        {
            ...
            builder
                .Property(x => x.CandidateIndicatorReplacements)
                .HasConversion(
                    candidates => JsonSerializer.Serialize(candidates, JsonOptions),
                    candidatesString =>
                        JsonSerializer.Deserialize<List<CandidateIndicator>>(candidatesString, JsonOptions)
                        ?? new List<CandidateIndicator>(),
                    ValueComparer.CreateDefault<List<CandidateIndicator>>(false)
                );
        }
    }
}
...
public record CandidateIndicator
{
