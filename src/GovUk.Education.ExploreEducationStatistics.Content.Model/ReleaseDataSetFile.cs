...
public class ReleaseDataSetFile

{
    ...
    public DataSetFileVersion DataSetFileVersion { get; set; } = null!;

    public Guid DataSetFileVersionId { get; set; }

    public string? Title { get; set; } // @MarkFix previously ReleaseFile.Name
    ...
    public DateTime? Published { get; set; } // @MarkFix we want this?
}
