...
public record DataSetUpload : ICreatedTimestamp<DateTime>
{
    ...
    public string DataFilePath => $"{FileStoragePathUtils.FilesPath(ReleaseVersionId, FileType.Data)}{DataFileId}";
    ...
    public string MetaFilePath => $"{FileStoragePathUtils.FilesPath(ReleaseVersionId, FileType.Metadata)}{MetaFileId}";
    ...
    public DataSetScreenResponse? ScreenerResult { get; set; }
