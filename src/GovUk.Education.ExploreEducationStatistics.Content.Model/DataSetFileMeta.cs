...
public class DataSetFileMetaOld // EES-5666 remove
{
...
public class TimePeriodRangeMetaOld // EES-5666 remove
{
...
public class TimePeriodRangeBoundMetaOld // EES-5666 remove
{
...
public class FilterMetaOld // EES-5666 remove
{
...
public class IndicatorMetaOld // EES-5666 remove
{
    public required Guid Id { get; set; }
