    ...
    : NotifierFunctionsIntegrationTest(fixture)
{
        ...
        : ApiSubscriptionFunctionsTests(fixture)
    {
        ...
        public async Task Success()
        {
            ...
            fixture
                ...
                .Callback(
                    ...
                    =>
                        verificationUrl = personalisation[
                            NotifierEmailTemplateFields.VerificationUrl
                        ]
                );
        ...
        public async Task DataSetTitleEmpty_400(string? dataSetTitle)
        {
            ...
            validationProblem.AssertHasNotEmptyError(
                expectedPath: nameof(PendingApiSubscriptionCreateRequest.DataSetTitle)
                    .ToLowerFirst()
            );
        }
        ...
        )
        {
            ...
            Assert.StartsWith(
                ...
                personalisation[NotifierEmailTemplateFields.VerificationUrl]
            );
            return true;
        }
    }
        ...
        : ApiSubscriptionFunctionsTests(fixture)
    {
        ...
        public async Task Success()
        {
            ...
            var subscribeToken = tokenService.GenerateToken(
                pendingSubscription.RowKey,
        ...
        {
            var result = await VerifySubscription(dataSetId: _dataSetId, token: "");
        ...
        )
        {
            Assert.Equal(dataSetTitle, personalisation[NotifierEmailTemplateFields.DataSetTitle]);
            Assert.StartsWith(
                unsubscribeUrlPrefix,
                personalisation[NotifierEmailTemplateFields.UnsubscribeUrl]
            );
            return true;
        }
    }
        ...
        : ApiSubscriptionFunctionsTests(fixture)
    {
        ...
        public async Task Success()
        {
            ...
            var result = await Unsubscribe(dataSetId: _dataSetId, token: unsubscribeToken);
        ...
        public async Task SubscriptionIsStillPending_400()
        {
            ...
            var unsubscribeToken = tokenService.GenerateToken(
                subscription.RowKey,
                subscription.Expiry.Value.UtcDateTime
            );
        ...
        {
            var result = await Unsubscribe(dataSetId: _dataSetId, token: "");
        ...
        : ApiSubscriptionFunctionsTests(fixture)
    {
        ...
        public async Task DataSetIdEmpty_ThrowsValidationException()
        {
            ...
            Assert.Equal(
                "Validation failed:  -- DataSetId: Must not be empty. Severity: Error",
        ...
        public async Task DataSetFileIdEmpty_ThrowsValidationException()
        {
            ...
            Assert.Equal(
                "Validation failed:  -- DataSetFileId: Must not be empty. Severity: Error",
                exception.Message.StripLines()
            );
        }
        ...
        public async Task VersionEmpty_ThrowsValidationException(string? version)
        {
            ...
            Assert.Equal(
                "Validation failed:  -- Version: Must not be empty. Severity: Error",
                exception.Message.StripLines()
            );
        }

        private async Task NotifyApiSubscribers(Guid dataSetId, Guid dataSetFileId, string version)
        {
        ...
        )
        {
            ...
            Assert.Equal(
                dataSetVersion,
                personalisation[NotifierEmailTemplateFields.DataSetVersion]
            );
            Assert.StartsWith(
                unsubscribeUrlPrefix,
                personalisation[NotifierEmailTemplateFields.UnsubscribeUrl]
        ...
        : ApiSubscriptionFunctionsTests(fixture)
    {
        ...
        public async Task Success()
        {
            ...
            await CreateApiSubscriptions(
                pendingAndExpiredSubscription,
                pendingSubscription,
    ...
    public class EmailTemplateOptions
    {
        ...
        public void SelectDataSetPublishedTemplateID_ReturnsCorrectTemplateId(
            string version,
        ...
        )
        {
            ...
            var templateId = govUkNotifyOptions.EmailTemplates.SelectDataSetPublishedTemplateId(
                version
            );
        ...
        public void SelectDataSetPublishedTemplateID_ThrowsArgumentException(string version)
        {
            ...
            var exception = Assert.Throws<ArgumentException>(() =>
                govUkNotifyOptions.EmailTemplates.SelectDataSetPublishedTemplateId(version)
            );
    ...
    private static string ExtractToken(string subscriptionLink) =>
        subscriptionLink.Split("/").Last();
}
