    ...
    public class FootnoteRepositoryTests
    {
        ...
        public async Task GetFilteredFootnotes_FilterByFiltersAndIndicators()
        {
            ...
            await using (var context = InMemoryStatisticsDbContext(contextId))
            {
                ...
                // Any footnotes applying to filter item 2 or indicator 2 should be excluded.
                // This includes the footnotes for filter 1 and indicator 2, filter group 1 and indicator 2,
                // filter item 1 and indicator 2, filter item 2 and indicator 1, filter item 2 and indicator 2.
