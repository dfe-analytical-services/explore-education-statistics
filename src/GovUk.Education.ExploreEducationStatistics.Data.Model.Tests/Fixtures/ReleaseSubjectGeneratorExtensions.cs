...
public static class ReleaseSubjectGeneratorExtensions
{
    ...
    public static Generator<ReleaseSubject> WithDefaults(
    ...
    public static Generator<ReleaseSubject> WithSubject(
        this Generator<ReleaseSubject> generator,
        Subject subject
    ) => generator.ForInstance(s => s.SetSubject(subject));

    public static Generator<ReleaseSubject> WithSubjectId(
        this Generator<ReleaseSubject> generator,
        Guid subjectId
    ...
    public static InstanceSetters<ReleaseSubject> SetDefaults(
