...
public static class ReleaseFootnoteGeneratorExtensions
{
    ...
    public static InstanceSetters<ReleaseFootnote> SetDefaults(this InstanceSetters<ReleaseFootnote> setters)
        => setters
            .SetDefault(rf => rf.ReleaseVersionId)
            .SetDefault(rf => rf.FootnoteId);

    public static Generator<ReleaseFootnote> WithReleaseVersion(this Generator<ReleaseFootnote> generator,
    ...
    public static InstanceSetters<ReleaseFootnote> SetReleaseVersion(this InstanceSetters<ReleaseFootnote> setters,
        ReleaseVersion releaseVersion)
        => setters.Set(rf => rf.ReleaseVersion, releaseVersion);

    public static InstanceSetters<ReleaseFootnote> SetFootnote(this InstanceSetters<ReleaseFootnote> setters,
        Footnote footnote)
