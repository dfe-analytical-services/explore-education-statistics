...
public static class IndicatorGroupGeneratorExtensions
{
    ...
    public static Generator<IndicatorGroup> DefaultIndicatorGroup(
        this DataFixture fixture,
        int indicatorCount
    ) =>
        fixture
            .Generator<IndicatorGroup>()
            .WithDefaults()
            .WithIndicators(fixture.DefaultIndicator().Generate(indicatorCount));

    public static Generator<IndicatorGroup> WithDefaults(
        this Generator<IndicatorGroup> generator
    ) => generator.ForInstance(s => s.SetDefaults());

    public static Generator<IndicatorGroup> WithSubject(
        this Generator<IndicatorGroup> generator,
        Subject subject
    ...
    public static Generator<IndicatorGroup> WithLabel(
        this Generator<IndicatorGroup> generator,
        string label
    ) => generator.ForInstance(s => s.SetLabel(label));

    public static InstanceSetters<IndicatorGroup> SetDefaults(
