...
public static class FilterGroupGeneratorExtensions
{
    ...
    public static Generator<FilterGroup> DefaultFilterGroup(
    ...
    public static Generator<FilterGroup> WithLabel(
        this Generator<FilterGroup> generator,
        string label
    ) => generator.ForInstance(s => s.SetLabel(label));

    public static Generator<FilterGroup> WithFilter(
        this Generator<FilterGroup> generator,
        Filter filter
    ...
    public static InstanceSetters<FilterGroup> SetDefaults(
