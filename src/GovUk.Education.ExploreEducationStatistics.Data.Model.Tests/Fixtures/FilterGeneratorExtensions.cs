...
public static class FilterGeneratorExtensions
{
    ...
    public static Generator<Filter> DefaultFilter(
        ...
        fixture
            .DefaultFilter()
            .WithFilterGroups(_ =>
                fixture.DefaultFilterGroup(filterItemCount: filterItemCount).Generate(filterGroupCount)
            );
    ...
    public static Generator<Filter> WithAutoSelectFilterItem(
    ...
    public static Generator<Filter> WithAutoSelectFilterItemId(
        this Generator<Filter> generator,
        Guid autoSelectFilterItemId
    ) => generator.ForInstance(s => s.SetAutoSelectFilterItemId(autoSelectFilterItemId));

    public static Generator<Filter> WithAutoSelectFilterItemLabel(
        this Generator<Filter> generator,
    ...
    public static Generator<Filter> WithFootnotes(this Generator<Filter> generator, IEnumerable<Footnote> footnotes) =>
    ...
    public static InstanceSetters<Filter> SetLabel(this InstanceSetters<Filter> setters, string label) =>
        setters.Set(f => f.Label, label).Set(f => f.Name, label.SnakeCase());

    public static InstanceSetters<Filter> SetHint(this InstanceSetters<Filter> setters, string? hint) =>
        setters.Set(f => f.Hint, hint);

    public static InstanceSetters<Filter> SetGroupCsvColumn(
        this InstanceSetters<Filter> setters,
        string groupCsvColumn
    ) => setters.Set(f => f.GroupCsvColumn, groupCsvColumn);
    ...
    public static InstanceSetters<Filter> SetAutoSelectFilterItemId(
        this InstanceSetters<Filter> setters,
        Guid autoSelectFilterItemId
    ) => setters.Set(f => f.AutoSelectFilterItemId, autoSelectFilterItemId);

    public static InstanceSetters<Filter> SetAutoSelectFilterItemLabel(
        this InstanceSetters<Filter> setters,
        string autoSelectFilterItemLabel
    ) => setters.Set(f => f.AutoSelectFilterItemLabel, autoSelectFilterItemLabel);

    public static InstanceSetters<Filter> SetSubject(this InstanceSetters<Filter> setters, Subject subject) =>
        setters
            .Set(
                f => f.Subject,
                (_, filter) =>
