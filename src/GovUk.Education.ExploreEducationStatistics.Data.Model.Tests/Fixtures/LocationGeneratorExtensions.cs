...
public static class LocationGeneratorExtensions
{
    ...
    public static Generator<Location> WithGeographicLevel(
        this Generator<Location> generator,
        GeographicLevel level
    ) => generator.ForInstance(s => s.SetGeographicLevel(level));

    public static Generator<Location> WithCountry(
        this Generator<Location> generator,
        Country country
    ) => generator.ForInstance(s => s.SetCountry(country));

    public static Generator<Location> WithRegion(
        this Generator<Location> generator,
        Region region
    ...
    public static Generator<Location> WithPresetLocalAuthority(
        this Generator<Location> generator,
        Region region
    ) => generator.ForInstance(s => s.SetPresetLocalAuthority(region));

    public static Generator<Location> WithPresetRegionAndLocalAuthority(
        this Generator<Location> generator
    ...
    public static InstanceSetters<Location> SetPresetRegionAndLocalAuthority(
        ...
        setters
            ...
            .Set(
                l => l.LocalAuthority,
                (faker, location) =>
                    faker.PickRandom(RegionLocalAuthorities.Value[location.Region!])
            );
}
