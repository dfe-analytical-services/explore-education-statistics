...
{
    public static List<LocalAuthority> EastMidlands =>
        new()
        {
    ...
    public static List<LocalAuthority> EastOfEngland =>
        new()
        {
    ...
    public static List<LocalAuthority> InnerLondon =>
        new()
        {
    ...
    public static List<LocalAuthority> NorthEast =>
        new()
        {
    ...
    public static List<LocalAuthority> NorthWest =>
        new()
        {
    ...
    public static List<LocalAuthority> OuterLondon =>
        new()
        {
    ...
    public static List<LocalAuthority> SouthEast =>
        new()
        {
    ...
    public static List<LocalAuthority> SouthWest =>
        new()
        {
    ...
    public static List<LocalAuthority> WestMidlands =>
        new()
        {
    ...
    public static List<LocalAuthority> YorkshireAndTheHumber =>
        new()
        {
...
{
    public static readonly Lazy<Dictionary<Region, List<LocalAuthority>>> RegionLocalAuthorities =
        new(() =>
            new Dictionary<Region, List<LocalAuthority>>
            {
                { RegionPresets.EastMidlands, LocalAuthorityPresets.EastMidlands },
                { RegionPresets.EastOfEngland, LocalAuthorityPresets.EastOfEngland },
                { RegionPresets.InnerLondon, LocalAuthorityPresets.InnerLondon },
                { RegionPresets.NorthEast, LocalAuthorityPresets.NorthEast },
                { RegionPresets.NorthWest, LocalAuthorityPresets.NorthWest },
                { RegionPresets.OuterLondon, LocalAuthorityPresets.OuterLondon },
                { RegionPresets.SouthEast, LocalAuthorityPresets.SouthEast },
                { RegionPresets.SouthWest, LocalAuthorityPresets.SouthWest },
                { RegionPresets.WestMidlands, LocalAuthorityPresets.WestMidlands },
                {
