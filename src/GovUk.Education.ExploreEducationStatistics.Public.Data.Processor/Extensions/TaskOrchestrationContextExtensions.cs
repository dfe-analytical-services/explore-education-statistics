...
public static class TaskOrchestrationContextExtensions
{
        ...
        TaskOptions? options = null)
    {
        ...
        logger.LogInformation("Attempting to acquire lock '{EntityId}' (InstanceId={InstanceId})",
            activityLockId,
            context.InstanceId);
        ...
        {
            logger.LogInformation("Acquired lock '{EntityId}' (InstanceId={InstanceId})",
                activityLockId,
                context.InstanceId);
            ...
            logger.LogInformation("Releasing lock '{EntityId}' (InstanceId={InstanceId})",
                activityLockId,
                context.InstanceId);
        }
    }
