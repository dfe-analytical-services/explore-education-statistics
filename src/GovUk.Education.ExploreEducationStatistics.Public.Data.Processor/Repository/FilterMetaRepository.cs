...
) : IFilterMetaRepository
{
    ...
    )
    {
        ...
        foreach (var metaRow in metaRows)
        {
            ...
            {
                Id = metaId,
                PublicId = publicIdMappings.Filters.GetValueOrDefault(metaRow.ColName, SqidEncoder.Encode(metaId)),
    ...
    )
    {
        ...
        return new PublicIdMappings { Filters = filterMappings, FilterOptions = filterOptionMappings };
    }
