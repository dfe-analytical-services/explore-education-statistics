    ...
    IDataSetVersionPathResolver dataSetVersionPathResolver) : IDataRepository
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await duckDb.ExecuteAsync("CREATE SEQUENCE data_seq START 1");
        ...
        await duckDb.ExecuteAsync($"CREATE TABLE {DataTable.TableName}({columns.JoinToString(",\n")})");
    ...
    private static LocationColumn[] GetParquetLocationCodeColumns(GeographicLevel geographicLevel)
    {
