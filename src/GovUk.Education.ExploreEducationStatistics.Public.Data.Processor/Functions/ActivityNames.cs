...
internal static class ActivityNames
{
    ...
    public const string HandleProcessingFailure = nameof(
        HandleProcessingFailureFunction.HandleProcessingFailure
    );
    ...
    public const string CreateMappings = nameof(
        ProcessNextDataSetVersionMappingsFunctions.CreateMappings
    );
    public const string ApplyAutoMappings = nameof(
        ProcessNextDataSetVersionMappingsFunctions.ApplyAutoMappings
    );
    ...
    public const string CreateChanges = nameof(
        ProcessCompletionOfNextDataSetVersionFunctions.CreateChanges
    );
