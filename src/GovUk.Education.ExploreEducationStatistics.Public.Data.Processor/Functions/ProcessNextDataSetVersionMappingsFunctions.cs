    ...
    IDataSetVersionMappingService mappingService) : BaseProcessDataSetVersionFunction(publicDataDbContext)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        await mappingService.CreateMappings(dataSetVersionImport.DataSetVersionId, dataSetVersionImport.DataSetVersionToPatch, cancellationToken);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        await mappingService.ApplyAutoMappings(dataSetVersionImport.DataSetVersionId,
            dataSetVersionImport.DataSetVersionToPatch is not null, cancellationToken);
    }
