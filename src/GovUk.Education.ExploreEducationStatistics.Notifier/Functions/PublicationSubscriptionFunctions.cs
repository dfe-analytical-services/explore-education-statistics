    ...
    IValidator<PendingPublicationSubscriptionCreateRequest> requestValidator)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var pendingSubscriptionTable =
            await _publicationSubscriptionRepository.GetTable(NotifierPendingSubscriptionsTableName);
        ...
        string token)
    {
        ...
        var table = await _publicationSubscriptionRepository.GetTable(NotifierSubscriptionsTableName);
        ...
        FunctionContext context)
    {
        ...
        var pendingSubscriptionsTbl = await _publicationSubscriptionRepository.GetTable(NotifierPendingSubscriptionsTableName);
