...
)
{
    private static class FunctionNames
    {
        ...
        public const string RequestPendingSubscription =
            $"{Base}{nameof(RequestPendingSubscription)}";
        public const string RemoveExpiredSubscriptions =
            $"{Base}{nameof(RemoveExpiredSubscriptions)}";
    ...
    public async Task<IActionResult> RequestPendingSubscription(
        [HttpTrigger(
            ...
            "post",
            Route = "public-api/request-pending-subscription"
        )]
        [FromBody]
    ...
    public async Task<IActionResult> Unsubscribe(
        [HttpTrigger(
            AuthorizationLevel.Anonymous,
            "delete",
            Route = "public-api/{dataSetId:guid}/unsubscribe/{token}"
        )]
            HttpRequest request,
        Guid dataSetId,
        string token,
