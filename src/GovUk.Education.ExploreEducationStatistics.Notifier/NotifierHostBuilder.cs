    ...
    public static IHostBuilder ConfigureNotifierHostBuilder(this IHostBuilder hostBuilder)
    {
        return hostBuilder
            ...
            .ConfigureServices(
                ...
                {
                    var appOptions = hostContext.Configuration.GetRequiredSection(
                        AppOptions.Section
                    );

                    var govUkNotifyOptions = hostContext.Configuration.GetRequiredSection(
                        GovUkNotifyOptions.Section
                    );
                    ...
                    services
                        ...
                        .AddValidatorsFromAssembly(
                            typeof(ApiNotificationMessage.Validator).Assembly
                        ) // Adds *all* validators from Notifier.Model
