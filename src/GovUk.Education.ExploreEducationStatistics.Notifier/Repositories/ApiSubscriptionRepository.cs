...
internal class ApiSubscriptionRepository(INotifierTableStorageService notifierTableStorage) : IApiSubscriptionRepository
{
    ...
    public async Task UpdateSubscription(ApiSubscription subscription, CancellationToken cancellationToken = default)
    {
    ...
    public async Task DeleteSubscription(Guid dataSetId, string email, CancellationToken cancellationToken = default)
    {
