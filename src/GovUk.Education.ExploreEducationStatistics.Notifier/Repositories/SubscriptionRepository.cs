...
public class SubscriptionRepository(INotifierTableStorageService notifierTableStorage) : ISubscriptionRepository
{
    ...
    public async Task<Subscription> GetSubscriptionAndStatus(string publicationId, string email)
    {
        ...
        {
            return new Subscription { Entity = pendingSub, Status = SubscriptionStatus.SubscriptionPending };
        }
