...
public class HandleProcessingFailureFunctionTests(ProcessorFunctionsIntegrationTestFixture fixture)
    : ProcessorFunctionsIntegrationTest(fixture)
{
        ...
        : HandleProcessingFailureFunctionTests(fixture)
    {
        ...
        public async Task Success()
        {
            ...
            await function.HandleProcessingFailure(new ProcessInitialDataSetVersionContext
                {
