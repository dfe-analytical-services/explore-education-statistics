...
) : ProcessorFunctionsIntegrationTest(fixture)
{
        ...
        : CreateChangesTests(fixture)
    {
        ...
        public async Task FiltersUpdatedOptionsAdded_ChangesContainOnlyUpdatedFiltersAndAddedOptions()
        {
                        ...
                        s.SetPublicId(SqidEncoder.Encode(2)) // Filter updated
                            .SetOptionLinks(() =>
                                DataFixture
                                    ...
                                    .ForIndex(
                                        0,
                                        UnchangedFilterOptionMetaLinkSetter(
                                            oldFilterMeta[1].OptionLinks[0]
                                        )
                                    ) // Filter Option unchanged
                                    .ForIndex(
                                        1,
                                        ls =>
                                            ls.SetOption(DataFixture.DefaultFilterOptionMeta())
            ...
            Assert.All(
                ...
                c => Assert.Equal(newVersion.Id, c.DataSetVersionId)
            );
        ...
        public async Task FiltersUpdatedOptionsUpdated_ChangesContainOnlyUpdatedFiltersAndUpdatedOptions()
        {
            ...
            AssertSingleFilterOptionUpdated(
                ...
                expectedOldOptionLink: oldFilterMetas[SqidEncoder.Encode(2)].OptionLinks[
                    SqidEncoder.Encode(3)
                ],
                expectedNewOptionLink: newFilterMetas[SqidEncoder.Encode(2)].OptionLinks[
                    SqidEncoder.Encode(3)
                ]
            );
            ...
            AssertSingleFilterOptionUpdated(
                changes: filterOptionMetaChanges,
                expectedOldOptionLink: oldFilterMetas[SqidEncoder.Encode(3)].OptionLinks[
                    SqidEncoder.Encode(6)
                ],
                expectedNewOptionLink: newFilterMetas[SqidEncoder.Encode(3)].OptionLinks[
                    SqidEncoder.Encode(6)
                ]
            );
                        ...
                        newOptionLinks: () =>
                            DataFixture
                                ...
                                .ForIndex(
                                    ...
                                    s =>
                                        s.SetOption(
                                                DataFixture.DefaultFilterOptionMeta().WithLabel("j")
                                            )
                                ...
                                .ForIndex(
                                    ...
                                    s =>
                                        s.SetOption(
                                                DataFixture.DefaultFilterOptionMeta().WithLabel("e")
                                            )
                        ...
                        newOptionLinks: () =>
                            DataFixture
                                ...
                                .ForIndex(
                                    ...
                                    s =>
                                        s.SetOption(
                                                DataFixture.DefaultFilterOptionMeta().WithLabel("g")
                                            )
                                ...
                                .ForIndex(
                                    ...
                                    s =>
                                        s.SetOption(
                                                DataFixture.DefaultFilterOptionMeta().WithLabel("l")
                                            )
        ...
        )
        {
            Assert.Single(
                changes,
                ([UsedImplicitly] c) =>
                    c.PreviousStateId == expectedFilter.Id && c.CurrentStateId is null
            );
        }
        ...
        )
        {
            Assert.Single(
                changes,
                ([UsedImplicitly] c) =>
                    c.PreviousStateId is null && c.CurrentStateId == expectedFilter.Id
            );
        }
        ...
        )
        {
            Assert.Single(
                changes,
                ([UsedImplicitly] c) =>
                    c.PreviousStateId == expectedOldFilter.Id
        ...
        private static Action<
            InstanceSetters<FilterOptionMetaLink>
        > UnchangedFilterOptionMetaLinkSetter(FilterOptionMetaLink filterOptionMetaLink)
        {
            return s =>
        ...
        private async Task<IReadOnlyList<FilterMetaChange>> GetFilterMetaChanges(
        ...
        private async Task<IReadOnlyList<FilterOptionMetaChange>> GetFilterOptionMetaChanges(
            DataSetVersion version
        )
        {
            return await GetDbContext<PublicDataDbContext>()
        ...
        private async Task<(
            ...
            Guid instanceId
        )> CreateDataSetInitialVersion(List<FilterMeta> filterMetas)
        {
        ...
        : CreateChangesTests(fixture)
    {
        ...
        public async Task LocationsAdded_ChangesContainOnlyAddedLocations()
        {
                            ...
                            .SetOptionLinks(() =>
                                DataFixture
                                    ...
                                    .ForIndex(
                                        ...
                                        ls =>
                                            ls.SetOption(
                                                    DataFixture.DefaultLocationLocalAuthorityOptionMeta()
                                                )
                                                .SetPublicId(SqidEncoder.Encode(1))
                                    )
                                    .Generate(1)
                            ...
                            .SetOptionLinks(() =>
                                DataFixture
                                    ...
                                    .ForIndex(
                                        ...
                                        ls =>
                                            ls.SetOption(
                                                    DataFixture.DefaultLocationSchoolOptionMeta()
                                                )
                                                .SetPublicId(SqidEncoder.Encode(2))
                            ...
                            .SetOptionLinks(() =>
                                DataFixture
                                    ...
                                    .ForIndex(
                                        ...
                                        ls =>
                                            ls.SetOption(
                                                    DataFixture.DefaultLocationRscRegionOptionMeta()
                                                )
                                                .SetPublicId(SqidEncoder.Encode(3))
                                    ) // Location Option added
                                    .Generate(1)
            ...
            // Location added
            AssertSingleLocationAdded(
                locationMetaChanges,
                newLocationMetas[GeographicLevel.School]
            );

            // Location added
            AssertSingleLocationAdded(
                locationMetaChanges,
                newLocationMetas[GeographicLevel.RscRegion]
            );
        }
        ...
        public async Task LocationsDeleted_ChangesContainOnlyDeletedLocations()
        {
            ...
            // Location deleted
            AssertSingleLocationDeleted(
                locationMetaChanges,
                oldLocationMetas[GeographicLevel.School]
            );

            // Location deleted
            AssertSingleLocationDeleted(
                locationMetaChanges,
                oldLocationMetas[GeographicLevel.RscRegion]
            );
        }
                    ...
                    UnchangedLocationMetaSetter(
                        ...
                        newOptionLinks: () =>
                            DataFixture
                                ...
                                .ForIndex(
                                    0,
                                    UnchangedLocationOptionMetaLinkSetter(
                                        oldLocationMeta[0].OptionLinks[0]
                                    )
                                ) // Location Option unchanged
                                .ForIndex(
                                    1,
                                    s =>
                                        s.SetOption(
                        ...
                        newOptionLinks: () =>
                            DataFixture
                                ...
                                .ForIndex(
                                    0,
                                    UnchangedLocationOptionMetaLinkSetter(
                                        oldLocationMeta[1].OptionLinks[0]
                                    )
                                ) // Location Option unchanged
                                .ForIndex(
                                    1,
        ...
        public async Task LocationsUnchangedOptionsUpdated_ChangesContainOnlyUpdatedOptions()
        {
            ...
            AssertSingleLocationOptionUpdated(
                ...
                expectedOldOptionLink: oldLocationMetas[GeographicLevel.LocalAuthority][
                    SqidEncoder.Encode(2)
                ],
                expectedNewOptionLink: newLocationMetas[GeographicLevel.LocalAuthority][
                    SqidEncoder.Encode(2)
                ]
            );
            ...
            AssertSingleLocationOptionUpdated(
                changes: locationOptionMetaChanges,
                expectedOldOptionLink: oldLocationMetas[GeographicLevel.School][
                    SqidEncoder.Encode(5)
                ],
                expectedNewOptionLink: newLocationMetas[GeographicLevel.School][
                    SqidEncoder.Encode(5)
                ]
            );
        ...
        public async Task LocationsOptionsAddedAndDeletedAndUpdated_ChangesInsertedIntoDatabaseInCorrectOrder()
        {
                                ...
                                DataFixture
                                    ...
                                    .ForIndex(
                                        ...
                                        ls =>
                                            ls.SetOption(
                                                    DataFixture
                                                        .DefaultLocationCodedOptionMeta()
                                                        .WithLabel("d")
                                                )
                                                .SetPublicId(SqidEncoder.Encode(1))
                                    ) // Location Option deleted
            ...
            AssertLocationOptionDeleted(
                expectedOptionLink: oldLocationMetas[GeographicLevel.EnglishDevolvedArea][
                    SqidEncoder.Encode(2)
                ],
                change: locationOptionMetaChanges[0]
            );
            AssertLocationOptionDeleted(
                expectedOptionLink: oldLocationMetas[GeographicLevel.Country][
                    SqidEncoder.Encode(5)
                ],
            ...
            AssertLocationOptionUpdated(
                expectedOldOptionLink: oldLocationMetas[GeographicLevel.EnglishDevolvedArea][
                    SqidEncoder.Encode(3)
                ],
                expectedNewOptionLink: newLocationMetas[GeographicLevel.EnglishDevolvedArea][
                    SqidEncoder.Encode(3)
                ],
                change: locationOptionMetaChanges[4]
            );
            AssertLocationOptionUpdated(
                expectedOldOptionLink: oldLocationMetas[GeographicLevel.Country][
                    SqidEncoder.Encode(7)
                ],
                expectedNewOptionLink: newLocationMetas[GeographicLevel.Country][
                    SqidEncoder.Encode(7)
                ],
        ...
        )
        {
            Assert.Single(
                changes,
                ([UsedImplicitly] c) =>
                    c.PreviousStateId == expectedLocation.Id && c.CurrentStateId is null
            );
        }
        ...
        )
        {
            Assert.Single(
                changes,
                ([UsedImplicitly] c) =>
                    c.PreviousStateId is null && c.CurrentStateId == expectedLocation.Id
            );
        }

        [UsedImplicitly]
        private static void AssertLocationDeleted(
            LocationMeta expectedLocation,
            LocationMetaChange change
        )
        {
        ...
        private static void AssertLocationAdded(
            LocationMeta expectedLocation,
            LocationMetaChange change
        )
        {
        ...
        private static Action<
            InstanceSetters<LocationOptionMetaLink>
        > UnchangedLocationOptionMetaLinkSetter(LocationOptionMetaLink locationOptionMetaLink)
        {
            return s =>
        ...
        private async Task<IReadOnlyList<LocationMetaChange>> GetLocationMetaChanges(
            DataSetVersion version
        )
        {
            return await GetDbContext<PublicDataDbContext>()
        ...
        private async Task<IReadOnlyList<LocationOptionMetaChange>> GetLocationOptionMetaChanges(
            DataSetVersion version
        )
        {
            return await GetDbContext<PublicDataDbContext>()
        ...
        private async Task<(
            DataSetVersion originalVersion,
            Guid instanceId
        )> CreateDataSetInitialVersion(List<LocationMeta> locationMetas)
        {
            return await CreateDataSetInitialVersion(
                dataSetStatus: DataSetStatus.Published,
                dataSetVersionStatus: DataSetVersionStatus.Published,
        ...
        : CreateChangesTests(fixture)
    {
        ...
        )
        {
            Assert.Single(
                changes,
                ([UsedImplicitly] c) =>
                    c.PreviousStateId == expectedIndicator.Id && c.CurrentStateId is null
            );
        }
        ...
        )
        {
            Assert.Single(
                changes,
                ([UsedImplicitly] c) =>
                    c.PreviousStateId is null && c.CurrentStateId == expectedIndicator.Id
            );
        }

        [UsedImplicitly]
        private static void AssertIndicatorDeleted(
            IndicatorMeta expectedIndicator,
        ...
        private static void AssertIndicatorAdded(
            IndicatorMeta expectedIndicator,
            IndicatorMetaChange change
        )
        {
        ...
        private static Action<InstanceSetters<IndicatorMeta>> UnchangedIndicatorMetaSetter(
        ...
        private async Task<IReadOnlyList<IndicatorMetaChange>> GetIndicatorMetaChanges(
            DataSetVersion version
        )
        {
            return await GetDbContext<PublicDataDbContext>()
        ...
        private async Task<(
            DataSetVersion originalVersion,
            Guid instanceId
        )> CreateDataSetInitialVersion(List<IndicatorMeta> indicatorMetas)
        {
            return await CreateDataSetInitialVersion(
                dataSetStatus: DataSetStatus.Published,
                dataSetVersionStatus: DataSetVersionStatus.Published,
        ...
        : CreateChangesTests(fixture)
    {
        ...
        public async Task TimePeriodsAddedAndDeleted_ChangesContainAdditionsAndDeletions()
        {
            ...
            var originalTimePeriodMetas = originalVersion.TimePeriodMetas.ToDictionary(m =>
                (m.Code, m.Period)
            );
            ...
            var newTimePeriodMetas = newVersion.TimePeriodMetas.ToDictionary(m =>
                (m.Code, m.Period)
            );

            Assert.Null(actualChanges[2].PreviousStateId);
            Assert.Equal(
                newTimePeriodMetas[(TimeIdentifier.AcademicYear, "2023")].Id,
                actualChanges[2].CurrentStateId
            );

            Assert.Null(actualChanges[3].PreviousStateId);
            Assert.Equal(
                newTimePeriodMetas[(TimeIdentifier.AcademicYear, "2024")].Id,
                actualChanges[3].CurrentStateId
            );
        }
        ...
        public async Task TimePeriodsAdded_ChangesContainOnlyAdditions()
        {
            ...
            Assert.Equal(
                newTimePeriodMetas[(TimeIdentifier.AcademicYear, "2019")].Id,
                actualChanges[0].CurrentStateId
            );
            Assert.Equal(
                newTimePeriodMetas[(TimeIdentifier.AcademicYear, "2020")].Id,
                actualChanges[1].CurrentStateId
            );
            Assert.Equal(
                newTimePeriodMetas[(TimeIdentifier.AcademicYear, "2021")].Id,
                actualChanges[2].CurrentStateId
            );
        }
        ...
        public async Task TimePeriodsDeleted_ChangesContainOnlyDeletions()
        {
            ...
            var oldTimePeriodMetas = originalVersion.TimePeriodMetas.ToDictionary(m =>
                (m.Code, m.Period)
            );
    ...
    ) : ProcessCompletionOfNextDataSetVersionFunctionsTests(fixture)
    {
        ...
        {
            var function = GetRequiredService<ProcessCompletionOfNextDataSetVersionFunctions>();
            await function.CompleteNextDataSetVersionImportProcessing(
                instanceId,
