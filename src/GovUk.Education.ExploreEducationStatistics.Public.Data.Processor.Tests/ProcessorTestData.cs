...
public record ProcessorTestData
{
        ...
        new()
        {
            ...
            [
                new FilterMeta
                {
                    ...
                    Options =
                    [
                        new FilterOptionMeta { Id = 1, Label = "Primary sponsor led academy" },
                        new FilterOptionMeta { Id = 2, Label = "Secondary free school" },
                        new FilterOptionMeta { Id = 3, Label = "Secondary sponsor led academy" },
                    ],
                    OptionLinks =
                    [
                ...
                new FilterMeta
                {
                    ...
                    Options =
                    [
                        new FilterOptionMeta { Id = 4, Label = "Year 10" },
                        new FilterOptionMeta { Id = 5, Label = "Year 4" },
                        new FilterOptionMeta { Id = 6, Label = "Year 6" },
                        new FilterOptionMeta { Id = 7, Label = "Year 8" },
                    ],
                    OptionLinks =
                    [
                        new FilterOptionMetaLink
                ...
                new FilterMeta
                {
                    ...
                    Options =
                    [
                        new FilterOptionMeta { Id = 8, Label = "State-funded primary" },
                        new FilterOptionMeta { Id = 9, Label = "State-funded secondary" },
                        new FilterOptionMeta { Id = 10, Label = "Total" },
                    ],
                    OptionLinks =
                    [
                        new FilterOptionMetaLink
    ...
    public static ProcessorTestData FilterDefaultOptions =>
        new()
        {
            ...
            ExpectedGeographicLevels = [GeographicLevel.LocalAuthority],
            ExpectedLocations =
            [
                new LocationMeta
                {
            ...
            [
                new FilterMeta
                {
                    ...
                    Options =
                    [
                        new FilterOptionMeta { Id = 3, Label = "All" },
                        new FilterOptionMeta { Id = 1, Label = "Entry level" },
                        new FilterOptionMeta { Id = 2, Label = "Higher" },
                    ],
                    OptionLinks =
                    [
                        new FilterOptionMetaLink
                ...
                new FilterMeta
                {
                    ...
                    Options =
                    [
                        new FilterOptionMeta { Id = 11, Label = "Biochemistry" },
                        new FilterOptionMeta { Id = 6, Label = "Bricklaying" },
                        new FilterOptionMeta { Id = 4, Label = "Civil engineering" },
                        new FilterOptionMeta { Id = 12, Label = "Electrical engineering" },
                        new FilterOptionMeta { Id = 9, Label = "Forestry" },
                        new FilterOptionMeta { Id = 8, Label = "Hedge rows" },
                        new FilterOptionMeta { Id = 5, Label = "Physics" },
                        new FilterOptionMeta { Id = 7, Label = "Plastering" },
                        new FilterOptionMeta { Id = 10, Label = "Total" },
                    ],
                    OptionLinks =
                    [
                ...
                new FilterMeta
                {
                    ...
                    Options =
                    [
                        new FilterOptionMeta { Id = 17, Label = "All areas" },
                        new FilterOptionMeta { Id = 13, Label = "Construction" },
                        new FilterOptionMeta { Id = 16, Label = "Engineering" },
                        new FilterOptionMeta { Id = 14, Label = "Horticulture" },
                        new FilterOptionMeta { Id = 15, Label = "Science" },
                    ],
                    OptionLinks =
                    [
                        new FilterOptionMetaLink
                ...
                new FilterMeta
                {
                    ...
                    Options =
                    [
                        new FilterOptionMeta { Id = 18, Label = "Academic" },
                        new FilterOptionMeta { Id = 10, Label = "Total" },
                        new FilterOptionMeta { Id = 19, Label = "Vocational" },
                    ],
                    OptionLinks =
                    [
                        new FilterOptionMetaLink
    ...
    private static string DataFilesDirectoryPath =>
        Path.Combine(Assembly.GetExecutingAssembly().GetDirectoryPath(), "Resources", "DataFiles");
}
