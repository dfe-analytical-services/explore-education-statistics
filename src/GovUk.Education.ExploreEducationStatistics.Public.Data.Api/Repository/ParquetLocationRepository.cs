...
) : IParquetLocationRepository
{
    ...
    )
    {
        ...
        foreach (var levelGroup in locationsByLevel)
        {
            ...
            var optionMetas = await command.QueryAsync<ParquetLocationOption>(
                cancellationToken: cancellationToken
            );
    ...
    private static (string Column, string Value) MapLocationToColumnValue(
    ...
    )
    {
        return location switch
        {
            ...
            DataSetQueryLocationId locationId => (
                Column: LocationOptionsTable.Cols.PublicId,
                Value: locationId.Id
            ),
            ...
            DataSetQueryLocationSchoolUrn school => (
                Column: LocationOptionsTable.Cols.Urn,
                Value: school.Urn
            ),
