...
public class Startup(IConfiguration configuration, IHostEnvironment hostEnvironment)
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddScoped<IParquetFilterOptionRepository, ParquetFilterOptionRepository>();
        services.AddScoped<IParquetLocationOptionRepository, ParquetLocationOptionRepository>();
