...
public record DataSetQueryCriteriaFilters
{
    ...
    public static DataSetQueryCriteriaFilters Create(string comparator, IList<string> optionIds)
    {
        ...
        {
            nameof(Eq) => new DataSetQueryCriteriaFilters { Eq = optionIds.Count > 0 ? optionIds[0] : null },
            nameof(NotEq) => new DataSetQueryCriteriaFilters { NotEq = optionIds.Count > 0 ? optionIds[0] : null },
