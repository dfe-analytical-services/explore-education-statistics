...
public static partial class LocationStringValidators
{
    ...
    public static IRuleBuilderOptionsConditions<T, string> LocationString<T>(
                ...
                (value, context) =>
                {
                    ...
                    if (!HasAllowedProperty(level: level, property: property))
                    {
                        context.AddFailure(
                            ...
                            detail: new LocationAllowedPropertyErrorDetail(
                                property,
                                GetAllowedProperties(level: level)
                            )
                        );
                        return;
                    }
                    ...
                    var result = validator.Validate(
                        new ValidationContext<IDataSetQueryLocation>(queryLocation)
                    );
                        ...
                        switch (error.ErrorCode)
                        {
                            ...
                            case FluentValidationKeys.MaximumLengthValidator:
                                ...
                                error.ErrorMessage = context
                                    ...
                                    .BuildMessage(
                                        ValidationMessages.LocationValueMaxLength.Message
                                    );
                                break;
                        }
