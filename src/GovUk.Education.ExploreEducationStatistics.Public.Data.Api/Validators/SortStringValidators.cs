...
public static partial class SortStringValidators
{
    ...
    public static IRuleBuilderOptionsConditions<T, string> SortString<T>(
            ...
            .Custom(
                (value, context) =>
                {
                    ...
                    foreach (var error in result.Errors)
                    {
                        switch (error.PropertyName.ToUpperFirst())
                        {
                            ...
                            case nameof(DataSetQuerySort.Direction)
                                when error.ErrorCode
                                    == Common.Validators.ValidationMessages.AllowedValue.Code:
                        ...
                        error.FormattedMessagePlaceholderValues["Property"] =
                            error.PropertyName.ToLowerFirst();
