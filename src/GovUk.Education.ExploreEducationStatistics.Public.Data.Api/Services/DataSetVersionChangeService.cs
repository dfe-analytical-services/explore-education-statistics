...
) : IDataSetVersionChangeService
{
    ...
    )
    {
        return publicDataDbContext
            ...
            .OnSuccess(version => version.Select(userService.CheckCanViewDataSetVersion).OnSuccessAll())
    ...
    private static DataSetVersionChangeSet MapChanges(DataSetVersion dataSetVersion)
    {
        ...
        var geographicLevelChanges = GetGeographicLevelChanges(dataSetVersion.GeographicLevelMetaChange);
        ...
        var locationOptionChanges = GetLocationOptionChanges(dataSetVersion.LocationOptionMetaChanges);
