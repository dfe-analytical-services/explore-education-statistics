...
public class ReleaseUpdatesServiceMockBuilder
{
    ...
    private static readonly Expression<
        Func<
            IReleaseUpdatesService,
            Task<Either<ActionResult, PaginatedListViewModel<ReleaseUpdateDto>>>
        >
    > GetReleaseUpdates = m =>
        m.GetReleaseUpdates(
            It.IsAny<string>(),
    ...
    public ReleaseUpdatesServiceMockBuilder()
    {
        _mock
            ...
            .ReturnsAsync(() =>
                _releaseUpdates ?? PaginatedListViewModel<ReleaseUpdateDto>.Paginate([], 1, 10)
            );
    }
