...
{
    public static Generator<GeographicLevelMeta> DefaultGeographicLevelMeta(this DataFixture fixture) =>
    ...
    public static InstanceSetters<GeographicLevelMeta> SetDefaults(this InstanceSetters<GeographicLevelMeta> setters) =>
    ...
    public static InstanceSetters<GeographicLevelMeta> SetDataSetVersion(
        ...
        DataSetVersion dataSetVersion
    ) => setters.Set(m => m.DataSetVersion, dataSetVersion).Set(m => m.DataSetVersionId, (_, m) => m.DataSetVersion.Id);
