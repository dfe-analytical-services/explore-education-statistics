...
{
    public static Generator<TimePeriodMetaChange> DefaultTimePeriodMetaChange(this DataFixture fixture)
        => fixture
            .Generator<TimePeriodMetaChange>()
            .WithDefaults();

    public static Generator<TimePeriodMetaChange> WithDefaults(this Generator<TimePeriodMetaChange> generator)
    ...
    public static InstanceSetters<TimePeriodMetaChange> SetDefaults(this InstanceSetters<TimePeriodMetaChange> setters)
        => setters
