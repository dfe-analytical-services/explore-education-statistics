...
{
    public static Generator<TOptionMeta> WithId<TOptionMeta>(this Generator<TOptionMeta> generator, int id)
        where TOptionMeta : LocationOptionMeta => generator.ForInstance(s => s.SetId(id));

    public static Generator<TOptionMeta> WithLabel<TOptionMeta>(this Generator<TOptionMeta> generator, string label)
