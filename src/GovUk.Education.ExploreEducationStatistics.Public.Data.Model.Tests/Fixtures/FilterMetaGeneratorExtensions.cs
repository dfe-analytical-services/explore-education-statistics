...
public static class FilterMetaGeneratorExtensions
{
    ...
    public static InstanceSetters<FilterMeta> SetDefaults(
    ...
    public static InstanceSetters<FilterMeta> SetPublicId(
        this InstanceSetters<FilterMeta> setters,
        string publicId
    ) => setters.Set(m => m.PublicId, publicId);

    public static InstanceSetters<FilterMeta> SetColumn(
        this InstanceSetters<FilterMeta> setters,
        string column
    ) => setters.Set(m => m.Column, column);

    public static InstanceSetters<FilterMeta> SetLabel(
        this InstanceSetters<FilterMeta> setters,
        string label
    ) => setters.Set(m => m.Label, label);

    public static InstanceSetters<FilterMeta> SetHint(
        this InstanceSetters<FilterMeta> setters,
        string hint
