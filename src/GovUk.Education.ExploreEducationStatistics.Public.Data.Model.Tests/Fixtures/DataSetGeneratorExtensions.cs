...
public static class DataSetGeneratorExtensions
{
    ...
    public static InstanceSetters<DataSet> SetId(this InstanceSetters<DataSet> instanceSetter, Guid id) =>
        instanceSetter.Set(ds => ds.Id, id);

    public static InstanceSetters<DataSet> SetTitle(this InstanceSetters<DataSet> instanceSetter, string title) =>
        instanceSetter.Set(ds => ds.Title, title);

    public static InstanceSetters<DataSet> SetSummary(this InstanceSetters<DataSet> instanceSetter, string summary) =>
    ...
    public static InstanceSetters<DataSet> SetSupersedingDataSet(
        this InstanceSetters<DataSet> instanceSetter,
        DataSet? dataSet
    ) => instanceSetter.Set(ds => ds.SupersedingDataSet, dataSet).Set(ds => ds.SupersedingDataSetId, dataSet?.Id);
