...
public static class DataSetVersionGeneratorExtensions
{
    ...
    public static Generator<DataSetVersion> DefaultDataSetVersion(
        ...
        fixture
            ...
            .WithFilterMetas(faker =>
                fixture.DefaultFilterMeta(options: faker.Random.Int(1, maxFilterOptions)).Generate(filters)
            )
            .WithIndicatorMetas(() => fixture.DefaultIndicatorMeta().Generate(indicators))
            .WithLocationMetas(faker =>
                fixture.DefaultLocationMeta(options: faker.Random.Int(1, maxLocationOptions)).Generate(locations)
            )
    ...
    public static Generator<DataSetVersion> WithId(this Generator<DataSetVersion> generator, Guid id) =>
        generator.ForInstance(s => s.SetId(id));

    public static Generator<DataSetVersion> WithDataSet(this Generator<DataSetVersion> generator, DataSet dataSet) =>
        generator.ForInstance(s => s.SetDataSet(dataSet));

    public static Generator<DataSetVersion> WithDataSetId(this Generator<DataSetVersion> generator, Guid dataSetId) =>
        generator.ForInstance(s => s.SetDataSetId(dataSetId));

    public static Generator<DataSetVersion> WithRelease(this Generator<DataSetVersion> generator, Release release) =>
    ...
    public static Generator<DataSetVersion> WithMetaSummary(this Generator<DataSetVersion> generator) =>
    ...
    public static Generator<DataSetVersion> WithGeographicLevelMeta(this Generator<DataSetVersion> generator) =>
    ...
    public static Generator<DataSetVersion> WithNotes(this Generator<DataSetVersion> generator, string notes) =>
    ...
    public static InstanceSetters<DataSetVersion> SetId(this InstanceSetters<DataSetVersion> instanceSetter, Guid id) =>
    ...
    public static InstanceSetters<DataSetVersion> SetStatusProcessing(
        this InstanceSetters<DataSetVersion> instanceSetter
    ) => instanceSetter.SetStatus(DataSetVersionStatus.Processing).SetWithdrawn(null).SetPublished(null);
    ...
    public static InstanceSetters<DataSetVersion> SetStatusMapping(
        this InstanceSetters<DataSetVersion> instanceSetter
    ) => instanceSetter.SetStatus(DataSetVersionStatus.Mapping).SetWithdrawn(null).SetPublished(null);
    ...
    public static InstanceSetters<DataSetVersion> SetMetaSummary(this InstanceSetters<DataSetVersion> instanceSetter) =>
        instanceSetter.Set(dsv => dsv.MetaSummary, (_, dsv) => DataSetVersionMetaSummary.Create(dsv));
