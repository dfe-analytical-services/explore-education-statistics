...
public static class DataSetVersionGeneratorExtensions
{
    ...
    public static Generator<DataSetVersion> WithGeographicLevelMetaChanges(
        this Generator<DataSetVersion> generator,
        IEnumerable<GeographicLevelMetaChange> metaChanges)
        => generator.ForInstance(s => s.SetGeographicLevelMetaChanges(metaChanges));
    ...
    public static InstanceSetters<DataSetVersion> SetGeographicLevelMetaChanges(
        this InstanceSetters<DataSetVersion> instanceSetter,
        IEnumerable<GeographicLevelMetaChange> geographicLevelChanges)
        => instanceSetter.Set(
            dsv => dsv.GeographicLevelMetaChanges,
