...
{
    public static Generator<LocationMetaChange> DefaultLocationMetaChange(
        this DataFixture fixture
    ) => fixture.Generator<LocationMetaChange>().WithDefaults();

    public static Generator<LocationMetaChange> WithDefaults(
    ...
    public static InstanceSetters<LocationMetaChange> SetDefaults(
