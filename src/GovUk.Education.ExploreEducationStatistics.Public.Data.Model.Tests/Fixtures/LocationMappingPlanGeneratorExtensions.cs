...
public static class LocationMappingPlanGeneratorExtensions
{
     ...
     * LocationMappingPlan
     */
    public static Generator<LocationMappingPlan> DefaultLocationMappingPlan(
    ...
    )
    {
        ...
        levels.ForEach(level =>
        {
            ...
            var sourceLocationsForLevel = sourceLocations?.SingleOrDefault(meta =>
                meta.Level == level
            );
            ...
            var targetLocationsForLevel = targetLocations?.SingleOrDefault(meta =>
                meta.Level == level
            );
     ...
     */
    public static Generator<LocationLevelMappings> DefaultLocationLevelMappings(
        this DataFixture fixture
     ...
     */
    public static Generator<MappableLocationOption> DefaultMappableLocationOption(
        this DataFixture fixture
    ) => fixture.Generator<MappableLocationOption>().WithDefaults();

    public static Generator<MappableLocationOption> WithDefaults(
    ...
    public static Generator<MappableLocationOption> WithCodes(
        ...
        generator.ForInstance(s =>
            s.SetCodes(code: code, oldCode: oldCode, urn: urn, laEstab: laEstab, ukprn: ukprn)
        );
     ...
     */
    public static Generator<LocationOptionMapping> DefaultLocationOptionMapping(
        this DataFixture fixture
    ) => fixture.Generator<LocationOptionMapping>().WithDefaults();

    public static Generator<LocationOptionMapping> WithDefaults(
