...
{
    public static Generator<LocationCodedOptionMeta> DefaultLocationCodedOptionMeta(this DataFixture fixture) =>
        fixture.Generator<LocationCodedOptionMeta>().WithDefaults();

    public static Generator<LocationCodedOptionMeta> WithDefaults(this Generator<LocationCodedOptionMeta> generator) =>
