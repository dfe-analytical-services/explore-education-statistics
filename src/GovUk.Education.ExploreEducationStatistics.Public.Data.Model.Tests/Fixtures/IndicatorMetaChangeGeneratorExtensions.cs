...
{
    public static Generator<IndicatorMetaChange> DefaultIndicatorMetaChange(this DataFixture fixture)
        => fixture
            .Generator<IndicatorMetaChange>()
            .WithDefaults();

    public static Generator<IndicatorMetaChange> WithDefaults(this Generator<IndicatorMetaChange> generator)
    ...
    public static InstanceSetters<IndicatorMetaChange> SetDefaults(this InstanceSetters<IndicatorMetaChange> setters)
        => setters
