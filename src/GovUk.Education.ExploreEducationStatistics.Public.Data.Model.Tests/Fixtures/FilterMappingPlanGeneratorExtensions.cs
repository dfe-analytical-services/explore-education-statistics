...
public static class FilterMappingPlanGeneratorExtensions
{
    ...
    )
    {
        ...
        {
            var autoMappedFilter = targetFilters?.SingleOrDefault(f =>
                f.Column == sourceFilter.Column
            );
            ...
            var filterMappingGenerator = fixture
                ...
                .WithType(
                    autoMappedFilter is not null ? MappingType.AutoMapped : MappingType.AutoNone
                )
            ...
            sourceFilter.Options.ForEach(option =>
            {
                ...
                var sourceLink = sourceFilter.OptionLinks.SingleOrDefault(l =>
                    l.OptionId == option.Id
                );
                ...
                filterMappingGenerator.AddOptionMapping(
                    ...
                    mapping: fixture
                        ...
                        .WithPublicId(
                            sourceLink?.PublicId ?? $"{sourceFilter.PublicId} :: {option.Label}"
                        )
                );
            });
    ...
    public static Generator<MappableFilter> WithDefaults(
    ...
    public static Generator<FilterMapping> WithManualMapped(
        ...
        generator.ForInstance(s =>
            s.SetType(MappingType.ManualMapped).SetCandidateKey(candidateKey)
        );
     ...
     */
    public static Generator<FilterMappingCandidate> DefaultFilterMappingCandidate(
        this DataFixture fixture
    ) => fixture.Generator<FilterMappingCandidate>().WithDefaults();

    public static Generator<FilterMappingCandidate> WithDefaults(
     ...
     */
    public static Generator<MappableFilterOption> DefaultMappableFilterOption(
        this DataFixture fixture
    ) => fixture.Generator<MappableFilterOption>().WithDefaults();

    public static Generator<MappableFilterOption> WithDefaults(
     ...
     * FilterOptionMapping
     */
    public static Generator<FilterOptionMapping> DefaultFilterOptionMapping(
        this DataFixture fixture
    ) => fixture.Generator<FilterOptionMapping>().WithDefaults();

    public static Generator<FilterOptionMapping> WithDefaults(
