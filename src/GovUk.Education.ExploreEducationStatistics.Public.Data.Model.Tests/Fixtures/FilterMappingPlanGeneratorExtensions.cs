...
public static class FilterMappingPlanGeneratorExtensions
{
    ...
    )
    {
        ...
        sourceFilters?.ForEach(sourceFilter =>
        {
            ...
            var filterMappingGenerator = fixture
                ...
                .WithSource(fixture.DefaultMappableFilter().WithLabel(sourceFilter.Label))
        ...
        {
            var filterCandidateGenerator = fixture.DefaultFilterMappingCandidate().WithLabel(targetFilter.Label);
            ...
            targetFilter.Options.ForEach(option =>
            {
                filterCandidateGenerator.AddOptionCandidate(
                    ...
                    candidate: fixture.DefaultMappableFilterOption().WithLabel(option.Label)
                );
            });
    ...
    public static Generator<MappableFilter> WithLabel(this Generator<MappableFilter> generator, string label) =>
        generator.ForInstance(s => s.SetLabel(label));

    public static InstanceSetters<MappableFilter> SetDefaults(this InstanceSetters<MappableFilter> setters) =>
    ...
    public static Generator<FilterMapping> WithSource(this Generator<FilterMapping> generator, MappableFilter source) =>
        generator.ForInstance(s => s.SetSource(source));

    public static Generator<FilterMapping> WithPublicId(this Generator<FilterMapping> generator, string publicId) =>
        generator.ForInstance(s => s.SetPublicId(publicId));

    public static Generator<FilterMapping> WithType(this Generator<FilterMapping> generator, MappingType type) =>
        generator.ForInstance(s => s.SetType(type));

    public static Generator<FilterMapping> WithNoMapping(this Generator<FilterMapping> generator) =>
    ...
    public static Generator<FilterMapping> WithAutoNone(this Generator<FilterMapping> generator) =>
    ...
    public static Generator<FilterMapping> WithManualNone(this Generator<FilterMapping> generator) =>
    ...
    public static InstanceSetters<FilterMapping> SetDefaults(this InstanceSetters<FilterMapping> setters) =>
        setters
    ...
    public static Generator<FilterOptionMapping> WithNoMapping(this Generator<FilterOptionMapping> generator) =>
        generator.ForInstance(s => s.SetType(MappingType.None).SetCandidateKey(null));
    ...
    public static Generator<FilterOptionMapping> WithAutoNone(this Generator<FilterOptionMapping> generator) =>
        generator.ForInstance(s => s.SetType(MappingType.AutoNone).SetCandidateKey(null));
    ...
    public static Generator<FilterOptionMapping> WithManualNone(this Generator<FilterOptionMapping> generator) =>
        generator.ForInstance(s => s.SetType(MappingType.ManualNone).SetCandidateKey(null));
    ...
    public static InstanceSetters<FilterOptionMapping> SetDefaults(this InstanceSetters<FilterOptionMapping> setters) =>
        setters
            .SetDefault(mapping => mapping.PublicId)
            .SetDefault(mapping => mapping.Type)
            .SetDefault(mapping => mapping.CandidateKey);
