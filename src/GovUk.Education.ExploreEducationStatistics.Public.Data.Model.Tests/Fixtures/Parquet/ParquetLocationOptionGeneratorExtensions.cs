...
public static class ParquetLocationOptionGeneratorExtensions
{
    ...
    public static Generator<ParquetLocationOption> WithId(this Generator<ParquetLocationOption> generator, int id) =>
    ...
    {
        setters.SetDefault(o => o.Id).SetDefault(o => o.Label).SetDefault(o => o.PublicId).SetLevel(level);

        return level switch
        {
            GeographicLevel.LocalAuthority => setters.SetDefault(o => o.Code).SetDefault(o => o.OldCode),
