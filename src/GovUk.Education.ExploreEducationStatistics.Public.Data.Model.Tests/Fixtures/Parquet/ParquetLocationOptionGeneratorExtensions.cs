...
{
    public static Generator<ParquetLocationOption> DefaultParquetLocationOption(this DataFixture fixture)
        => fixture.Generator<ParquetLocationOption>().WithDefaults();
    ...
    public static InstanceSetters<ParquetLocationOption> SetDefaults(
        ...
        => setters
            ...
            .SetLevel(GeographicLevel.Country)
            .SetDefault(o => o.Code);
