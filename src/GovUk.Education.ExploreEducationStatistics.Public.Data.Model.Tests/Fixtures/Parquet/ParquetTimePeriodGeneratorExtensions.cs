...
public static class ParquetTimePeriodGeneratorExtensions
{
    ...
    public static Generator<ParquetTimePeriod> WithDefaults(
        this Generator<ParquetTimePeriod> generator)
        => generator.ForInstance(s => s.SetDefaults());

    public static Generator<ParquetTimePeriod> WithId(
        this Generator<ParquetTimePeriod> generator,
        int id)
        => generator.ForInstance(s => s.SetId(id));

    public static Generator<ParquetTimePeriod> WithPeriod(
        this Generator<ParquetTimePeriod> generator,
        string period)
    ...
    public static InstanceSetters<ParquetTimePeriod> SetDefaults(
        this InstanceSetters<ParquetTimePeriod> setters)
        => setters
            .SetDefault(o => o.Id)
            .SetDefault(o => o.Period)
            .SetDefault(o => o.Identifier);

    public static InstanceSetters<ParquetTimePeriod> SetId(
        this InstanceSetters<ParquetTimePeriod> setters,
        int id)
