...
public static class ParquetFilterOptionGeneratorExtensions
{
    ...
    public static Generator<ParquetFilterOption> WithDefaults(this Generator<ParquetFilterOption> generator) =>
        generator.ForInstance(s => s.SetDefaults());

    public static Generator<ParquetFilterOption> WithId(this Generator<ParquetFilterOption> generator, int id) =>
    ...
    public static InstanceSetters<ParquetFilterOption> SetDefaults(this InstanceSetters<ParquetFilterOption> setters) =>
        setters
            .SetDefault(o => o.Id)
