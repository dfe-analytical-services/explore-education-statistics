...
public static class ReleaseGeneratorExtensions
{
    ...
    public static Generator<Release> WithDataSetFileId(this Generator<Release> generator, Guid dataSeFileId) =>
        generator.ForInstance(s => s.SetDataSetFileId(dataSeFileId));

    public static Generator<Release> WithReleaseFileId(this Generator<Release> generator, Guid releaseFileId) =>
    ...
    public static InstanceSetters<Release> SetSlug(this InstanceSetters<Release> instanceSetter, string slug) =>
        instanceSetter.Set(r => r.Slug, slug);

    public static InstanceSetters<Release> SetTitle(this InstanceSetters<Release> instanceSetter, string title) =>
