...
public class SearchableDocumentRemoverMockBuilder
{
    ...
    public SearchableDocumentRemoverMockBuilder()
    {
        ...
        _mock
            ...
            .ReturnsAsync(
                _removePublicationSearchableDocumentsResponse
                    ?? new RemovePublicationSearchableDocumentsResponse(
        ...
        _mock
            ...
            .ReturnsAsync(
                _removeSearchableDocumentResponse
                    ?? new RemoveSearchableDocumentResponse(Success: true)
            );
    ...
    public SearchableDocumentRemoverMockBuilder WhereResponseIs(
        RemovePublicationSearchableDocumentsResponse response
    )
    {
    ...
    public SearchableDocumentRemoverMockBuilder WhereResponseIs(
        RemoveSearchableDocumentResponse response
    )
    {
    ...
    public class Asserter(Mock<ISearchableDocumentRemover> mock)
    {
        ...
        {
            mock.Verify(
                m => m.RemoveAllSearchableDocuments(It.IsAny<CancellationToken>()),
                Times.Once
            );
        }
    }
