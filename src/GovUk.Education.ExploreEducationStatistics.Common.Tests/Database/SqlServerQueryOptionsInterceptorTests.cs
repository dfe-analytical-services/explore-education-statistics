...
public abstract class SqlServerQueryOptionsInterceptorTests
{
    public class SqlServerQueryOptionsInterceptorSqlProcessorDependencyTests : SqlServerQueryOptionsInterceptorTests
    {
        ...
        {
            AssertSqlProcessorCalled((interceptor, dbCommand) => 
        ...
        {
            await AssertSqlProcessorCalledAsync((interceptor, dbCommand) => 
                interceptor.ReaderExecutingAsync(
                    command: dbCommand,
                    eventData: null!,
                    result: default));
        }
        ...
        {
            await AssertSqlProcessorCalledAsync((interceptor, dbCommand) => 
                interceptor.ScalarExecutingAsync(
                    command: dbCommand,
                    eventData: null!,
                    result: default));
        }
        ...
        {
            await AssertSqlProcessorCalledAsync((interceptor, dbCommand) => 
                interceptor.NonQueryExecutingAsync(
                    command: dbCommand,
                    eventData: null!,
                    result: default));
        }
    ...
    public class SqlServerQueryOptionsInterceptorSqlProcessorTests : SqlServerQueryOptionsInterceptorTests
    {
        ...
        [Fact]
        public void
            GivenExistingSqlHasNoOptionClause_WhenMultipleWithOptionsCommentsPresent_ThenOptionsAreMergedAndDeduplicated()
        {
            const string originalSql =
                """
                -- tenant: 42
        ...
        [Fact]
        public void
            GivenExistingSqlHasOptionClause_WhenMultipleWithOptionsCommentsPresent_ThenOptionsAreMergedAndDeduplicated()
        {
            const string originalSql =
                """
                -- Some comments.
