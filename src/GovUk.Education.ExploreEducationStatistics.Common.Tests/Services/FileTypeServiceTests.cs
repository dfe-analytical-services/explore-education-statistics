...
public class FileTypeServiceTests
{
    ...
    private static readonly FileInfo Ods = new(
        "test.ods",
        "application/vnd.oasis.opendocument.spreadsheet"
    );

    private static readonly FileInfo Odt = new(
        "test.odt",
    ...
    public async Task HasMatchingMimeType_ValidChartFileUploads()
    {
        ...
        foreach (var type in AllTypes)
        {
            ...
            await AssertHasMatchingMimeType(
                type,
                AllowedChartFileTypes.ToList(),
                expectedToSucceed
            );
        }
    }
    ...
    public async Task HasMatchingMimeType_ValidZipFileUploads()
    {
        foreach (var type in AllTypes)
        {
            ...
            await AssertHasMatchingMimeType(
                type,
                AllowedZipFileMimeTypes.ToList(),
                expectedToSucceed
            );
        }
    }
