...
public class DataFixture
{
    ...
    private static int GenerateUniqueStartingSeedForType<T>(int seedFrom) where T : class
    {
        var md5Hasher = MD5.Create();
        var hashed = md5Hasher.ComputeHash(Encoding.UTF8.GetBytes(typeof(T).GetPrettyFullName()));
        var uniqueStartingSeedForType = seedFrom + BitConverter.ToInt32(hashed, 0);
        return uniqueStartingSeedForType;
    }
}
