...
public static class ClaimsPrincipalGeneratorExtensions
{
    ...
    public static Generator<ClaimsPrincipal> WithClaims(
        this Generator<ClaimsPrincipal> generator,
        Claim[] claims
