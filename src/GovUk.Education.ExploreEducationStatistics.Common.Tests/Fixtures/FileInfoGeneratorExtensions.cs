...
public static class FileInfoGeneratorExtensions
{
    ...
    public static Generator<FileInfo> WithSummary(this Generator<FileInfo> generator, string summary)
        => generator.ForInstance(f => f.SetSummary(summary));

    public static Generator<FileInfo> WithFileName(this Generator<FileInfo> generator, string fileName)
    ...
    public static Generator<FileInfo> WithUserName(this Generator<FileInfo> generator, string userName)
    ...
    public static InstanceSetters<FileInfo> SetName(this InstanceSetters<FileInfo> setters, string name)
    ...
    public static InstanceSetters<FileInfo> SetType(this InstanceSetters<FileInfo> setters, FileType type)
        => setters.Set(f => f.Type, type);

    public static InstanceSetters<FileInfo> SetUserName(this InstanceSetters<FileInfo> setters, string userName)
