...
public class CancellationTokenTimeoutAspectTests : IClassFixture<CancellationTokenTimeoutTestFixture>
{
    private static class TestMethods
    {
        ...
        [CancellationTokenTimeout(TimeoutMillis)]
        public static void AddTimeout(Action<CancellationToken?> assertions, CancellationToken? token = null)
        {
    ...
    public void TimeoutExceededWithMisconfiguredConfiguration()
    {
        ...
        Assert.Equal(
            $"Timeout configuration setting for key {MisconfiguredConfigurationItemKey} " + $"must be an integer",
            exception.Message
        );
    }
    ...
    public void TimeoutExceededWithMissingConfiguration()
    {
        ...
        Assert.Equal(
            $"Could not find timeout configuration setting for " + $"key {MissingConfigurationItemKey}",
            exception.Message
        );
    }
