...
public static class StartupSecurityConfiguration
{
    ...
    public static void ConfigureAuthorizationPolicies(IServiceCollection services)
    {
        services.AddAuthorization(options =>
        {
             ...
             */
            options.AddPolicy(
                SecurityPolicies.IsBauUser.ToString(),
                policy => policy.RequireRole(RoleNames.BauUser)
            );
            ...
            options.AddPolicy(
                ...
                policy =>
                    policy.Requirements.Add(
                        new ViewSpecificPublicationReleaseTeamAccessRequirement()
                    )
            );
            ...
            options.AddPolicy(
                ...
                policy =>
                    policy.Requirements.Add(
                        new AssignPrereleaseContactsToSpecificReleaseRequirement()
                    )
            );
            ...
            options.AddPolicy(
                ...
                policy =>
                    policy.Requirements.Add(
                        new CreateMethodologyForSpecificPublicationRequirement()
                    )
            );
            ...
            options.AddPolicy(
                ...
                policy =>
                    policy.Requirements.Add(
                        new ManageExternalMethodologyForSpecificPublicationRequirement()
                    )
            );
    ...
    public static void ConfigureResourceBasedAuthorization(IServiceCollection services)
    {
        ...
        services.AddTransient<
            ...
            UpdatePublicationSummaryAuthorizationHandler
        >();
        services.AddTransient<IAuthorizationHandler, UpdateContactAuthorizationHandler>();
        services.AddTransient<
            IAuthorizationHandler,
            CreatePublicationForSpecificThemeAuthorizationHandler
        >();
        services.AddTransient<
            IAuthorizationHandler,
        ...
        services.AddTransient<
            IAuthorizationHandler,
            ManagePublicationReleaseSeriesAuthorizationHandler
        >();
        ...
        services.AddTransient<
            IAuthorizationHandler,
            UpdateSpecificReleaseVersionAuthorizationHandler
        >();
        ...
        services.AddTransient<
            IAuthorizationHandler,
            MarkReleaseAsHigherLevelReviewAuthorizationHandler
        >();
        services.AddTransient<IAuthorizationHandler, MarkReleaseAsApprovedAuthorizationHandler>();
        services.AddTransient<
            IAuthorizationHandler,
            MakeAmendmentOfSpecificReleaseAuthorizationHandler
        >();
        ...
        services.AddTransient<
            IAuthorizationHandler,
            CancelSpecificFileImportAuthorizationHandler
        >();
        services.AddTransient<
            IAuthorizationHandler,
        ...
        services.AddTransient<
            IAuthorizationHandler,
            AssignPrereleaseContactsToSpecificReleaseAuthorizationHandler
        >();
        ...
        services.AddTransient<
            IAuthorizationHandler,
            MakeAmendmentOfSpecificMethodologyAuthorizationHandler
        >();
        services.AddTransient<
            IAuthorizationHandler,
