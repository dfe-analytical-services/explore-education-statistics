...
{
    public static IRuleBuilderOptions<T, FileDto> MustHaveAValidFileName<T>(this IRuleBuilder<T, FileDto> ruleBuilder)
    {
        return ruleBuilder
            .Must(
                (_, dto, context) =>
    ...
    public static IRuleBuilderOptions<T, FileDto> MustNotBeAnEmptyFile<T>(this IRuleBuilder<T, FileDto> ruleBuilder)
    {
        return ruleBuilder
            .Must(
                (_, dto, context) =>
    ...
    public static IRuleBuilderOptions<T, FileDto> MustBeValidFile<T>(this IRuleBuilder<T, FileDto> ruleBuilder)
    {
        return ruleBuilder.MustNotBeAnEmptyFile().MustHaveAValidFileName().When(dto => dto is not null);
    }

    public static IRuleBuilderOptions<T, FileDto> MustBeValidDataFile<T>(this IRuleBuilder<T, FileDto> ruleBuilder)
    {
        return ruleBuilder
            .MustBeValidFile()
            .Must(
    ...
    public static IRuleBuilderOptions<T, FileDto> MustBeValidMetaFile<T>(this IRuleBuilder<T, FileDto> ruleBuilder)
    {
        return ruleBuilder
            .MustBeValidFile()
            .Must(
