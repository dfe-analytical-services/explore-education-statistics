...
/// <see cref="DataBlockVersionViewModel" /> destination instances if they have been mapped from a source
/// <see cref="DataBlock"/>, which does not have a DataBlockParentId present in its attributes.
///
/// Note that this is not necessary to do for <see cref="DataBlockVersionViewModel" /> destination instances if the source is
...
/// </summary>
public class DataBlockVersionViewModelPostMappingAction : IMappingAction<DataBlock, DataBlockVersionViewModel>
{
    ...
    public void Process(DataBlock source, DataBlockVersionViewModel destination, ResolutionContext context)
    {
