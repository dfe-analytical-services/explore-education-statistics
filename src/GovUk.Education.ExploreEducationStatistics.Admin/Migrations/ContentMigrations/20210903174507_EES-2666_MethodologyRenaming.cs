...
public partial class EES2666_MethodologyRenaming : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropPrimaryKey(name: "PK_PublicationMethodologies", table: "PublicationMethodologies");
        ...
        migrationBuilder.DropIndex(name: "IX_MethodologyFiles_MethodologyId", table: "MethodologyFiles");
        ...
        migrationBuilder.RenameColumn(name: "MethodologyParentId", table: "Methodologies", newName: "MethodologyId");

        migrationBuilder.RenameTable(name: "Methodologies", newName: "MethodologyVersions");

        migrationBuilder.RenameTable(name: "MethodologyParents", newName: "Methodologies");
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropIndex(name: "IX_MethodologyVersions_MethodologyId", table: "MethodologyVersions");

        migrationBuilder.DropIndex(name: "IX_MethodologyFiles_MethodologyVersionId", table: "MethodologyFiles");
        ...
        migrationBuilder.RenameTable(name: "Methodologies", newName: "MethodologyParents");

        migrationBuilder.RenameTable(name: "MethodologyVersions", newName: "Methodologies");
        ...
        migrationBuilder.RenameColumn(name: "MethodologyId", table: "Methodologies", newName: "MethodologyParentId");
