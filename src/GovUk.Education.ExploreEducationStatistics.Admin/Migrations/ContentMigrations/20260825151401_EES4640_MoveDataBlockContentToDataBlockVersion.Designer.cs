...
namespace GovUk.Education.ExploreEducationStatistics.Admin.Migrations.ContentMigrations
{
    ...
    [Migration("20260825151401_EES4640_MoveDataBlockContentToDataBlockVersion")]
    partial class EES4640_MoveDataBlockContentToDataBlockVersion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Content.Model.DataSetMapping", b =>
                {
                    ...
                    b.Property<string>("FilterMappings")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("IndicatorMappings")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("UnmappedReplacementFilters")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Content.Model.DataSetUpload", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ScreenerProgressLastChecked")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset?>("ScreenerProgressLastUpdated")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Content.Model.EinContentBlock", b =>
                {
                    ...
                    b.Property<Guid>("EinContentSectionId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("EinContentSectionId");

                    b.ToTable("EinContentBlocks");

                    b.HasDiscriminator<string>("Type").HasValue("EinContentBlock");
            ...
            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Content.Model.FeaturedTable", b =>
                {
                    ...
                    b.Property<Guid>("DataBlockVersionId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Content.Model.Organisation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ReleaseVersionPublishingOrganisations", b =>
                {
                    ...
                    b.HasKey("OrganisationId", "ReleaseVersionId");

                    b.HasIndex("ReleaseVersionId");

                    b.ToTable("ReleaseVersionPublishingOrganisations");
                });

            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Content.Model.DataBlockVersionLink", b =>
                {
                    ...
                    b.HasIndex("DataBlockVersionId")
                        .IsUnique()
                        .HasFilter("[DataBlockVersionId] IS NOT NULL");

                    b.HasDiscriminator().HasValue("DataBlockVersionLink");
                });
            ...
            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Content.Model.EinHtmlBlock", b =>
                {
            ...
            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Content.Model.DataBlock", b =>
                {
                    b.HasOne("GovUk.Education.ExploreEducationStatistics.Content.Model.DataBlockVersion", "LatestDraftVersion")
                        .WithOne()
                        .HasForeignKey("GovUk.Education.ExploreEducationStatistics.Content.Model.DataBlock", "LatestDraftVersionId");

                    b.HasOne("GovUk.Education.ExploreEducationStatistics.Content.Model.DataBlockVersion", "LatestPublishedVersion")
                        .WithOne()
                        .HasForeignKey("GovUk.Education.ExploreEducationStatistics.Content.Model.DataBlock", "LatestPublishedVersionId");
            ...
            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Content.Model.EinContentBlock", b =>
                {
                    b.HasOne("GovUk.Education.ExploreEducationStatistics.Content.Model.EinContentSection", "EinContentSection")
                        .WithMany("Content")
                        .HasForeignKey("EinContentSectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("EinContentSection");
                });
            ...
            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Content.Model.FeaturedTable", b =>
                {
                    ...
                    b.HasOne("GovUk.Education.ExploreEducationStatistics.Content.Model.DataBlockVersion", "DataBlockVersion")
                        .WithOne()
                        .HasForeignKey("GovUk.Education.ExploreEducationStatistics.Content.Model.FeaturedTable", "DataBlockVersionId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("ReleaseVersionPublishingOrganisations", b =>
                {
                    b.HasOne("GovUk.Education.ExploreEducationStatistics.Content.Model.Organisation", null)
                        .WithMany()
                        .HasForeignKey("OrganisationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GovUk.Education.ExploreEducationStatistics.Content.Model.ReleaseVersion", null)
                        .WithMany()
                        .HasForeignKey("ReleaseVersionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Content.Model.DataBlockVersionLink", b =>
                {
                    b.HasOne("GovUk.Education.ExploreEducationStatistics.Content.Model.DataBlockVersion", "DataBlockVersion")
                        .WithOne()
                        .HasForeignKey("GovUk.Education.ExploreEducationStatistics.Content.Model.DataBlockVersionLink", "DataBlockVersionId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Content.Model.KeyStatisticDataBlock", b =>
                {
                    ...
                    b.HasOne("GovUk.Education.ExploreEducationStatistics.Content.Model.DataBlockVersion", "DataBlockVersion")
                        .WithMany()
                        .HasForeignKey("DataBlockVersionId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
