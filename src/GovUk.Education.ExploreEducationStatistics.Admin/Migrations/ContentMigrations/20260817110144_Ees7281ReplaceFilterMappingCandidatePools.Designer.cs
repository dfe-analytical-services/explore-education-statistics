...
namespace GovUk.Education.ExploreEducationStatistics.Admin.Migrations.ContentMigrations
{
    ...
    [Migration("20260817110144_Ees7281ReplaceFilterMappingCandidatePools")]
    partial class Ees7281ReplaceFilterMappingCandidatePools
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Content.Model.DataSetMapping", b =>
                {
                    ...
                    b.Property<string>("ReplacementFilterGroups")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ReplacementFilterItems")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ReplacementFilters")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Content.Model.DataBlockVersion", b =>
                {
                    b.HasOne("GovUk.Education.ExploreEducationStatistics.Content.Model.DataBlock", "ContentBlock")
                        .WithOne("DataBlockVersion")
                        .HasForeignKey("GovUk.Education.ExploreEducationStatistics.Content.Model.DataBlockVersion", "ContentBlockId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
