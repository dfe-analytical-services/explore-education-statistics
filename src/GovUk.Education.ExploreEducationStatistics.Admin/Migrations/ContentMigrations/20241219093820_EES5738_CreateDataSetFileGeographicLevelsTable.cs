...
public partial class EES5738_CreateDataSetFileGeographicLevelsTable : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                DataSetFileVersionId = table.Column<Guid>(
                    type: "uniqueidentifier",
                    nullable: false
                ),
                GeographicLevel = table.Column<string>(
                    type: "nvarchar(6)",
                    maxLength: 6,
                    nullable: false
                ),
        ...
        migrationBuilder.Sql(
            "GRANT SELECT ON dbo.DataSetFileVersionGeographicLevels TO [content];"
        );
        migrationBuilder.Sql(
            "GRANT INSERT ON dbo.DataSetFileVersionGeographicLevels TO [importer];"
        );
