    ...
    public partial class ApproveReleases : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                values: new object[] { new DateTime(2020, 3, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2020, 3, 25, 9, 30, 0, 0, DateTimeKind.Unspecified), "Approved" });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("63227211-7cb3-408c-b5c2-40d3d7cb2717"),
                columns: new[] { "PublishScheduled", "Published", "Status" },
                values: new object[] { null, new DateTime(2018, 6, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "Draft" });
