...
public partial class EES2156_MigrateMethodologyTitleAndSlugToParentAndAddAlternativeTitleField
    : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropColumn(name: "Title", table: "Methodologies");
    }

    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.DropColumn(name: "OwningPublicationTitle", table: "MethodologyParents");

        migrationBuilder.DropColumn(name: "Slug", table: "MethodologyParents");

        migrationBuilder.DropColumn(name: "AlternativeTitle", table: "Methodologies");
