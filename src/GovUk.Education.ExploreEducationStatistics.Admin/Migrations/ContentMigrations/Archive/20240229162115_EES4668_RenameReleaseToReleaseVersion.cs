...
public partial class EES4668_RenameReleaseToReleaseVersion : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropForeignKey(name: "FK_DataBlockVersions_Releases_ReleaseId", table: "DataBlockVersions");

        migrationBuilder.DropForeignKey(name: "FK_FeaturedTables_Releases_ReleaseId", table: "FeaturedTables");

        migrationBuilder.DropForeignKey(name: "FK_KeyStatistics_Releases_ReleaseId", table: "KeyStatistics");
        ...
        migrationBuilder.DropForeignKey(name: "FK_ReleaseFiles_Releases_ReleaseId", table: "ReleaseFiles");

        migrationBuilder.DropForeignKey(name: "FK_ReleaseStatus_Releases_ReleaseId", table: "ReleaseStatus");

        migrationBuilder.DropForeignKey(name: "FK_Update_Releases_ReleaseId", table: "Update");

        migrationBuilder.DropForeignKey(name: "FK_UserReleaseInvites_Releases_ReleaseId", table: "UserReleaseInvites");

        migrationBuilder.DropForeignKey(name: "FK_UserReleaseRoles_Releases_ReleaseId", table: "UserReleaseRoles");

        // Drop the unique index on Publications.LatestPublishedReleaseId
        // so the column can be renamed
        migrationBuilder.DropIndex(name: "IX_Publications_LatestPublishedReleaseId", table: "Publications");

        // Rename the Releases table to ReleaseVersions
        migrationBuilder.RenameTable(name: "Releases", newName: "ReleaseVersions");

        // Rename the ReleaseId column to ReleaseVersionId in the 12 foreign key columns
        migrationBuilder.RenameColumn(name: "ReleaseId", table: "ContentBlock", newName: "ReleaseVersionId");

        migrationBuilder.RenameColumn(name: "ReleaseId", table: "ContentSections", newName: "ReleaseVersionId");

        migrationBuilder.RenameColumn(name: "ReleaseId", table: "DataBlockVersions", newName: "ReleaseVersionId");

        migrationBuilder.RenameColumn(name: "ReleaseId", table: "FeaturedTables", newName: "ReleaseVersionId");

        migrationBuilder.RenameColumn(name: "ReleaseId", table: "KeyStatistics", newName: "ReleaseVersionId");
        ...
        migrationBuilder.RenameColumn(name: "ReleaseId", table: "ReleaseFiles", newName: "ReleaseVersionId");

        migrationBuilder.RenameColumn(name: "ReleaseId", table: "ReleaseStatus", newName: "ReleaseVersionId");

        migrationBuilder.RenameColumn(name: "ReleaseId", table: "Update", newName: "ReleaseVersionId");

        migrationBuilder.RenameColumn(name: "ReleaseId", table: "UserReleaseInvites", newName: "ReleaseVersionId");

        migrationBuilder.RenameColumn(name: "ReleaseId", newName: "ReleaseVersionId", table: "UserReleaseRoles");
        ...
        migrationBuilder.RenameColumn(name: "ReleaseId", table: "Permalinks", newName: "ReleaseVersionId");
