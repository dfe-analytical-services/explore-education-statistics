...
public partial class EES968AddNDeletedAndDeletedByIdToUserReleaseRolesTable : Migration
{
    ...
    {
        migrationBuilder.AddColumn<DateTime>(name: "Created", table: "UserReleaseRoles", nullable: true);

        migrationBuilder.AddColumn<Guid>(name: "CreatedById", table: "UserReleaseRoles", nullable: true);

        migrationBuilder.AddColumn<DateTime>(name: "Deleted", table: "UserReleaseRoles", nullable: true);

        migrationBuilder.AddColumn<Guid>(name: "DeletedById", table: "UserReleaseRoles", nullable: true);
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropIndex(name: "IX_UserReleaseRoles_CreatedById", table: "UserReleaseRoles");
