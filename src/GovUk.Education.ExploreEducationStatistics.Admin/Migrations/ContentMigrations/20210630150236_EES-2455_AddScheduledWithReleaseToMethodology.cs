...
public partial class EES2455_AddScheduledWithReleaseToMethodology : Migration
{
    ...
    {
        migrationBuilder.AddColumn<Guid>(name: "ScheduledWithReleaseId", table: "Methodologies", nullable: true);
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropIndex(name: "IX_Methodologies_ScheduledWithReleaseId", table: "Methodologies");
