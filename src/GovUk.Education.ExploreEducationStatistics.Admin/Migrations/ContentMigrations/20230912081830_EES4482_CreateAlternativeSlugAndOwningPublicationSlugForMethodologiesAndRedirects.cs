...
public partial class EES4482_CreateAlternativeSlugAndOwningPublicationSlugForMethodologiesAndRedirects
    : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                MethodologyVersionId = table.Column<Guid>(
            ...
            {
                table.PrimaryKey(
                    "PK_MethodologyRedirects",
                    x => new { x.MethodologyVersionId, x.Slug }
                );
                table.ForeignKey(
