            ...
            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Content.Model.File", b =>
                {
                    ...
                    b.Property<string>("DataSetFileMetaOld")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Content.Model.File", b =>
                {
                    ...
                    b.OwnsOne("GovUk.Education.ExploreEducationStatistics.Content.Model.DataSetFileMeta", "DataSetFileMeta", b1 =>
                        {
                            ...
                            b1.ToJson("DataSetFileMeta");

                            b1.WithOwner()
                                .HasForeignKey("FileId");

                            b1.OwnsMany("GovUk.Education.ExploreEducationStatistics.Content.Model.FilterMeta", "Filters", b2 =>
                                {
                                    b2.Property<Guid>("DataSetFileMetaFileId")
                                        .HasColumnType("uniqueidentifier");
                                    ...
                                    b2.Property<string>("ColumnName")
                                        .IsRequired()
                                        .HasColumnType("nvarchar(max)");

                                    b2.Property<Guid>("FilterId")
                                        .HasColumnType("uniqueidentifier");
                                    ...
                                    b2.HasKey("DataSetFileMetaFileId", "Id");

                                    b2.ToTable("Files");

                                    b2.WithOwner()
                                        .HasForeignKey("DataSetFileMetaFileId");
                                });

                            b1.OwnsMany("GovUk.Education.ExploreEducationStatistics.Content.Model.GeographicLevelMeta", "GeographicLevels", b2 =>
                                {
                                    b2.Property<Guid>("DataSetFileMetaFileId")
                                        .HasColumnType("uniqueidentifier");
                            ...
                            b1.OwnsMany("GovUk.Education.ExploreEducationStatistics.Content.Model.IndicatorMeta", "Indicators", b2 =>
                                {
                                    b2.Property<Guid>("DataSetFileMetaFileId")
                                        .HasColumnType("uniqueidentifier");
                            ...
                            b1.OwnsOne("GovUk.Education.ExploreEducationStatistics.Content.Model.TimePeriodRangeMeta", "TimePeriodRange", b2 =>
                                {
                                    b2.Property<Guid>("DataSetFileMetaFileId")
                                        .HasColumnType("uniqueidentifier");

                                    b2.HasKey("DataSetFileMetaFileId");
                                    ...
                                    b2.OwnsOne("GovUk.Education.ExploreEducationStatistics.Content.Model.TimePeriodRangeBoundMeta", "End", b3 =>
                                        {
                                            b3.Property<Guid>("TimePeriodRangeMetaDataSetFileMetaFileId")
                                                .HasColumnType("uniqueidentifier");
                                            ...
                                            b3.HasKey("TimePeriodRangeMetaDataSetFileMetaFileId");

                                            b3.ToTable("Files");

                                            b3.WithOwner()
                                                .HasForeignKey("TimePeriodRangeMetaDataSetFileMetaFileId");
                                        });

                                    b2.OwnsOne("GovUk.Education.ExploreEducationStatistics.Content.Model.TimePeriodRangeBoundMeta", "Start", b3 =>
                                        {
                                            b3.Property<Guid>("TimePeriodRangeMetaDataSetFileMetaFileId")
                                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.Navigation("Filters");

                            b1.Navigation("GeographicLevels");

                            b1.Navigation("Indicators");
