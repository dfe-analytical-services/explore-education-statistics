...
public partial class EES5625_CopyReleaseVersionFieldsToRelease : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.AddColumn<int>(name: "Year", table: "Releases", type: "int", nullable: true);
    ...
    {
        migrationBuilder.DropForeignKey(name: "FK_Releases_Publications_PublicationId", table: "Releases");
