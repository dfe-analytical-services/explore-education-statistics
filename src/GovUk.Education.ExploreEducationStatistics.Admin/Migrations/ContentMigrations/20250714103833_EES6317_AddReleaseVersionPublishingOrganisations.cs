...
public partial class EES6317_AddReleaseVersionPublishingOrganisations : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.Sql(
            "GRANT SELECT ON dbo.ReleaseVersionPublishingOrganisations TO [content];"
        );
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.Sql(
            "REVOKE SELECT ON dbo.ReleaseVersionPublishingOrganisations TO [content];"
        );
        migrationBuilder.Sql("REVOKE SELECT ON dbo.Organisations TO [publisher];");
        migrationBuilder.Sql(
            "REVOKE SELECT ON dbo.ReleaseVersionPublishingOrganisations TO [publisher];"
        );
