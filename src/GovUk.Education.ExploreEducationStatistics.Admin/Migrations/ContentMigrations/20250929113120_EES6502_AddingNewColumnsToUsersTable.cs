...
public partial class EES6502_AddingNewColumnsToUsersTable : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.AddColumn<Guid>(name: "CreatedById", table: "Users", type: "uniqueidentifier", nullable: true);

        // Add 'RoleId' as nullable first, so that we don't break foreign key constraints while we populate existing rows
        migrationBuilder.AddColumn<string>(name: "RoleId", table: "Users", type: "nvarchar(450)", nullable: true);
        ...
        migrationBuilder.AlterColumn<string>(name: "RoleId", table: "Users", type: "nvarchar(450)", nullable: false);
