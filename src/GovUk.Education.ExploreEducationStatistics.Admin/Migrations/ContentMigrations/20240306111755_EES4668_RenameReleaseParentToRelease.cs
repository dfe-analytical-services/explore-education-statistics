...
public partial class EES4668_RenameReleaseParentToRelease : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.RenameIndex(name: "PK_Releases", table: "ReleaseVersions", newName: "PK_ReleaseVersions");
        ...
        migrationBuilder.Sql(
            "EXEC sp_rename 'dbo.FK_Releases_Publications_PublicationId', 'FK_ReleaseVersions_Publications_PublicationId', 'OBJECT'"
        );
        migrationBuilder.Sql(
            "EXEC sp_rename 'dbo.FK_Releases_ReleaseParents_ReleaseParentId', 'FK_ReleaseVersions_ReleaseParents_ReleaseParentId', 'OBJECT'"
        );
        migrationBuilder.Sql(
            "EXEC sp_rename 'dbo.FK_Releases_Releases_PreviousVersionId', 'FK_ReleaseVersions_Releases_PreviousVersionId', 'OBJECT'"
        );
        migrationBuilder.Sql(
            "EXEC sp_rename 'dbo.FK_Releases_Users_CreatedById', 'FK_ReleaseVersions_Users_CreatedById', 'OBJECT'"
        );
        ...
        migrationBuilder.RenameTable(name: "ReleaseParents", newName: "Releases");

        // Rename indexes which are not renamed by the ReleaseParents -> Releases table rename
        migrationBuilder.RenameIndex(name: "PK_ReleaseParents", table: "Releases", newName: "PK_Releases");

        // Rename the ReleaseVersions.ReleaseParentId column
        migrationBuilder.RenameColumn(name: "ReleaseParentId", table: "ReleaseVersions", newName: "ReleaseId");
