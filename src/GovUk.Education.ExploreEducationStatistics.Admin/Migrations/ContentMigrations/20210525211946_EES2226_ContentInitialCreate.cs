...
public partial class EES2226_ContentInitialCreate : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            {
                table.PrimaryKey(
                    "PK_ReleaseContentBlocks",
                    x => new { x.ReleaseId, x.ContentBlockId }
                );
                table.ForeignKey(
        ...
        migrationBuilder.CreateTable(
            ...
            {
                table.PrimaryKey(
                    "PK_ReleaseContentSections",
                    x => new { x.ReleaseId, x.ContentSectionId }
                );
                table.ForeignKey(
        ...
        migrationBuilder.InsertData(
            ...
            values: new object[]
            {
                new Guid("9d333457-9132-4e55-ae78-c55cb3673d7c"),
                "Official Statistics",
            }
        );
        ...
        migrationBuilder.InsertData(
            ...
            values: new object[]
            {
                new Guid("8becd272-1100-4e33-8a7d-1c0c4e3b42b8"),
                "National Statistics",
            }
        );
