...
{
    private static readonly Dictionary<ReleaseType, Guid> ReleaseTypeIds = new Dictionary<
        ReleaseType,
        Guid
    >
    {
        ...
        }, // Altered from ReleaseType.NationalStatistics so we could remove it from the enum
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.AddColumn<string>(name: "Type", table: "Releases", nullable: true);
        ...
        migrationBuilder.CreateIndex(name: "IX_Releases_Type", table: "Releases", column: "Type");

        // Drop the TypeId column
        migrationBuilder.DropForeignKey(name: "FK_Releases_ReleaseTypes_TypeId", table: "Releases");

        migrationBuilder.DropTable(name: "ReleaseTypes");

        migrationBuilder.DropIndex(name: "IX_Releases_TypeId", table: "Releases");

        migrationBuilder.DropColumn(name: "TypeId", table: "Releases");
    }
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropIndex(name: "IX_Releases_Type", table: "Releases");
