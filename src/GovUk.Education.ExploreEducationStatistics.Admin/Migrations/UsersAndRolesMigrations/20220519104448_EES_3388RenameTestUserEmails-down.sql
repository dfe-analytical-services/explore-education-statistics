...
UPDATE AspNetUsers SET NormalizedUserName = 'EES-ANALYST@EDUCATION.GOV.UK' WHERE NormalizedUserName = 'EES-TEST.ANALYST1@education.gov.uk';
UPDATE AspNetUsers SET Email = 'ees-analyst1@education.gov.uk' WHERE Email = 'EES-test.ANALYST1@education.gov.uk';
UPDATE AspNetUsers SET NormalizedEmail = 'EES-ANALYST1@education.gov.uk' WHERE NormalizedEmail = 'EES-TEST.ANALYST1@education.gov.uk';
UPDATE AspNetUsers SET UserName = 'ees-analyst1@education.gov.uk' WHERE UserName = 'ees-test.analyst1@education.gov.uk';
UPDATE Users SET Email = 'ees-analyst1@education.gov.uk' WHERE Email = 'ees-test.analyst1@education.gov.uk';

UPDATE AspNetUsers SET NormalizedUserName = 'EES-ANALYST2@EDUCATION.GOV.UK' WHERE NormalizedUserName = 'EES-TEST.ANALYST2@education.gov.uk';
UPDATE AspNetUsers SET Email = 'ees-analyst2@education.gov.uk' WHERE Email = 'EES-test.ANALYST2@education.gov.uk';
UPDATE AspNetUsers SET NormalizedEmail = 'EES-ANALYST2@EDUCATION.GOV.UK' WHERE NormalizedEmail = 'EES-TEST.ANALYST2@education.gov.uk';
UPDATE AspNetUsers SET UserName = 'ees-analyst2@education.gov.uk' WHERE UserName = 'ees-test.analyst2@education.gov.uk';
UPDATE Users SET Email = 'ees-analyst2@education.gov.uk' WHERE Email = 'ees-test.analyst2@education.gov.uk';

UPDATE AspNetUsers SET NormalizedUserName = 'EES-ANALYST3@EDUCATION.GOV.UK' WHERE NormalizedUserName = 'EES-TEST.ANALYST3@education.gov.uk';
UPDATE AspNetUsers SET Email = 'ees-analyst3@education.gov.uk' WHERE Email = 'EES-test.ANALYST3@education.gov.uk';
UPDATE AspNetUsers SET NormalizedEmail = 'EES-ANALYST3@EDUCATION.GOV.UK' WHERE NormalizedEmail = 'EES-TEST.ANALYST3@education.gov.uk';
UPDATE AspNetUsers SET UserName = 'ees-analyst3@education.gov.uk' WHERE UserName = 'ees-test.analyst3@education.gov.uk';
