...
public class MethodologyContentController : ControllerBase
{
    ...
    {
        return await _contentService.GetContent(methodologyId).HandleFailuresOrOk();
    }
    ...
    {
        return await _contentService.ReorderContentSections(methodologyId, newSectionOrder).HandleFailuresOrOk();
    }
    ...
    {
        return await _contentService.AddContentSection(methodologyId, request, type).HandleFailuresOrOk();
    }
    ...
    {
        return await _contentService.RemoveContentSection(methodologyId, contentSectionId).HandleFailuresOrOk();
    }
    ...
    {
        return await _contentService.GetContentSection(methodologyId, contentSectionId).HandleFailuresOrOk();
    }
    ...
    {
        return await _contentService.AddContentBlock(methodologyId, contentSectionId, request).HandleFailuresOrOk();
    }
