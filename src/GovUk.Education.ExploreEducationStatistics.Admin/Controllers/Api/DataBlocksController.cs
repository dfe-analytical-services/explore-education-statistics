...
public class DataBlocksController : ControllerBase
{
    ...
    {
        return await _dataBlockService.Create(releaseVersionId, dataBlock).HandleFailuresOrOk();
    }

    [HttpDelete("releases/{releaseVersionId:guid}/data-blocks/{dataBlockVersionId:guid}")]
    public async Task<ActionResult> DeleteDataBlock(Guid releaseVersionId, Guid dataBlockVersionId)
    {
    ...
    public async Task<ActionResult<DeleteDataBlockPlanViewModel>> GetDeletePlan(
        Guid releaseVersionId,
        Guid dataBlockVersionId
    )
    {
        return await _dataBlockService
            .GetDeletePlan(releaseVersionId: releaseVersionId, dataBlockVersionId: dataBlockVersionId)
            .HandleFailuresOrOk();
    }
    ...
    {
        return await _dataBlockService.List(releaseVersionId).HandleFailuresOrOk();
    }
    ...
    {
        return await _dataBlockService.Update(dataBlockVersionId, dataBlock).HandleFailuresOrOk();
    }
