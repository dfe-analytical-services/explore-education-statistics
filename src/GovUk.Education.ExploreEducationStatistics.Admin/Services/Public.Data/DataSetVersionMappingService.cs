    ...
    : IDataSetVersionMappingService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var typeCombinations = await publicDataDbContext.Database
            .SqlQueryRaw<FilterAndOptionMappingTypeDto>(
                sql: $"""
                 SELECT DISTINCT 
                     FilterMappingType "{nameof(FilterAndOptionMappingTypeDto.FilterMappingTypeRaw)}",
                     OptionMappingType "{nameof(FilterAndOptionMappingTypeDto.OptionMappingTypeRaw)}" 
                 FROM (
    ...
    public record FilterAndOptionMappingTypeDto
    {
