...
public class DataSetFileStorage(
    ...
    IUserService userService) : IDataSetFileStorage
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var releaseDataFileOrder = await GetNextDataFileOrder(releaseVersionId, dataSet.ReplacingFile);
        ...
        File? replacingFile = null)
    {
        ...
        {
            var replacedReleaseDataFile = await contentDbContext.ReleaseFiles
                .Include(rf => rf.File)
                .SingleAsync(rf =>
                    rf.ReleaseVersionId == releaseVersionId
