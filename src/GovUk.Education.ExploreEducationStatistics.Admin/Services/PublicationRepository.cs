        ...
        IPublicationRepository
{
    ...
    {
        return _context.Publications.Where(publication =>
            themeId == null || publication.ThemeId == themeId
        );
    }

    public async Task<List<Publication>> ListPublicationsForUser(Guid userId, Guid? themeId = null)
    {
        var publicationsGrantedByPublicationRoleQueryable = _context.UserPublicationRoles.Where(
            userPublicationRole =>
        ...
        var publicationsGrantedByPublicationRole =
            await publicationsGrantedByPublicationRoleQueryable
        ...
        if (themeId.HasValue)
        {
            releasesGrantedByReleaseRolesQueryable = releasesGrantedByReleaseRolesQueryable.Where(
                userReleaseRole =>
