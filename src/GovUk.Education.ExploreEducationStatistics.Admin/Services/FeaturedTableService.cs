...
namespace GovUk.Education.ExploreEducationStatistics.Admin.Services
{
    public class FeaturedTableService : IFeaturedTableService
    {
        ...
        public async Task<Either<ActionResult, FeaturedTableViewModel>> Get(Guid releaseId, Guid id)
        {
            return await _persistenceHelper.CheckEntityExists<Release>(releaseId)
                ...
                .OnSuccess(async featuredTable =>
                {
                    ...
                    {
                        return new Either<ActionResult, FeaturedTableViewModel>(
                            ValidationUtils.ValidationActionResult(FeaturedTableIsNotAssociatedWithRelease));
                    }
            ...
            FeaturedTableUpdateRequest request)
        {
            return await _persistenceHelper.CheckEntityExists<Release>(releaseId)
                ...
                .OnSuccess(featuredTable =>
                {
                    ...
                    {
                        return new Either<ActionResult, FeaturedTable>(
                            ValidationUtils.ValidationActionResult(FeaturedTableIsNotAssociatedWithRelease));
                    }

                    return featuredTable;
                })
                .OnSuccess(async featuredTable =>
                {
        ...
        private async Task<bool> FeaturedTableIsAssociatedWithRelease(FeaturedTable featuredTable, Guid releaseId)
        {
            return await _contentDbContext.ReleaseContentBlocks
                .AnyAsync(rcb =>
                    rcb.ContentBlockId == featuredTable.DataBlockId
