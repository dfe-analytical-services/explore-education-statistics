...
public class MethodologyAmendmentService : IMethodologyAmendmentService
{
    ...
    {
        var amendment = CreateMethodologyAmendment(
            originalMethodologyVersion,
    ...
    )
    {
        ...
        var amendment = new MethodologyVersion
        {
            ...
            MethodologyContent = CopyMethodologyContent(
                originalMethodologyVersion,
                createdByUserId
            ),
            Notes = CopyNotes(
                originalMethodologyVersion,
                methodologyVersionAmendmentId,
                createdByUserId
            ),
    ...
    > HydrateMethodologyVersionForAmendment(MethodologyVersion methodologyVersion)
    {
