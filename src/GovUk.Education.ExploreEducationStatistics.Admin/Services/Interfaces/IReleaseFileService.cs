...
public interface IReleaseFileService
{
    ...
    Task<Either<ActionResult, Unit>> Delete(Guid releaseVersionId, Guid fileId, bool forceDelete = false);

    Task<Either<ActionResult, Unit>> Delete(Guid releaseVersionId, IEnumerable<Guid> fileIds, bool forceDelete = false);

    Task<Either<ActionResult, Unit>> DeleteAll(Guid releaseVersionId, bool forceDelete = false);

    Task<Either<ActionResult, IEnumerable<FileInfo>>> ListAll(Guid releaseVersionId, params FileType[] types);

    Task<Either<ActionResult, FileInfo>> GetFile(Guid releaseVersionId, Guid fileId);
    ...
    Task<Either<ActionResult, Unit>> UpdateDataFileDetails(
        Guid releaseVersionId,
        Guid fileId,
    ...
    Task<Either<ActionResult, FileInfo>> UploadChart(
        Guid releaseVersionId,
        IFormFile formFile,
