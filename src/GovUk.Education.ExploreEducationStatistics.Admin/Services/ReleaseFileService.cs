    ...
    public class ReleaseFileService : IReleaseFileService
    {
            ...
            ReleaseAncillaryFileUploadRequest upload)
        {
            return _persistenceHelper
                .CheckEntityExists<ReleaseVersion>(releaseVersionId)
                .OnSuccess(_userService.CheckCanUpdateReleaseVersion)
                .OnSuccess(async () => await _ancillaryFileValidatorService.ValidateFileForUpload(upload.File, Ancillary))
                .OnSuccess(async () =>
                {
            ...
            ReleaseAncillaryFileUpdateRequest request)
        {
            return _persistenceHelper
                ...
                .OnSuccessDo(async _ =>
                {
                    ...
                    {
                        return await _ancillaryFileValidatorService.ValidateFileForUpload(request.File, Ancillary);
                    }
            ...
            Guid? replacingId = null)
        {
            return _persistenceHelper
                .CheckEntityExists<ReleaseVersion>(releaseVersionId)
                .OnSuccess(_userService.CheckCanUpdateReleaseVersion)
                .OnSuccess(async () => await _ancillaryFileValidatorService.ValidateFileForUpload(formFile, Chart))
                .OnSuccess(async () =>
                {
