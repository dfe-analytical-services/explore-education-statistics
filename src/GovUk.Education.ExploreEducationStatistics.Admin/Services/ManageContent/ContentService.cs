...
public class ContentService : IContentService
{
        ...
        return _persistenceHelper
            ...
            .OnSuccess(async releaseVersion =>
            {
                var orderForNewSection =
                    request?.Order ?? releaseVersion.GenericContent.Max(contentSection => contentSection.Order) + 1;
    ...
    {
        return CheckContentSectionExists(releaseVersionId: releaseVersionId, contentSectionId: contentSectionId)
            .OnSuccess(CheckCanUpdateReleaseVersion)
    ...
    )
    {
        ...
        return CheckContentSectionExists(releaseVersionId: releaseVersionId, contentSectionId: contentSectionId)
            ...
            .OnSuccess(async tuple =>
            {
                ...
                return await AddContentBlockToContentSectionAndSave(request.Order, section, newContentBlock);
            });
    }
    ...
    {
        return _mapper.Map<List<ContentSectionViewModel>>(releaseVersion.GenericContent).OrderBy(c => c.Order).ToList();
    }
