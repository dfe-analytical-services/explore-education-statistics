    ...
    : IDataSetMappingService
{
    ...
    {
        var (initialIndicatorMappingDictionary, unsetReplacementIndicatorIds) = await GenerateInitialIndicatorMapping(
            originalDataSetId,
        ...
        var newMapping = new DataSetMapping
        {
            ...
            UnsetReplacementIndicators = unsetReplacementIndicatorIds,
        };
    ...
    private async Task<(Dictionary<Guid, IndicatorMapping>, List<UnsetIndicator>)> GenerateInitialIndicatorMapping(
        Guid originalDataSetId,
        Guid replacementDataSetId,
        CancellationToken cancellationToken
    )
    {
        ...
        var unsetReplacementIds = replacementIndicatorNameToIndicatorMap
            .Values.ExceptBy(mappedReplacementIds, indicator => indicator.Id)
            .Select(i => new UnsetIndicator
            {
        ...
        return (initialMappingDictionary, unsetReplacementIds);
    }
}
