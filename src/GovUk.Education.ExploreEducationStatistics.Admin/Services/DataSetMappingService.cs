    ...
    : IDataSetMappingService
{
    ...
    {
        var (initialIndicatorMappingDictionary, candidateReplacementIndicatorIds) =
        ...
        var newMapping = new DataSetMapping
        {
            ...
            CandidateIndicatorReplacements = candidateReplacementIndicatorIds,
        };
    ...
    private async Task<(Dictionary<Guid, IndicatorMapping>, List<CandidateIndicator>)> GenerateInitialIndicatorMapping(
        Guid originalDataSetId,
        Guid replacementDataSetId,
        CancellationToken cancellationToken
    )
    {
        ...
        var candidateReplacementIds = replacementIndicatorNameToIndicatorMap
            .Values.ExceptBy(mappedReplacementIds, indicator => indicator.Id)
            .Select(i => new CandidateIndicator
            {
        ...
        return (initialMappingDictionary, candidateReplacementIds);
    }
}
