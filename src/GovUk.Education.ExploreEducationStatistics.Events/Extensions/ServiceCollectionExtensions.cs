...
{
    public static IServiceCollection AddEventGridClient(
        ...
        services
            ...
            .AddTransient(
                typeof(Func<ILogger<SafeEventGridClient>>),
                sp => (Func<ILogger<SafeEventGridClient>>)sp.GetRequiredService<ILogger<SafeEventGridClient>>
            )
