...
public static class TimePeriodUtil
{
    ...
    )
    {
        if (startYear <= 0)
        {
            throw new ArgumentNullException(nameof(startYear), "The time period StartYear must be specified");
        }

        if (endYear <= 0)
        {
            throw new ArgumentNullException(nameof(endYear), "The time period EndYear must be specified");
        }
        ...
        {
            throw new ArgumentOutOfRangeException(nameof(startYear), "The time period StartYear must be four digits");
        }

        if (endYearLength != 4)
        {
            throw new ArgumentOutOfRangeException(nameof(endYear), "The time period EndYear must be four digits");
        }
