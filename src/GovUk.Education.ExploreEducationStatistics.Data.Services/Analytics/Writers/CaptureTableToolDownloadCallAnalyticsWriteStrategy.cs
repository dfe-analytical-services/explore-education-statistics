...
) : IAnalyticsWriteStrategy
{
    ...
    private readonly IWorkflowActor<CaptureTableToolDownloadCall> _workflowActor = new WorkflowActor(
    ...
    private class WorkflowActor(string analyticsPath) : WorkflowActorBase<CaptureTableToolDownloadCall>(analyticsPath)
    {
