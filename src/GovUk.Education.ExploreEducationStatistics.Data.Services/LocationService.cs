...
public class LocationService(StatisticsDbContext context, IBoundaryDataRepository boundaryDataRepository)
    : ILocationService
{
    ...
    )
    {
        ...
        var locationsMatchingLevel = locations.Where(location => location.GeographicLevel == boundaryLevel.Level);
