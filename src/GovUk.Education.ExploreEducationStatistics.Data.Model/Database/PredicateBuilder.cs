...
public static class PredicateBuilder
{
    ...
    private static Expression<Func<TInput, bool>> CombineWithAnd<TInput>(
        this Expression<Func<TInput, bool>> func1,
    ...
    )
    {
        return Expression.Lambda<Func<TInput, bool>>(
            Expression.And(
                func1.Body,
                new ExpressionParameterReplacer(func2.Parameters, func1.Parameters).Visit(
                    func2.Body
                )
            ),
            func1.Parameters
    ...
    private static Expression<Func<TInput, bool>> CombineWithAndAlso<TInput>(
        this Expression<Func<TInput, bool>> func1,
        Expression<Func<TInput, bool>> func2
    )
    {
    ...
    private static Expression<Func<TInput, bool>> CombineWithOrElse<TInput>(
        this Expression<Func<TInput, bool>> func1,
        Expression<Func<TInput, bool>> func2
    )
    {
    ...
    private static Expression<Func<TInput, bool>> CombineWithOr<TInput>(
        this Expression<Func<TInput, bool>> func1,
        Expression<Func<TInput, bool>> func2
    )
    {
