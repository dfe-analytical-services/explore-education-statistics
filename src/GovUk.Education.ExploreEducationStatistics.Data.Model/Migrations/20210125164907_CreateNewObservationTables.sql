--
-- Leaving in foreign keys and indexes as commented-out lines to show the constraints that 
-- would have come as a part of standard CREATE scripts for these tables.  We can achieve
-- migration from Observation and ObservationFilterItem tables in half the time without 
-- these constraints in place, then we will reinstate these constraints at a later time when 
-- we have migrated the bulk of records over.
--
