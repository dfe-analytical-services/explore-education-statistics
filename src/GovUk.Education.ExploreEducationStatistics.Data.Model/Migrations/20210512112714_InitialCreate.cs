...
public partial class InitialCreate : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateIndex(name: "IX_Filter_SubjectId", table: "Filter", column: "SubjectId");
        ...
        migrationBuilder.CreateIndex(name: "IX_FilterGroup_FilterId", table: "FilterGroup", column: "FilterId");
        ...
        migrationBuilder.CreateIndex(name: "IX_FilterItem_FilterGroupId", table: "FilterItem", column: "FilterGroupId");
        ...
        migrationBuilder.CreateIndex(name: "IX_IndicatorGroup_SubjectId", table: "IndicatorGroup", column: "SubjectId");

        migrationBuilder.CreateIndex(name: "IX_Location_Country_Code", table: "Location", column: "Country_Code");
        ...
        migrationBuilder.CreateIndex(name: "IX_Location_Region_Code", table: "Location", column: "Region_Code");

        migrationBuilder.CreateIndex(name: "IX_Location_RscRegion_Code", table: "Location", column: "RscRegion_Code");

        migrationBuilder.CreateIndex(name: "IX_Location_Sponsor_Code", table: "Location", column: "Sponsor_Code");

        migrationBuilder.CreateIndex(name: "IX_Location_Ward_Code", table: "Location", column: "Ward_Code");
        ...
        migrationBuilder.CreateIndex(name: "IX_Observation_LocationId", table: "Observation", column: "LocationId");

        migrationBuilder.CreateIndex(name: "IX_Observation_SubjectId", table: "Observation", column: "SubjectId");
        ...
        migrationBuilder.CreateIndex(name: "IX_Observation_Year", table: "Observation", column: "Year");
        ...
        migrationBuilder.CreateIndex(name: "IX_Publication_TopicId", table: "Publication", column: "TopicId");
        ...
        migrationBuilder.CreateIndex(name: "IX_Release_PublicationId", table: "Release", column: "PublicationId");
        ...
        migrationBuilder.CreateIndex(name: "IX_ReleaseSubject_SubjectId", table: "ReleaseSubject", column: "SubjectId");
