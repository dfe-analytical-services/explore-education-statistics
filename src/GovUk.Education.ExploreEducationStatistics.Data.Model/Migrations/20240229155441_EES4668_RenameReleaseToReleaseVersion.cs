...
public partial class EES4668_RenameReleaseToReleaseVersion : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropForeignKey(name: "FK_ReleaseFootnote_Release_ReleaseId", table: "ReleaseFootnote");

        migrationBuilder.DropForeignKey(name: "FK_ReleaseSubject_Release_ReleaseId", table: "ReleaseSubject");
        ...
        migrationBuilder.RenameColumn(name: "ReleaseId", newName: "ReleaseVersionId", table: "ReleaseFootnote");

        migrationBuilder.RenameColumn(name: "ReleaseId", newName: "ReleaseVersionId", table: "ReleaseSubject");
