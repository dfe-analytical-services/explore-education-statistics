...
WHERE F.ReleaseId = (SELECT TOP(1) ReleaseId FROM ReleaseSubject WHERE SubjectId = @subjectId ORDER BY Id DESC)
  AND (@subjectId = SF.SubjectId OR SF.SubjectId IS NULL)
