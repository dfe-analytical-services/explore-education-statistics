...
namespace GovUk.Education.ExploreEducationStatistics.Data.Model.Migrations
{
    ...
    [Migration("20251007104628_Ees6481AddFilterItemIdObservationIdIndexToObservationFilterItemTable")]
    partial class Ees6481AddFilterItemIdObservationIdIndexToObservationFilterItemTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Data.Model.BoundaryData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BoundaryLevelId");

                    b.HasIndex("Code");

                    b.ToTable("BoundaryData");
                });
            ...
            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Data.Model.ReleaseFootnote", b =>
                {
                    ...
                    b.HasKey("ReleaseVersionId", "FootnoteId");
            ...
            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Data.Model.ReleaseSubject", b =>
                {
                    ...
                    b.HasKey("ReleaseVersionId", "SubjectId");
            ...
            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Data.Model.ReleaseVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Thinktecture:TempTable:GovUk.Education.ExploreEducationStatistics.Data.Model.Database.MatchedObservation", b =>
                {
                    ...
                    b.ToTable("#MatchedObservation", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Data.Model.BoundaryData", b =>
                {
                    b.HasOne("GovUk.Education.ExploreEducationStatistics.Common.Model.Data.BoundaryLevel", "BoundaryLevel")
                        .WithMany()
                        .HasForeignKey("BoundaryLevelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BoundaryLevel");
                });
            ...
            modelBuilder.Entity("GovUk.Education.ExploreEducationStatistics.Data.Model.ReleaseFootnote", b =>
                {
                    ...
                    b.HasOne("GovUk.Education.ExploreEducationStatistics.Data.Model.ReleaseVersion", "ReleaseVersion")
                        .WithMany()
