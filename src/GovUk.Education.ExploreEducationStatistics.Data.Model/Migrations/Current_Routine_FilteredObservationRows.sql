    ...
    IF (@observationalUnitExists = 1)
        BEGIN
            ...
            IF (EXISTS(SELECT TOP 1 1 FROM @countriesList))
                BEGIN
                    SET @idsList = (SELECT '''' + STRING_AGG(Id, ''',''') + '''' FROM @countriesList)
            ...
            IF (EXISTS(SELECT TOP 1 1 FROM @englishDevolvedAreasList))
                BEGIN
                    SET @idsList = (SELECT '''' + STRING_AGG(Id, ''',''') + '''' FROM @englishDevolvedAreasList)
            ...
            IF (EXISTS(SELECT TOP 1 1 FROM @institutionsList))
                BEGIN
                    SET @idsList = (SELECT '''' + STRING_AGG(Id, ''',''') + '''' FROM @institutionsList)
            ...
            IF (EXISTS(SELECT TOP 1 1 FROM @localAuthorityList))
                BEGIN
                    SET @idsList = (SELECT '''' + STRING_AGG(Id, ''',''') + '''' FROM @localAuthorityList)
            ...
            IF (EXISTS(SELECT TOP 1 1 FROM @localAuthorityOldCodeList))
                BEGIN
                    SET @idsList = (SELECT '''' + STRING_AGG(Id, ''',''') + '''' FROM @localAuthorityOldCodeList)
            ...
            IF (EXISTS(SELECT TOP 1 1 FROM @localAuthorityDistrictList))
                BEGIN
                    SET @idsList = (SELECT '''' + STRING_AGG(Id, ''',''') + '''' FROM @localAuthorityDistrictList)
            ...
            IF (EXISTS(SELECT TOP 1 1 FROM @localEnterprisePartnershipsList))
                BEGIN
                    SET @idsList = (SELECT '''' + STRING_AGG(Id, ''',''') + '''' FROM @localEnterprisePartnershipsList)
            ...
            IF (EXISTS(SELECT TOP 1 1 FROM @mayoralCombinedAuthoritiesList))
                BEGIN
                    SET @idsList = (SELECT '''' + STRING_AGG(Id, ''',''') + '''' FROM @mayoralCombinedAuthoritiesList)
            ...
            IF (EXISTS(SELECT TOP 1 1 FROM @multiAcademyTrustList))
                BEGIN
                    SET @idsList = (SELECT '''' + STRING_AGG(Id, ''',''') + '''' FROM @multiAcademyTrustList)
            ...
            IF (EXISTS(SELECT TOP 1 1 FROM @opportunityAreasList))
                BEGIN
                    SET @idsList = (SELECT '''' + STRING_AGG(Id, ''',''') + '''' FROM @opportunityAreasList)
            ...
            IF (EXISTS(SELECT TOP 1 1 FROM @parliamentaryConstituenciesList))
                BEGIN
                    SET @idsList = (SELECT '''' + STRING_AGG(Id, ''',''') + '''' FROM @parliamentaryConstituenciesList)
            ...
            IF (EXISTS(SELECT TOP 1 1 FROM @regionsList))
                BEGIN
                    SET @idsList = (SELECT '''' + STRING_AGG(Id, ''',''') + '''' FROM @regionsList)
            ...
            IF (EXISTS(SELECT TOP 1 1 FROM @rscRegionsList))
                BEGIN
                    SET @idsList = (SELECT '''' + STRING_AGG(Id, ''',''') + '''' FROM @rscRegionsList)
            ...
            IF (EXISTS(SELECT TOP 1 1 FROM @sponsorList))
                BEGIN
                    SET @idsList = (SELECT '''' + STRING_AGG(Id, ''',''') + '''' FROM @sponsorList)
            ...
            IF (EXISTS(SELECT TOP 1 1 FROM @wardsList))
                BEGIN
                    SET @idsList = (SELECT '''' + STRING_AGG(Id, ''',''') + '''' FROM @wardsList)
            ...
            IF (EXISTS(SELECT TOP 1 1 FROM @planningAreasList))
                BEGIN
                    SET @idsList = (SELECT '''' + STRING_AGG(Id, ''',''') + '''' FROM @planningAreasList)
