...
namespace GovUk.Education.ExploreEducationStatistics.Data.Model.Repository.Interfaces
{
    ...
    {
        Dictionary<GeographicLevel, IEnumerable<LabelValue>> GetLocationsLabelValue(Guid subjectId);

        Dictionary<GeographicLevel, IEnumerable<LabelValue>> GetLocationsLabelValue(IQueryable<Observation> observations);
