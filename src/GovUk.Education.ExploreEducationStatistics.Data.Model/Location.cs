...
public class Location
{
    ...
    {
        get =>
            LocalAuthority_Code == null
            && LocalAuthority_OldCode == null
            && LocalAuthority_Name == null
                ? null
                : new LocalAuthority(
                    LocalAuthority_Code,
    ...
    public LocalEnterprisePartnership? LocalEnterprisePartnership
    {
        get =>
            LocalEnterprisePartnership_Code == null && LocalEnterprisePartnership_Name == null
                ? null
                : new LocalEnterprisePartnership(
    ...
    {
        get =>
            LocalSkillsImprovementPlanArea_Code == null
            && LocalSkillsImprovementPlanArea_Name == null
                ? null
    ...
    {
        get =>
            Provider_Code == null && Provider_Name == null
                ? null
    ...
    {
        get =>
            School_Code == null && School_Name == null
                ? null
    ...
    {
        get =>
            Sponsor_Code == null && Sponsor_Name == null
                ? null
...
public static class LocationListExtensions
{
    public static Dictionary<
        GeographicLevel,
        List<LocationAttributeNode>
    > GetLocationAttributesHierarchical(
    ...
    private static Dictionary<
        GeographicLevel,
        List<Func<Location, LocationAttribute>>
                ...
                pair.Value.Select(propertyName =>
                    {
                        ...
                        return (Func<Location, LocationAttribute>)(
                            location =>
                            {
                                ...
                                if (
                                    !typeof(LocationAttribute).IsAssignableFrom(
                                ...
                                if (value == null)
                                {
                                    ...
                                    var constructorParams = propertyType
                                        .GetConstructors()
                                        .Single()
                                        .GetParameters();
