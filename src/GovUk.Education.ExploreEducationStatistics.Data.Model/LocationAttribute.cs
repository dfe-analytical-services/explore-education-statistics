...
public record LocalAuthority(string? Code, string? OldCode, string? Name)
    : LocationAttribute(Code, Name)
{
...
public record LocalSkillsImprovementPlanArea(string? Code, string? Name)
    : LocationAttribute(Code, Name)
{
    public override KeyValuePair<string, string>[] CsvValues =>
        new KeyValuePair<string, string>[]
...
{
    public override KeyValuePair<string, string>[] CsvValues =>
        new KeyValuePair<string, string>[] { new("rsc_region_lead_name", Code ?? string.Empty) };
