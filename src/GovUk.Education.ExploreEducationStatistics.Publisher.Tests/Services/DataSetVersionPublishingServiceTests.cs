...
public class DataSetVersionPublishingServiceTests(FunctionsIntegrationTestFixture fixture) 
    : FunctionsIntegrationTest(fixture)
{
    public class PublishDataSetVersions(FunctionsIntegrationTestFixture fixture) 
        : DataSetVersionPublishingServiceTests(fixture)
    {
        [Fact]
        public async Task FirstReleaseVersionPublished()
        {
