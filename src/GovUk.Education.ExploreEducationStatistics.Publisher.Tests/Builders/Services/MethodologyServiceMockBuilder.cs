...
public class MethodologyServiceMockBuilder
{
    ...
    {
        _mock.Setup(m => m.GetLatestVersionByRelease(releaseVersion)).ReturnsAsync(methodologyVersions.ToList());
    ...
    {
        _mock.Setup(m => m.IsBeingPublishedAlongsideRelease(methodologyVersion, releaseVersion)).ReturnsAsync(true);
    ...
    {
        _mock.Setup(m => m.IsBeingPublishedAlongsideRelease(methodologyVersion, releaseVersion)).ReturnsAsync(false);
