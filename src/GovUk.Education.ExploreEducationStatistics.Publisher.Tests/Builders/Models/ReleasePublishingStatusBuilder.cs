...
{
    private ReleasePublishingStatusContentStage _contentStatus =
        ReleasePublishingStatusContentStage.Complete;
    private ReleasePublishingStatusFilesStage _filesStatus =
        ReleasePublishingStatusFilesStage.Complete;
    ...
    public ReleasePublishingStatusBuilder WhereContentStatusIs(
        ReleasePublishingStatusContentStage status
    )
    {
    ...
    public ReleasePublishingStatusBuilder WhereFilesStatusIs(
        ReleasePublishingStatusFilesStage status
    )
    {
        _filesStatus = status;
        return this;
