...
import ReleaseManageTeamAccessAddUsersPage from '@admin/pages/publication/ReleaseManageTeamAccessAddUsersPage';
...
export const releaseManageTeamAccessAddUsersRoute: ReleaseRouteProps = {
