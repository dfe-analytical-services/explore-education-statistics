import {AdminDashboardPublication, AdminDashboardRelease} from "@admin/services/dashboard/types";
import {Polyfilla} from "@admin/services/util/polyfilla";

const publicationPollyfilla: Polyfilla<AdminDashboardPublication> = (publication: AdminDashboardPublication) => (
  {
    ...publication,
