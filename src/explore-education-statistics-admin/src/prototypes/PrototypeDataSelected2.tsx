      ...
      >
        <>
          <h1 className="govuk-heading-xl">
            <span className="govuk-caption-xl ">Data catalogue v2</span>{' '}
              ...
              <RelatedInformation heading="Quick links">
                {dataType === 'api' && (
                  <>
                    ...
                    <ul className="govuk-list ">
                      <li>
                        <a href="#api-preview-tabs-1">Data preview</a>
                      </li>
                      <li>
                        <a href="#api-preview-tabs-2">Changelog</a>
                      </li>
                      <li>
                        <a href="#api-preview-tabs-3">Version history</a>
                      </li>
                      <li>
                        <a href="#api-endpoints">API endpoints quick start</a>
                      </li>
                    </ul>
                  </>
                )}
                  ...
                  <>
                    ...
                    >
                      <h2 className="govuk-label-wrapper">
                        ...
                        >
                          Version history with related release
                        </label>
                      </h2>
          ...
          <h2 className="govuk-heading-l">
            {dataType === 'api'
              ? 'API data preview, changelog and version history'
              : 'Data preview'}
          </h2>
          ...
          {dataType === 'api' && (
            <div className="govuk-!-margin-bottom-9">
              <h2 className="govuk-heading-l" id="api-endpoints">
