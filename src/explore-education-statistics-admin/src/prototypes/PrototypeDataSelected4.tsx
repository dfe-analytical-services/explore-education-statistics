            ...
            <div className="govuk-grid-column-three-quarters">
              ...
              {selectedRelease === latestRelease && (
                <div className="govuk-inset-text">
                  ...
                  highlighted in the changelog, this is likely to cause breaking
                  changes to any existing queries you may have set up.
                </div>
              )}
              ...
              <div className={styles.prototypeCardContainer}>
                <div className={classNames(styles.prototypeCardChevronOneHalf)}>
                  <h2
                    className={classNames(
                      'govuk-heading-m',
