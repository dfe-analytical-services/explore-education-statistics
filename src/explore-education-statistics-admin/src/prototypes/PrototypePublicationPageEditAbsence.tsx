                ...
                {data.content.length > 0 ?
                    this.state.reordering ? (
                            <Fragment>
                                <DragDropContext onDragEnd={this.onDragEnd}>
                                    <h2 className="govuk-heading-l reorderable-relative">
                                        <button className="reorderable" onClick={() => this.setState({reordering: false})}>Done</button>
                                        Contents
                                    </h2>
                                                            ...
                                                            >
                                                                <div className="govuk-accordion__section-header">
                                                                    ...
                                                                    <h2 className="govuk-accordion__section-heading reorderable-relative">
                                                                        ...
                                                                        <button className="govuk-accordion__section-button">{heading}</button>
                                                                    </h2>
                        ...
                        <div>
                            ...
                            <h2 className="govuk-heading-l reorderable-relative">
                                <button className="reorderable" onClick={() => this.setState({reordering: true})}>Reorder sections</button>
                                Contents
                            </h2>
