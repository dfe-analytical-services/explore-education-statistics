    ...
    <div className="govuk-grid-row">
      <div className="govuk-grid-column-three-quarters">
        ...
        <div className="govuk-inset-text">
          ...
          this publication. After viewing a table you can also adjust and change
          filters to quickly see different results.
        </div>
        ...
        >
          <li>
            ...
            <p>
              by gender, age at 31 March, category of need, ethnic origin, legal
              status and motherhood status, in England, 2018 to 2020
            </p>
          </li>
          <li>
            <a href="#" className="govuk-!-font-weight-bold">
          ...
          <li>
            ...
            <p>
              by distance between home and placement and locality of placement,
          ...
          <li>
            <a href="#" className="govuk-!-font-weight-bold">
              B2 - Number of new placement for children looked after during the
              year
            </a>
            <p>
              by locality of placement and distance between home and placement,
              in England, 2018 to 2020
            </p>
          </li>
          <li>
          ...
          <li>
            <a href="#" className="govuk-!-font-weight-bold">
              B4 - Reason for placement change for children who moved placements
              in the year
            </a>
            <p>in England, 2018 to 2020</p>
          </li>
