    ...
    <div className={styles.releaseMainContent}>
      ...
      <div className={styles.prototypeCardDashboardContainerGrid}>
        <div className={styles.prototypeDashboardCard}>
          <p>
            <em>38,800</em> children aged under 5 in <em>385</em> state-funded
            nurseries
          </p>
        ...
        <div className={styles.prototypeDashboardCard}>
          <p>
            Almost <em>1 in 10</em> (8.6%) nursery pupils are eligible for free
            school meals
          </p>
        ...
        <div className={styles.prototypeDashboardCard}>
          <p>
            <em>1.7 million</em> children under 5 benefit from government-funded
        ...
        <div className={styles.prototypeDashboardCard}>
          <p>
            <em>1,100</em> nursery teachers means there are <em>23.4</em> pupils
            per teacher
          </p>
      ...
      <div className={styles.prototypeCardDashboardContainerGrid}>
        ...
        <div className={styles.prototypeDashboardCard}>
          <p>
            <em>6.4%</em> school sessions missed due to absence this year, of
            which <em>2.0%</em> was unauthorised
          </p>
          <a
            className={classNames(
              'govuk-link--no-visited-state',
        ...
        <div className={styles.prototypeDashboardCard}>
          <p>
            <em>26.7</em> pupils in each infant class, <em>26.6</em> primary,{' '}
            <em>22.3</em> secondary.
          </p>
          <a
            className={classNames(
              'govuk-link--no-visited-state',
        ...
        <div className={styles.prototypeDashboardCard}>
          <p>
            <em>465,500</em> teachers and <em>37,500</em> new trainee teachers
          </p>
          <a
            className={classNames(
              'govuk-link--no-visited-state',
        ...
        <div className={styles.prototypeDashboardCard}>
          <p>
            <em>59%</em> pupils meet expected standards of reading, writing ad
        ...
        <div className={styles.prototypeDashboardCard}>
          <p>
            <em>1 in 10</em>(12.6%) pupils receive SEN support. <em>1 in 25</em>
      ...
      <div className={styles.prototypeCardDashboardContainerGrid}>
        <div className={styles.prototypeDashboardCard}>
          <p>
            At KS5, the average A level result is <em>B</em>, applied general is{' '}
            <em>Dist -</em> and tech level is <em>Dist -</em>
          </p>
          <a
            className={classNames(
              'govuk-link--no-visited-state',
        ...
        <div className={styles.prototypeDashboardCard}>
          <p>
            <em>1 in 10</em> people aged 16-24 are not in education, employment
            or training
          </p>
          <a
            className={classNames(
        ...
        <div className={styles.prototypeDashboardCard}>
          <p>
            <em>2 in 3</em> pupils who undertook A levels, applied general or
            tech levels went on to higher / further education
          </p>
          <a
            className={classNames(
              'govuk-link--no-visited-state',
        ...
        <div className={styles.prototypeDashboardCard}>
          <p>
            Graduates earn, on average <em>&pound;28,200</em> five years after
            graduation, and <em>86.8%</em> are in sustained employment
          </p>
          <a
            className={classNames(
              'govuk-link--no-visited-state',
      ...
      <div className={styles.prototypeCardDashboardContainerGrid}>
        <div className={styles.prototypeDashboardCard}>
          <p>
            <em>334</em> per <em>10,000</em> children are children in need (CIN)
          </p>
          <a
            className={classNames(
              'govuk-link--no-visited-state',
