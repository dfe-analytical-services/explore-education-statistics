...
const ExampleCharts = ({ chartType }: Props) => {
  return (
    <>
          ...
          >
            <li>
              <div className="dfe-content">
                Figures for 2022/23 are provisional and cover the first three
                quarters (Aug 2022 to Apr 2023). All other years are final,
                full-year figures.
              </div>
            </li>
            <li>
              <div className="dfe-content">
                ...
                value of fewer than 5. Where data shows 'x' this indicates data
                is unavailable, 'z' indicates data is not applicable, and 'c'
                indicates data is suppressed.
              </div>
            </li>
          </ol>
          <button
            aria-controls="chartFootnotes-dataBlock-23831949-ec60-480e-a076-28b721b48747-chart"
            aria-disabled="false"
            aria-expanded="false"
            type="button"
            className="ButtonText_button__60Q71 govuk-!-display-none-print govuk-!-margin-bottom-4"
          >
            Show 6 more footnotes
          </button>
      ...
      {chartType === 'map' && (
        <section
          id="dataBlock-2904c403-643a-4877-9b5a-9adc7785fa19-charts"
          aria-labelledby="dataBlock-2904c403-643a-4877-9b5a-9adc7785fa19-charts-tab"
          role="tabpanel"
        >
          <figure
            className="govuk-!-margin-0"
            ...
            <div className="govuk-grid-row govuk-!-margin-bottom-4">
                  ...
                  >
                    ...
                    <div className="leaflet-pane leaflet-overlay-pane">
                      <svg
                        ...
                        style={{ transform: 'translate3d(-60px, -60px, 0px)' }}
                      >
                        <g>
                          <path
              ...
              <div className="govuk-grid-column-one-third">
                <h3 className="govuk-heading-s dfe-word-break--break-word">
                  Key to Indicative starts rate per 100,000 population (2021/22)
                </h3>
