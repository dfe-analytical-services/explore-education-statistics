  ...
  return (
    <>
      ...
      {sectionExample === 'summaryFull' && (
        <div className="govuk-grid-row">
          <div className="govuk-grid-column-full">
            <h2 className="govuk-heading-l">Release details</h2>
            <dl className="govuk-summary-list govuk-summary-list--no-border">
              <div className="govuk-summary-list__row">
                <dt className="govuk-summary-list__key">Published</dt>
                <dd className="govuk-summary-list__value">
          ...
          <Tabs id="test">
            <TabsSection title="Summary">
              ...
              <div className="dfe-content">
                ...
                <ul>
                  <li>
                    Apprenticeship starts were down by 4.6% to 275,630 compared
                    to 288,800 reported for the same period in the previous
                    year.
                  </li>
                  ...
                  <li>
                    ...
                    apprenticeship starts increased by 6.1% to 93,670 compared
                    to 88,240 in the same period last year.
                  </li>
                  <li>
                    Starts at Level 6 and 7 increased by 9.3% to 41,340 in
                    2022/23. This represents 15.0% of all starts reported to
                    date for 2022/23. There were 37,810 Level 6 and 7 starts in
                    the same period last year (13.1% of starts in the same
                    period).
                  </li>
                  <li>
                  ...
                  <li>
                    Apprenticeship achievements increased by 20.1% to 105,600
                    compared to 87,920 reported for the same period in the
                    previous year. Please note: COVID-19 restrictions and
                    assessment flexibilities affected the timing of
                    achievements, therefore care must be taken when comparing
                    achievements between years as some achievements expected in
                    a given academic year may have been delayed to the
                    subsequent year.
                  </li>
                  <li>
                    Learner participation increased by 1.6% to 703,670 compared
                    to 692,920 reported for the same period in the previous
                    year.
                  </li>
                </ul>
              </div>
