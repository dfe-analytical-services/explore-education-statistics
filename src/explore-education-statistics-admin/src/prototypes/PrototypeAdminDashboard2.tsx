                        ...
                        {themeValue === 'theme-1' && (
                          <>
                            ...
                            <tr>
                              <td>
                                <Link to="/prototypes/admin-publication">
                                  ...
                                  settings during the coronavirus (COVID-19)
                                  pandemic
                                </Link>
                              </td>
                              <td className="govuk-table__cell--numeric">
                            ...
                            <tr>
                              <td>
                                <Link to="/prototypes/admin-publication">
                                  Career pathways: post-16 qualifications held
                                  by employees
                                </Link>
                              </td>
                              <td className="govuk-table__cell--numeric">
                        ...
                        {themeValue === 'theme-2' && (
                          <>
                            ...
                            <tr>
                              <td>
                                <Link to="/prototypes/admin-publication">
                                  Children accommodated in secure children's
                                  homes
                                </Link>
                              </td>
                              <td className="govuk-table__cell--numeric">
                            ...
                            <tr>
                              <td>
                                <Link to="/prototypes/admin-publication">
                                  Looked after children aged 16 to 17 in
                                  independent or semi-independent placements
                                </Link>
                              </td>
                              <td className="govuk-table__cell--numeric">
                                23 May 2022
                        ...
                        {themeValue === 'theme-4' && (
                          <>
                            ...
                            <tr>
                              <td>
                                <Link to="/prototypes/admin-publication">
                                  Further education: outcome-based success
                                  measures
                                </Link>
                              </td>
                              <td className="govuk-table__cell--numeric">
