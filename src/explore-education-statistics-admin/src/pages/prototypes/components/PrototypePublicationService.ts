      ...
      content: [
        {
          ...
          content: [
            {
              $type:
                'GovUk.Education.ExploreEducationStatistics.Content.Api.Models.MarkDownBlock, GovUk.Education.ExploreEducationStatistics.Content.Api',
              type: 'MarkDownBlock',
              body:
        ...
        },
        {
          ...
          content: [
            ...
            {
              $type:
                'GovUk.Education.ExploreEducationStatistics.Content.Api.Models.DataBlock, GovUk.Education.ExploreEducationStatistics.Content.Api',
              type: 'DataBlock',
              heading: null,
              dataQuery: {
              ...
              charts: [
                {
                  $type:
                    'GovUk.Education.ExploreEducationStatistics.Content.Api.Models.LineChart, GovUk.Education.ExploreEducationStatistics.Content.Api',
                  indicators: [
        ...
        },
        {
          ...
          content: [
            {
              $type:
                'GovUk.Education.ExploreEducationStatistics.Content.Api.Models.InsetTextBlock, GovUk.Education.ExploreEducationStatistics.Content.Api',
              type: 'InsetTextBlock',
              heading: null,
              body:
