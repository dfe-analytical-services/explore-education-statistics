...
import { releaseApiDataSetLocationsMappingRoute } from '@admin/routes/releaseRoutes';
...
describe('ReleaseApiDataSetLocationsMappingPage', () => {
  ...
  test('shows the mapping action buttons for a user with permission to manage public API data sets', async () => {
    ...
    expect(
      screen.getAllByRole('button', { name: /^Map location/ }).length,
    ).toBeGreaterThan(0);
  });
