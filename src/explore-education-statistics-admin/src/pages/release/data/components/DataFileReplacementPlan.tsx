...
const DataFileReplacementPlan = ({
  ...
  const [isFetchingSoon, isFetchingSoonToggle] = useToggle(false);
  ...
  const {
    ...
    // disable automatic refetch triggers
...
function DataSetMappingProgressTag({
  mappableType,
  ...
  return (
    <>
      <WarningMessage>
        ...
        replacement as making this change may affect existing data blocks and
        footnotes.
      </WarningMessage>
      ...
      <div className="dfe-position--relative ">
        ...
        {hasInvalidDataBlocks ? (
          <p>
            ...
            replacement. The list below shows the affected data blocks, you can
