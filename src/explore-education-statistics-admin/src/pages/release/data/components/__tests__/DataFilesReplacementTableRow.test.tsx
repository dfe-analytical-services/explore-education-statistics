...
describe('DataFilesReplacementTableRow', () => {
  ...
  test('delete function is called with correct isReplacement argument', async () => {
    releaseDataFileService.getDataFile.mockResolvedValue({
      ...testReplacementDataFile,
      status: 'COMPLETE',
    });
    ...
    releaseDataFileService.deleteDataFiles.mockResolvedValue(undefined);

    const onReplacementStatusChange = jest.fn();
