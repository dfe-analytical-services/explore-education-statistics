...
import tableBuilderService, { ThemeMeta } from '@common/modules/full-table/services/tableBuilderService';
...
const CreateDataBlocks = () => {
  ...
  const [publicationId, setPublicationId] = React.useState<string>(publication.id);
