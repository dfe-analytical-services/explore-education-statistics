  ...
  return (
    <ReleasePageTabPanel tabKey="explore" hidden={hidden}>
      <ReleasePageLayout navItems={[]}>
        ...
        <p>
          No ferri partem ceteros pro. Everti volumus menandri at pro. Cum illud
          euripidis cu, mazim deterruisset ei eum. Ex alia dolorem insolens per,
          malis clita laboramus duo ut, ridens appareat philosophia ea quo.
        </p>
        <p>
