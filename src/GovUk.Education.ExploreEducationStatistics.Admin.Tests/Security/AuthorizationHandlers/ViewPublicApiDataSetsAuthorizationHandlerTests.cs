...
public abstract class ViewPublicApiDataSetsAuthorizationHandlerTests
{
    private readonly Guid _userId = Guid.NewGuid();
    private readonly Guid _publicationId = Guid.NewGuid();

    public class GlobalRolesTests : ViewPublicApiDataSetsAuthorizationHandlerTests
    {
        [Fact]
        public async Task SucceedsOnlyForValidGlobalRoles()
        {
            await AssertHandlerSucceedsWithCorrectGlobalRoles<ViewPublicApiDataSetsRequirement, Guid>(
    ...
    public class PublicationRolesTests : ViewPublicApiDataSetsAuthorizationHandlerTests
    {
        [Fact]
        public async Task SucceedsOnlyForValidPublicationRoles()
        {
            await AssertHandlerSucceedsForAnyValidPublicationRole<ViewPublicApiDataSetsRequirement, Guid>(
    ...
    private ViewPublicApiDataSetsAuthorizationHandler BuildHandler(
