    ...
    ITestOutputHelper output) : IAsyncLifetime
{
    ...
    // TestApplicationFactory testApp) : OptimisedDataSetVersionsControllerTests(testApp)
    // {
    ...
    //     public async Task NotBauUser_Returns403()
    //     {
    //         var client = BuildApp(user: _dataFixture.AuthenticatedUser()).CreateClient();
    //
    ...
    // }
    //
    // public class DeleteVersionTests(TestApplicationFactory testApp) : OptimisedDataSetVersionsControllerTests(testApp)
    // {
    //     [Fact]
    //     public async Task Success()
    //     {
    ...
    // }
    //
    // public class GetVersionChangesTests(TestApplicationFactory testApp) : OptimisedDataSetVersionsControllerTests(testApp)
    // {
    //     [Fact]
    ...
    // }
    //
    // public class UpdateVersionTests(TestApplicationFactory testApp) : OptimisedDataSetVersionsControllerTests(testApp)
    // {
    //     [Theory]
    ...
    //         })
    //         .SetUser(user ?? _dataFixture.BauUser());
    // }
}
