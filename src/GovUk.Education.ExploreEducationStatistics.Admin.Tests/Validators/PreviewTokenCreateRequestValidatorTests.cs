...
public class PreviewTokenCreateRequestValidatorTests
{
    ...
    // Activates at 2pm:
    [InlineData("2025-01-01T14:00:00 +00:00", "2025-01-08T13:59:59 +00:00", true)]
    [InlineData("2025-01-01T14:00:00 +00:00", "2025-01-08T14:00:00 +00:00", true)]
    [InlineData("2025-01-01T14:00:00 +00:00", "2025-01-08T23:59:59 +00:00", true)]
    [InlineData("2025-01-01T14:00:00 +00:00", "2025-01-09T00:00:00 +00:00", false)]
    // *Activates and expires both fall within daylight savings time*
    // Activates at start of day:
    [InlineData("2025-10-03T00:00:00 +01:00", "2025-10-10T23:59:59 +01:00", true)]
    [InlineData("2025-10-03T00:00:00 +01:00", "2025-10-11T00:00:00 +01:00", false)]
    // Activates at 2pm:
    [InlineData("2025-10-03T14:00:00 +01:00", "2025-10-10T13:59:59 +01:00", true)]
    [InlineData("2025-10-03T14:00:00 +01:00", "2025-10-10T14:00:00 +01:00", true)]
    [InlineData("2025-10-03T14:00:00 +01:00", "2025-10-10T23:59:59 +01:00", true)]
    [InlineData("2025-10-03T14:00:00 +01:00", "2025-10-11T00:00:00 +01:00", false)]
    // // *Activates outside daylight savings time, expires within daylight savings time*
    // // Activates at start of day:
    // [InlineData("2025-03-28T00:00:00 +00:00", "2025-04-04T23:59:59 +01:00", true)]
    // [InlineData("2025-03-28T00:00:00 +00:00", "2025-04-05T00:00:00 +01:00", false)]
    // // Activates at 2pm:
    // [InlineData("2025-03-28T14:00:00 +00:00", "2025-04-04T13:59:59 +01:00", true)]
    // [InlineData("2025-03-28T14:00:00 +00:00", "2025-04-04T14:00:00 +01:00", true)]
    // [InlineData("2025-03-28T14:00:00 +00:00", "2025-04-04T23:59:59 +01:00", true)]
    // [InlineData("2025-03-28T14:00:00 +00:00", "2025-04-05T00:00:00 +01:00", false)]
    // // *Activates within daylight savings time, expires outside daylight savings time*
    // // Activates at start of day:
    // [InlineData("2025-10-20T00:00:00 +01:00", "2025-10-27T23:59:59 +00:00", true)]
    // [InlineData("2025-10-20T00:00:00 +01:00", "2025-10-28T00:00:00 +00:00", false)]
    // // Activates at 2pm:
    // [InlineData("2025-10-20T14:00:00 +01:00", "2025-10-27T13:59:59 +00:00", true)]
    // [InlineData("2025-10-20T14:00:00 +01:00", "2025-10-27T14:00:00 +00:00", true)]
    // [InlineData("2025-10-20T14:00:00 +01:00", "2025-10-27T23:59:59 +00:00", true)]
    // [InlineData("2025-10-20T14:00:00 +01:00", "2025-10-28T00:00:00 +00:00", false)]
    ...
    )
    {
        ...
        var timeProvider = GetTimeProvider(DateTimeOffset.Parse(activates).ToUniversalTime());
