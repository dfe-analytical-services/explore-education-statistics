...
public class OrganisationsValidatorMockBuilder
{
    ...
    public OrganisationsValidatorMockBuilder WhereHasValidationErrors(
    ...
    public class Asserter(Mock<IOrganisationsValidator> mock)
    {
                ...
                m =>
                    m.ValidateOrganisations(
                        It.Is<Guid[]?>(organisationIds =>
                            ...
                            || organisationIds == expectedOrganisationIds
                        ),
        ...
        public void ValidateOrganisationsWasNotCalled() =>
            mock.Verify(ValidateOrganisations, Times.Never);
    }
}
