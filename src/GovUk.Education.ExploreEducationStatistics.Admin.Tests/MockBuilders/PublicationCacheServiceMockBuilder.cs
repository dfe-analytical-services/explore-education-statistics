...
public class PublicationCacheServiceMockBuilder
{
    ...
    public PublicationCacheServiceMockBuilder()
    {
        _mock
            ...
            .ReturnsAsync(
                (string slug) =>
                    (Either<ActionResult, PublicationCacheViewModel>)
                        new PublicationCacheViewModel { Slug = slug }
            );
    ...
    public PublicationCacheServiceMockBuilder WhereInvalidatingPublicationThrows(
    ...
    )
    {
        _mock
            ...
            .Throws(
                (string slug) =>
                    new Exception("This is a mock exception: UpdatePublication: " + slug)
            );
        return this;
    }

    public PublicationCacheServiceMockBuilder WhereInvalidatingPublicationFails(
        string? publicationSlug = null
    )
    {
        _mock
            ...
            .ReturnsAsync(() =>
                (Either<ActionResult, PublicationCacheViewModel>)new NotFoundResult()
            );
        return this;
    }
