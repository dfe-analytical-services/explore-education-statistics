...
public abstract class ReleaseServiceTests
{
    ...
    public class CreateReleaseTests : ReleaseServiceTests
    {
        ...
        public async Task WithTemplate()
        {
            ...
            Publication publication = _dataFixture
                .DefaultPublication()
                .WithReleases(
                    _dataFixture.DefaultRelease().WithVersions([templateReleaseVersion]).Generate(1)
                );
            ...
            await using (var context = InMemoryApplicationDbContext(contextId))
            {
                ...
                Assert.Equal(
                    ...
                    newReleaseVersion.SummarySection.Type
                );
                ...
                Assert.Empty(
                    context.DataBlocks.Where(dataBlock =>
                        dataBlock.ReleaseVersionId == newReleaseVersionId
                    )
                );
            }
        }
        ...
        public async Task GivenReleaseExists_ReleaseSlugIsValidated()
        {
            ...
            var releaseVersionService =
                new ReleaseVersionServiceMockBuilder().WhereGetReleaseVersionReturns();
    ...
    public class UpdateReleaseTests(ITestOutputHelper output) : ReleaseServiceTests
    {
        ...
        )
        {
            ...
            var releasePublishingStatusRepository =
                new ReleasePublishingStatusRepositoryMockBuilder().SetNoReleaseVersionStatus(
                    releaseVersion.Id
                );
    ...
    )
    {
        ...
        return new ReleaseService(
            ...
            releaseSlugValidator: releaseSlugValidator
                ?? new ReleaseSlugValidatorMockBuilder().Build()
        );
    }
}
