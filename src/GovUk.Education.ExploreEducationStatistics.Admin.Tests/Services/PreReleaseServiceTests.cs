...
{
    private static readonly DateTime DefaultScheduledPublishDate = new(
        2003,
        11,
        15,
        0,
    ...
    private static readonly DateTime DefaultActuallyPublishedDate = new(
        2003,
        11,
        15,
        9,
    ...
    private static readonly DateTime DateWithinPreReleaseAccessWindow = new(
        2003,
        11,
        14,
        10,
    ...
    private readonly PreReleaseService _service = new(
        ...
        {
            AccessWindow = new AccessWindowOptions { MinutesBeforeReleaseTimeStart = 1440 },
        }.ToOptionsWrapper()
    );
    ...
    public void CalculatesAccessRangeAsExpected(
        string referenceTimeString,
        bool releaseHasBeenPublished,
        PreReleaseAccess expectedAccess
    )
    {
        ...
        var referenceTime = DateTime.Parse(
            referenceTimeString,
    ...
    public void CalculatesStartAndScheduledPublishDatesAsExpected()
    {
        ...
        var result = _service.GetPreReleaseWindowStatus(
            testReleaseVersion,
