...
public class EmbedBlockServicePermissionTests
{
        ...
        await PolicyCheckBuilder<SecurityPolicies>()
            ...
            .AssertForbidden(userService =>
            {
                ...
                return service.Update(
                    ...
                    request: new EmbedBlockUpdateRequest { Title = "Test title", Url = "http://www.test.com" }
                );
            });
    }
    ...
    public async Task Delete()
    {
        await PolicyCheckBuilder<SecurityPolicies>()
            ...
            {
                var service = SetupEmbedBlockService(userService: userService.Object);
                return service.Delete(releaseVersionId: _releaseVersion.Id, contentBlockId: Guid.NewGuid());
            });
    }
