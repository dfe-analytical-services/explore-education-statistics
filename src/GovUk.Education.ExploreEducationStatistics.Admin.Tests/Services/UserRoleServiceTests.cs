...
public class UserRoleServiceTests
{
    ...
    public async Task SetGlobalRole()
    {
        ...
        await using (
            var userAndRolesDbContext = InMemoryUserAndRolesDbContext(userAndRolesDbContextId)
        )
        {
        ...
        userManager
            .Setup(mock =>
                mock.RemoveFromRolesAsync(
                    ItIsUser(user),
                    ItIs.ListSequenceEqualTo(ListOf(existingRole.Name))
                )
            )
            .ReturnsAsync(new IdentityResult());
    ...
    public async Task AddPublicationRole()
    {
        ...
        await using (
            var userAndRolesDbContext = InMemoryUserAndRolesDbContext(usersAndRolesDbContextId)
        )
        {
        ...
        userPublicationRoleRepository
            .Setup(mock =>
                mock.UserHasRoleOnPublication(_user.Id, publication.Id, PublicationRole.Owner)
            )
            .ReturnsAsync(false)
            .Verifiable();
        userPublicationRoleRepository
        ...
        )
        {
            ...
            var result = await service.AddPublicationRole(
                _user.Id,
                publication.Id,
                PublicationRole.Owner
            );
    ...
    public async Task AddReleaseRole()
    {
        ...
        userReleaseRoleRepository
            .Setup(mock =>
                mock.HasUserReleaseRole(_user.Id, releaseVersion.Id, ReleaseRole.Contributor)
            )
            .ReturnsAsync(false)
            .Verifiable();
        userReleaseRoleRepository
    ...
    public async Task AddReleaseRole_UserAlreadyHasReleaseRole()
    {
        ...
        userReleaseRoleRepository
            .Setup(mock =>
                mock.HasUserReleaseRole(_user.Id, release.Versions[0].Id, ReleaseRole.Contributor)
            )
            .ReturnsAsync(true)
            .Verifiable();
    ...
    public async Task RemoveUserPublicationRole()
    {
        ...
        userPublicationRoleRepository
            .Setup(m =>
                m.Remove(
                    It.Is<UserPublicationRole>(urr => urr.Id == userPublicationRole.Id),
                    default
                )
            )
    ...
    public async Task RemoveUserReleaseRole()
    {
        ...
        userReleaseRoleRepository
            .Setup(m =>
                m.Remove(It.Is<UserReleaseRole>(urr => urr.Id == userReleaseRole.Id), default)
            )
            .Returns(Task.CompletedTask)
            .Verifiable();
        userReleaseRoleRepository
    ...
    public async Task RemoveUserReleaseRoleAsPrerelease_AnalystRoleRetained()
    {
        ...
        userReleaseRoleRepository
            .Setup(m =>
                m.Remove(It.Is<UserReleaseRole>(urr => urr.Id == prereleaseRole.Id), default)
            )
            .Returns(Task.CompletedTask)
            .Verifiable();
        userReleaseRoleRepository
    ...
    )
    {
        ...
        return new UserRoleService(
            ...
            usersAndRolesPersistenceHelper
                ?? new PersistenceHelper<UsersAndRolesDbContext>(usersAndRolesDbContext),
