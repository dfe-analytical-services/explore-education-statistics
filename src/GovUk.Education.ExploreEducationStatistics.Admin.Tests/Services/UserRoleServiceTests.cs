...
public class UserRoleServiceTests
{
    ...
    public async Task RemoveAllUserResourceRoles()
    {
        ...
        var remainingUserReleaseRoles = await contentDbContext
            .UserReleaseRoles
            .ToListAsync();
        ...
        Assert.Equal(otherUser.Id, remainingUserReleaseRole.UserId);
        Assert.Equal(otherUser.Id, remainingUserPublicationRole.UserId);
    }
