...
public class UserManagementServiceTests
{
    ...
    public async Task GetUser()
    {
        ...
        userRoleService
            .Setup(mock => mock.GetPublicationRolesForUser(userId))
            .ReturnsAsync(publicationRoles);
    ...
    public async Task UpdateUser()
    {
        ...
        userRoleService
            .Setup(mock => mock.SetGlobalRole(user.Id, role.Id))
    ...
    public async Task InviteUser(DateTime? createdDate)
    {
        ...
        userReleaseInviteRepository
            .Setup(mock =>
                mock.Create(releaseVersion.Id, email, releaseRole, true, CreatedById, createdDate)
            )
            .Returns(Task.CompletedTask)
            .Callback(async () =>
            {
        ...
        userPublicationInviteRepository
            .Setup(mock =>
                mock.CreateManyIfNotExists(userPublicationRoles, email, CreatedById, createdDate)
            )
            .Returns(Task.CompletedTask)
            .Callback(async () =>
            {
        ...
        {
            var userInvites = await usersAndRolesDbContext.UserInvites.ToListAsync();
    ...
    public async Task InviteUser_MultipleReleaseAndPublicationRoles()
    {
        ...
        userPublicationInviteRepository
            .Setup(mock =>
                mock.CreateManyIfNotExists(userPublicationRoles, email, CreatedById, null)
            )
            .Returns(Task.CompletedTask)
            .Callback(async () =>
            {
    ...
    private async Task AssertExistingUserInviteOverridden(DateTime inviteCreatedDate)
    {
        ...
        {
            new() { ReleaseId = release2.Id, ReleaseRole = ReleaseRole.PrereleaseViewer },
        };
        var userPublicationRolesToCreate = new List<UserPublicationRoleCreateRequest>()
        {
            new() { PublicationId = publication2.Id, PublicationRole = PublicationRole.Owner },
        };
        ...
        userPublicationInviteRepository
            .Setup(mock =>
                mock.CreateManyIfNotExists(userPublicationRolesToCreate, email, CreatedById, null)
            )
            .Returns(Task.CompletedTask)
            .Callback(async () =>
            {
    ...
    public async Task CancelInvite()
    {
        ...
        )
        {
            usersAndRolesDbContext.UserInvites.AddRange(
                ...
                new UserInvite { Email = otherEmail, Created = DateTime.UtcNow.AddDays(-1) }
            );
            await usersAndRolesDbContext.SaveChangesAsync();
        }
    ...
    public async Task DeleteUser()
    {
        ...
        var invite = new UserInvite { Email = internalUser.Email };
        ...
        userManager
            .Setup(mock =>
                mock.DeleteAsync(It.Is<ApplicationUser>(user => user.Email == internalUser.Email))
            )
        ...
        )
        {
            userRepository
                ...
                .ReturnsAsync(() =>
                    contentDbContext.Users.Single(u => u.Email == internalUser.Email)
                )
                .Verifiable();
