...
public abstract class UserReleaseRoleRepositoryTests
{
    ...
    public class CreateTests : UserReleaseRoleRepositoryTests
    {
        ...
        public async Task Create()
        {
            ...
            await using (var contentDbContext = InMemoryApplicationDbContext(contentDbContextId))
            {
                var userReleaseRole = await contentDbContext
                ...
                Assert.InRange(
                    DateTime.UtcNow.Subtract(userReleaseRole.Created!.Value).Milliseconds,
                    0,
                    1500
                );
            }
    ...
    public class CreateIfNotExistsTests : UserReleaseRoleRepositoryTests
    {
        ...
        public async Task CreateIfNotExists_AlreadyExists()
        {
            ...
            await using (var contentDbContext = InMemoryApplicationDbContext(contentDbContextId))
            {
                var dbUserReleaseRole = await contentDbContext
                    .UserReleaseRoles.AsQueryable()
                    .SingleAsync();
                ...
                Assert.Equal(
                    dbUserReleaseRole.ReleaseVersionId,
                    dbUserReleaseRole.ReleaseVersionId
                );
    ...
    public class CreateManyIfNotExistsTests : UserReleaseRoleRepositoryTests
    {
        ...
        public async Task CreateManyIfNotExists_Users()
        {
            ...
            await using (var contentDbContext = InMemoryApplicationDbContext(contentDbContextId))
            {
                ...
                Assert.InRange(
                    DateTime.UtcNow.Subtract(userReleaseRoles[1].Created!.Value).Milliseconds,
                    0,
                    1500
                );
                ...
                Assert.InRange(
                    DateTime.UtcNow.Subtract(userReleaseRoles[2].Created!.Value).Milliseconds,
                    0,
                    1500
                );
                ...
                Assert.InRange(
                    DateTime.UtcNow.Subtract(userReleaseRoles[3].Created!.Value).Milliseconds,
                    0,
                    1500
                );
            }
        ...
        public async Task CreateManyIfNotExists_Releases()
        {
            ...
            await using (var contentDbContext = InMemoryApplicationDbContext(contentDbContextId))
            {
                ...
                Assert.Equal(
                    userRelease1Role.ReleaseVersionId,
        ...
        public async Task GetAllRolesByUserAndPublication()
        {
                ...
                _fixture
                    ...
                    .WithReleaseVersion(
                        _fixture
                            .DefaultReleaseVersion()
                            .WithRelease(
                                _fixture.DefaultRelease().WithPublication(otherPublication)
                            )
                    ),
            ...
            await using (var contentDbContext = InMemoryApplicationDbContext(contentDbContextId))
            {
                ...
                await contentDbContext.UserReleaseRoles.AddRangeAsync(
                    userReleaseRolesForPublication
                );
    ...
    public class GetDistinctRolesByUserTests : UserReleaseRoleRepositoryTests
    {
        ...
        public async Task GetDistinctRolesByUser()
        {
            ...
            await using (var contentDbContext = InMemoryApplicationDbContext(contentDbContextId))
            {
                ...
                Assert.Equal(
                    [ReleaseRole.Contributor, ReleaseRole.PrereleaseViewer, ReleaseRole.Approver],
                    result
                );
            }
        }
    ...
    public class RemoveTests : UserReleaseRoleRepositoryTests
    {
        ...
        public async Task Success()
        {
            ...
            await using (var contentDbContext = InMemoryApplicationDbContext(contentDbContextId))
            {
                ...
                var userReleaseRoleToRemove = await contentDbContext.UserReleaseRoles.SingleAsync(
                    urr => urr.Id == userReleaseRole.Id
                );
            ...
            await using (var contentDbContext = InMemoryApplicationDbContext(contentDbContextId))
            {
                var updatedReleaseRole =
                    await contentDbContext.UserReleaseRoles.SingleOrDefaultAsync(urr =>
    ...
    public class RemoveForPublicationTests : UserReleaseRoleRepositoryTests
    {
        ...
        public async Task TargetPublicationHasRoles_RemovesTargetRoles()
        {
            ...
            await using (var contentDbContext = InMemoryApplicationDbContext(contentDbContextId))
            {
                ...
                var expectedNumberOfRemainingRoles =
                    allUserReleaseRoles.Count - expectedNumberOfRolesToRemove;
        ...
        [InlineData(
            new[] { ReleaseRole.Approver, ReleaseRole.Contributor, ReleaseRole.PrereleaseViewer }
        )]
        ...
        public async Task TargetUserHasRoles_RemovesTargetRoles()
        {
            ...
            await using (var contentDbContext = InMemoryApplicationDbContext(contentDbContextId))
            {
                var remainingRoles = await contentDbContext
                    .UserReleaseRoles.Include(urr => urr.User)
                    .ToListAsync();
