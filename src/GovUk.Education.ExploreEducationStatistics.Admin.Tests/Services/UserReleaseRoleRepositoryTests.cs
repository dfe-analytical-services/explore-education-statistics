    ...
    public class UserReleaseRoleRepositoryTests
    {
        ...
        public async Task Remove_IgnoreQueryFilters()
        {
            ...
            await using (var contentDbContext = InMemoryApplicationDbContext(contentDbContextId))
            {
                ...
                updatedReleaseRole.Deleted.AssertRecent();
        ...
        public async Task RemoveMany_IgnoreQueryFilters()
        {
            ...
            await using (var contentDbContext = InMemoryApplicationDbContext(contentDbContextId))
            {
                ...
                userReleaseRoles[0].Deleted.AssertRecent();
                ...
                userReleaseRoles[1].Deleted.AssertRecent();
                ...
                userReleaseRoles[2].Deleted.AssertRecent();
