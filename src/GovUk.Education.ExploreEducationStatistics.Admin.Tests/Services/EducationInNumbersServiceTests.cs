...
public class EducationInNumbersServiceTests
{
    ...
    private EducationInNumbersService CreateService(ContentDbContext contentDbContext, IUserService? userService = null)
    {
        return new EducationInNumbersService(contentDbContext, userService ?? AlwaysTrueUserService(_userId).Object);
    }
}
