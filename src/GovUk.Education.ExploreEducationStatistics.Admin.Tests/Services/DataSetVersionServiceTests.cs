...
public abstract class DataSetVersionServiceTests(TestApplicationFactory testApp)
    : IntegrationTestFixture(testApp)
{
    public class GetStatusesForReleaseVersionTests(TestApplicationFactory testApp)
        : DataSetVersionServiceTests(testApp)
    {
        ...
        private async Task AssertDataSetVersionStatusReturnedOk(DataSetVersionStatus status)
        {
            ...
            var statusSummary = Assert.Single(
                await service.GetStatusesForReleaseVersion(dataFile.ReleaseVersionId)
            );
        ...
        : DataSetVersionServiceTests(testApp)
    {
        ...
        public async Task Success()
        {
            ...
            var actualDataSetVersions = await publicDataDbContext
