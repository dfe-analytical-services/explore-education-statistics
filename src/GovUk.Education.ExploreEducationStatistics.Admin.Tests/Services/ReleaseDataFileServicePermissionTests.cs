...
namespace GovUk.Education.ExploreEducationStatistics.Admin.Tests.Services
{
    public class ReleaseDataFileServicePermissionTests
    {
            ...
            IUserService? userService = null)
        {
            ...
            releaseVersionRepository ??= new Mock<IReleaseVersionRepository>(MockBehavior.Strict).Object;
            releaseDataFileRepository ??= new Mock<IReleaseDataFileRepository>(MockBehavior.Strict).Object;
