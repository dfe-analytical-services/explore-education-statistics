    ...
    public class ContentServiceTests
    {
        ...
        public async Task AttachDataBlock()
        {
            ...
            await using (var contentDbContext = InMemoryApplicationDbContext(contentDbContextId))
            {
                ...
                var dataBlockVersionViewModel = result.AssertRight();
                Assert.Equal(dataBlockVersion.Id, dataBlockVersionViewModel.Id);
                Assert.Equal(dataBlockParent.Id, dataBlockVersionViewModel.DataBlockParentId);
            }
