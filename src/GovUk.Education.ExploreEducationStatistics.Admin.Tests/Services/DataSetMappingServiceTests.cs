...
public class DataSetMappingServiceTests
{
    ...
    public async Task GetOrCreateMapping_FetchesDbMapping_Success()
    {
        ...
        var mapping = new DataSetMapping
        {
            ...
            UnsetReplacementIndicators =
            [
                new UnsetIndicator
                {
                    Id = Guid.NewGuid(),
                    Label = "Unset indicator",
                    GroupId = Guid.NewGuid(),
                    GroupLabel = "Unset indicator group",
                },
            ],
        };
        ...
        await using (var statisticsDbContext = StatisticsDbUtils.InMemoryStatisticsDbContext(statisticsDbContextId))
        {
            ...
            var unsetIndicator = Assert.Single(result.UnsetReplacementIndicators);
            Assert.Equal(mapping.UnsetReplacementIndicators.First(), unsetIndicator);
        }
    }
