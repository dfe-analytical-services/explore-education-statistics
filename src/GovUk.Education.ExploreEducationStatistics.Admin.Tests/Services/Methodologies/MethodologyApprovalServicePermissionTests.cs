...
{
    private readonly MethodologyVersion _methodologyVersion = new() { Id = Guid.NewGuid(), Status = Draft };

    private readonly MethodologyVersion _approvedMethodologyVersion = new() { Id = Guid.NewGuid(), Status = Approved };
