...
public class MethodologyImageServiceTests
{
    ...
    public async Task Delete()
    {
        ...
        privateBlobStorageService.SetupDeleteBlob(PrivateMethodologyFiles, imageFile1.Path());
        publicBlobStorageService.SetupDeleteBlob(PublicMethodologyFiles, imageFile1.Path());
        privateBlobStorageService.SetupDeleteBlob(PrivateMethodologyFiles, imageFile2.Path());
        publicBlobStorageService.SetupDeleteBlob(PublicMethodologyFiles, imageFile2.Path());
        ...
        await using (var contentDbContext = InMemoryApplicationDbContext(contentDbContextId))
        {
            ...
            var result = await service.Delete(methodologyVersion.Id, AsList(imageFile1.File.Id, imageFile2.File.Id));

            result.AssertRight();

            MockUtils.VerifyAllMocks(privateBlobStorageService, publicBlobStorageService);
        }
    ...
    public async Task Delete_FilesLinkedToOtherMethodologyVersions()
    {
        ...
        {
            await contentDbContext.MethodologyVersions.AddAsync(methodologyVersion);
            await contentDbContext.MethodologyFiles.AddRangeAsync(
                imageFile1,
                imageFile2,
        ...
        await using (var contentDbContext = InMemoryApplicationDbContext(contentDbContextId))
        {
            ...
            var filesForFileLinkedToDeletingMethodology = await contentDbContext.Files.FindAsync(imageFile2.File.Id);

            var filesForFileLinkedToAnotherMethodology = await contentDbContext.Files.FindAsync(
                imageFile2UsedByAnotherMethodology.File.Id
            );
    ...
    public async Task Delete_InvalidFileType()
    {
        ...
        await using (var contentDbContext = InMemoryApplicationDbContext(contentDbContextId))
        {
            ...
            var result = await service.Delete(methodologyVersion.Id, AsList(ancillaryFile.File.Id, imageFile.File.Id));
    ...
    public async Task Delete_MethodologyVersionNotFound()
    {
        ...
        await using (var contentDbContext = InMemoryApplicationDbContext(contentDbContextId))
        {
            ...
            var result = await service.Delete(Guid.NewGuid(), AsList(imageFile.File.Id));
    ...
    public async Task Delete_FileNotFound()
    {
        ...
        await using (var contentDbContext = InMemoryApplicationDbContext(contentDbContextId))
        {
            ...
            var result = await service.Delete(methodologyVersion.Id, AsList(imageFile.File.Id, Guid.NewGuid()));
    ...
    public async Task Stream()
    {
        ...
        privateBlobStorageService.SetupGetDownloadStream(PrivateMethodologyFiles, methodologyFile.Path(), fileData);
    ...
    public async Task Upload()
    {
        ...
        privateBlobStorageService
            .Setup(mock =>
                mock.UploadFile(
                    ...
                    It.Is<string>(path => path.Contains(FilesPath(methodologyVersion.Id, Image))),
                    formFile
                )
            )
        ...
        await using (var contentDbContext = InMemoryApplicationDbContext(contentDbContextId))
        {
            var methodologyFile = await contentDbContext
