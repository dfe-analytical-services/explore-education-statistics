...
public class ProcessorClientTests
{
    ...
    public class AuthenticationTests : ProcessorClientTests
    {
        ...
        public async Task AuthenticationManagerCalled()
        {
            ...
            var authenticationManager = new Mock<
                IHttpClientAzureAuthenticationManager<PublicDataProcessorOptions>
            >(MockBehavior.Strict);
            ...
            _mockHttp
                ...
                .Respond(
                    ...
                    JsonContent.Create(
                        ...
                        {
                            Errors = [new() { Code = Errors.Error1.ToString() }],
                        }
                    )
                );
    ...
    private ProcessorClient BuildService(
        IHttpClientAzureAuthenticationManager<PublicDataProcessorOptions>? azureAuthenticationManager =
            null
    )
    {
