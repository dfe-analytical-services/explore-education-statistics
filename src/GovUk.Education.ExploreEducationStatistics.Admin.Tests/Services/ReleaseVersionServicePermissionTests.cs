...
namespace GovUk.Education.ExploreEducationStatistics.Admin.Tests.Services
{
    public class ReleaseVersionServicePermissionTests
    {
        ...
        public async Task GetRelease()
        {
            await PolicyCheckBuilder<ContentSecurityPolicies>()
                ...
                .AssertForbidden(
                    userService =>
                    {
                        var service = BuildReleaseVersionService(userService.Object);
        ...
        public async Task ListReleasesWithStatuses_NoAccessToSystem()
        {
            await PolicyCheckBuilder<SecurityPolicies>()
                ...
                .AssertForbidden(
                    async userService =>
                    {
                        var service = BuildReleaseVersionService(userService: userService.Object);
        ...
        private ReleaseVersionService BuildReleaseVersionService(
