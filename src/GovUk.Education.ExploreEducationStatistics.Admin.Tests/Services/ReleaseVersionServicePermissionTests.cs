    ...
    public async Task ListReleasesWithStatuses_CanViewAllReleases()
    {
        ...
        await PolicyCheckBuilder<SecurityPolicies>()
            ...
            .AssertSuccess(async userService =>
            {
                userService
                    .Setup(s =>
                        s.MatchesPolicy(releaseVersion, CanAssignPreReleaseUsersToSpecificRelease)
                    )
                    .ReturnsAsync(true);
                ...
                userService
                    .Setup(s =>
                        s.MatchesPolicy(releaseVersion, CanMakeAmendmentOfSpecificReleaseVersion)
                    )
                    .ReturnsAsync(true);
    ...
    public async Task UpdateReleasePublished()
    {
        ...
        await PolicyCheckBuilder<SecurityPolicies>()
            ...
            .AssertForbidden(async userService =>
            {
                ...
                return await service.UpdateReleasePublished(
                    releaseVersion.Id,
    ...
    )
    {
        ...
        return new ReleaseVersionService(
            ...
            releaseVersionRepository
                ?? new ReleaseVersionRepository(contentDbContext, statisticsDbContext),
