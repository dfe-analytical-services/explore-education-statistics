#nullable enable
namespace GovUk.Education.ExploreEducationStatistics.Data.Api.Options;

// @ClaudeFix Update the bicep files: mount the statistics data Azure File Share (shared with admin and the importer) into the data-api app
