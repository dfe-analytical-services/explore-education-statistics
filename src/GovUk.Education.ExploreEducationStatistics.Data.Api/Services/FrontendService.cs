...
public class FrontendService : IFrontendService
{
    ...
    public FrontendService(IHttpClientFactory httpClientFactory, ILogger<FrontendService> logger)
    {
    ...
    )
    {
        ...
        var response = await httpClient.PostAsync("api/permalink", request, cancellationToken);
    ...
    private record TableCreateRequest(TableBuilderResultViewModel FullTable, TableBuilderConfiguration Configuration);
}
