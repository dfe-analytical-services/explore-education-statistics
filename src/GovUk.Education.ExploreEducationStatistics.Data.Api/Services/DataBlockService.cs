...
public class DataBlockService : IDataBlockService
{
    ...
    )
    {
        return await _persistenceHelper
            ...
            .OnSuccess(() =>
                CheckDataBlockVersionExists(releaseVersionId: releaseVersionId, dataBlockVersionId: dataBlockVersionId)
            )
    ...
    > GetLocationsForDataBlock(Guid releaseVersionId, Guid dataBlockVersionId, long boundaryLevelId)
    {
        return await _persistenceHelper
            .CheckEntityExists<ReleaseVersion>(releaseVersionId)
            .OnSuccess(_userService.CheckCanViewReleaseVersion)
            ...
            .OnSuccess(dataBlock =>
                _tableBuilderService.QueryForBoundaryLevel(releaseVersionId, dataBlock.Query, boundaryLevelId)
            );
    }
    ...
    )
    {
        return await _contentDbContext
            .DataBlockVersions.Where(dataBlockVersion =>
                dataBlockVersion.ReleaseVersionId == releaseVersionId && dataBlockVersion.Id == dataBlockVersionId
            )
