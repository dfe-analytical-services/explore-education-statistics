...
namespace GovUk.Education.ExploreEducationStatistics.Content.Api.Controllers
{
    ...
    public class ReleaseController : ControllerBase
    {
        ...
        [MemoryCache(typeof(GetLatestReleaseCacheKey), expirySchedule: HalfHourly, cacheDurationInSeconds: 30)]
        ...
        [MemoryCache(typeof(GetReleaseCacheKey), expirySchedule: HalfHourly, cacheDurationInSeconds: 30)]
