...
public class LocationServiceTests
{
    ...
    public async Task GetLocationViewModels_NoBoundaryLevel_ReturnsViewModelsWithoutGeoJson()
    {
        ...
        var locations = new List<Location> { location1, location2, location3, location4, location5, location6 };
    ...
    public async Task GetLocationViewModels_WithBoundaryLevel_ReturnsViewModelsWithGeoJson()
    {
        ...
        var hierarchies = new Dictionary<GeographicLevel, List<string>> { { GeographicLevel.Region, ["Country"] } };
