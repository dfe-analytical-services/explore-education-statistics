...
public class TimePeriodUtilTests
{
    ...
    public void RangeFailsIfTimeIdentifiersAreNotAlike()
    {
        ...
        var termIdentifiers = new[] { AutumnTerm, AutumnSpringTerm, SpringTerm, SummerTerm };

        var financialYearPartIdentifiers = new[] { FinancialYearPart1, FinancialYearPart2 };
        ...
        foreach (var identifier in _allTimeIdentifiers.Except(financialYearPartIdentifiers))
        {
            Assert.Throws<ArgumentException>(() =>
                TimePeriodUtil.Range(
                    new TimePeriodQuery(2018, FinancialYearPart1, 2019, identifier)
                )
            );
        }
    ...
    public void RangeIsGeneratedForAcademicYearQuery()
    {
        ...
        CollectionAssert.AreEquivalent(
            expected,
            TimePeriodUtil
                .Range(new TimePeriodQuery(2018, AcademicYear, 2019, AcademicYear))
                .ToList()
        );
    }
    ...
    public void RangeIsGeneratedForCalendarYearQuery()
    {
        ...
        CollectionAssert.AreEquivalent(
            expected,
            TimePeriodUtil
                .Range(new TimePeriodQuery(2018, CalendarYear, 2019, CalendarYear))
                .ToList()
        );
    }
    ...
    public void RangeIsGeneratedForFinancialYearQuery()
    {
        ...
        CollectionAssert.AreEquivalent(
            expected,
            TimePeriodUtil
                .Range(new TimePeriodQuery(2018, FinancialYear, 2019, FinancialYear))
                .ToList()
        );
    }
    ...
    public void RangeIsGeneratedForReportingYearQuery()
    {
        ...
        CollectionAssert.AreEquivalent(
            expected,
            TimePeriodUtil
                .Range(new TimePeriodQuery(2018, ReportingYear, 2019, ReportingYear))
                .ToList()
        );
    }
    ...
    {
        CollectionAssert.AreEquivalent(
            new List<(int Year, TimeIdentifier TimeIdentifier)> { (2019, February) },
    ...
    {
        CollectionAssert.AreEquivalent(
            new List<(int Year, TimeIdentifier TimeIdentifier)> { (2020, Week17) },
    ...
    {
        CollectionAssert.AreEquivalent(
            new List<(int Year, TimeIdentifier TimeIdentifier)> { (2019, AcademicYearQ3) },
            TimePeriodUtil
                .Range(new TimePeriodQuery(2019, AcademicYearQ3, 2019, AcademicYearQ3))
                .ToList()
        );
        ...
        CollectionAssert.AreEquivalent(
            ...
            TimePeriodUtil
                .Range(new TimePeriodQuery(2019, AcademicYearQ3, 2019, AcademicYearQ4))
                .ToList()
        );
        ...
        CollectionAssert.AreEquivalent(
            ...
            TimePeriodUtil
                .Range(new TimePeriodQuery(2018, AcademicYearQ4, 2020, AcademicYearQ2))
                .ToList()
        );
    }
    ...
    {
        CollectionAssert.AreEquivalent(
            new List<(int Year, TimeIdentifier TimeIdentifier)> { (2019, CalendarYearQ3) },
            TimePeriodUtil
                .Range(new TimePeriodQuery(2019, CalendarYearQ3, 2019, CalendarYearQ3))
                .ToList()
        );
        ...
        CollectionAssert.AreEquivalent(
            ...
            TimePeriodUtil
                .Range(new TimePeriodQuery(2019, CalendarYearQ3, 2019, CalendarYearQ4))
                .ToList()
        );
        ...
        CollectionAssert.AreEquivalent(
            ...
            TimePeriodUtil
                .Range(new TimePeriodQuery(2018, CalendarYearQ4, 2020, CalendarYearQ2))
                .ToList()
        );
    }
    ...
    {
        CollectionAssert.AreEquivalent(
            new List<(int Year, TimeIdentifier TimeIdentifier)> { (2019, FinancialYearQ3) },
            TimePeriodUtil
                .Range(new TimePeriodQuery(2019, FinancialYearQ3, 2019, FinancialYearQ3))
                .ToList()
        );
        ...
        CollectionAssert.AreEquivalent(
            ...
            TimePeriodUtil
                .Range(new TimePeriodQuery(2019, FinancialYearQ3, 2019, FinancialYearQ4))
                .ToList()
        );
        ...
        CollectionAssert.AreEquivalent(
            ...
            TimePeriodUtil
                .Range(new TimePeriodQuery(2018, FinancialYearQ4, 2020, FinancialYearQ2))
                .ToList()
        );
    }
    ...
    {
        CollectionAssert.AreEquivalent(
            new List<(int Year, TimeIdentifier TimeIdentifier)> { (2019, TaxYearQ3) },
    ...
    {
        CollectionAssert.AreEquivalent(
            new List<(int Year, TimeIdentifier TimeIdentifier)> { (2019, AutumnTerm) },
        ...
        CollectionAssert.AreEquivalent(
            ...
            TimePeriodUtil
                .Range(new TimePeriodQuery(2018, AutumnSpringTerm, 2020, AutumnTerm))
                .ToList()
        );
    }
    ...
    {
        CollectionAssert.AreEquivalent(
            new List<(int Year, TimeIdentifier TimeIdentifier)> { (2021, FinancialYearPart1) },
            TimePeriodUtil
                .Range(new TimePeriodQuery(2021, FinancialYearPart1, 2021, FinancialYearPart1))
                .ToList()
        );
        ...
        CollectionAssert.AreEquivalent(
            ...
            TimePeriodUtil
                .Range(new TimePeriodQuery(2021, FinancialYearPart1, 2021, FinancialYearPart2))
                .ToList()
        );
        ...
        CollectionAssert.AreEquivalent(
            ...
            TimePeriodUtil
                .Range(new TimePeriodQuery(2020, FinancialYearPart1, 2021, FinancialYearPart1))
                .ToList()
        );
    }
}
