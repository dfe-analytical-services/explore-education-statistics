...
public class TimePeriodUtilTests
{
    ...
    {
        var calendarQuarterIdentifiers = new[] { CalendarYearQ1, CalendarYearQ2, CalendarYearQ3, CalendarYearQ4 };
    ...
    {
        var expected = new List<(int Year, TimeIdentifier TimeIdentifier)> { (2018, TaxYear), (2019, TaxYear) };
    ...
    public void RangeIsGeneratedForAcademicQuarterQuery()
    {
        ...
        CollectionAssert.AreEquivalent(
            new List<(int Year, TimeIdentifier TimeIdentifier)> { (2019, AcademicYearQ3), (2019, AcademicYearQ4) },
    ...
    public void RangeIsGeneratedForCalendarQuarterQuery()
    {
        ...
        CollectionAssert.AreEquivalent(
            new List<(int Year, TimeIdentifier TimeIdentifier)> { (2019, CalendarYearQ3), (2019, CalendarYearQ4) },
    ...
    public void RangeIsGeneratedForFinancialQuarterQuery()
    {
        ...
        CollectionAssert.AreEquivalent(
            new List<(int Year, TimeIdentifier TimeIdentifier)> { (2019, FinancialYearQ3), (2019, FinancialYearQ4) },
    ...
    public void RangeIsGeneratedForTaxQuarterQuery()
    {
        ...
        CollectionAssert.AreEquivalent(
            new List<(int Year, TimeIdentifier TimeIdentifier)> { (2019, TaxYearQ3), (2019, TaxYearQ4) },
