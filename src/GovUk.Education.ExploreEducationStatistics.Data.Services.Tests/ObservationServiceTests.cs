...
public class ObservationServiceTests
{
    ...
    public async Task QueryGenerator_MinimalQuery()
    {
        ...
        var tempTableCreator =
            new Mock<MatchingObservationsQueryGenerator.ITemporaryTableCreator>();
        tempTableCreator
        ...
        var (sql, sqlParameters, tempTableReferences) =
            await queryGenerator.GetMatchingObservationsQuery(
                context,
                subjectId,
                [],
                [],
    ...
    public async Task QueryGenerator_FilterItems()
    {
        ...
        await using (var context = InMemoryStatisticsDbContext(contextId))
        {
            ...
            var filterItemIdTempTableReferences = selectedFilterItemTempTableEntriesByFilter
                ...
                {
                    var filterNumber =
                        selectedFilterItemTempTableEntriesByFilter.IndexOf(tempTableEntries) + 1;
            ...
            var expectedTempTableReferences = filterItemIdTempTableReferences.Select(mock =>
                mock.Object
            );
    ...
    private static string FormatSql(string sql)
    {
        ...
        var openingBracketWhitespaceStripped = removeWhitespaceAfterOpeningBracket.Replace(
            newLinesStripped,
            "("
        );
