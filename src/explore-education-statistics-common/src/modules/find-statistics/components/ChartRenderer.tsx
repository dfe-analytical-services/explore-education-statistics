...
import Infographic, {InfographicChartProps} from "@common/modules/find-statistics/components/charts/Infographic";
...
export interface ChartRendererProps extends ChartProps, StackedBarProps, InfographicChartProps {
  type: ChartType;
}
