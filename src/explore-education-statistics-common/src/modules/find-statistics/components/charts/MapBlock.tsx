...
const MapBlock = ({
  ...
  const [selectedDataSetKey, setSelectedDataSetKey] = React.useState<string>(generateKeyFromDataSet(axes.major.dataSets[0], axes.major.groupBy));
  ...
  }, [chartData, meta, selectedDataSetKey]);
