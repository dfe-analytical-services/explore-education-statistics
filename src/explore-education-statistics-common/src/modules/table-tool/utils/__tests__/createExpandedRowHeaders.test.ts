...
describe('createExpandedRowHeaders', () => {
  ...
  //   const expandedRowHeaders: TableCellJson[][] = [
  //     [
  //       { tag: 'th', text: 'A', rowSpan: 2, scope:'rowgroup', colSpan: 1 },
  //       { tag: 'th', text: 'C', rowSpan: 1, scope:'row', colSpan: 2 },
  //     ],
  //     [{ tag: 'th', text: 'D', rowSpan: 1, scope:'row', colSpan: 2 }],
  //   ];
  //   expect(createExpandedRowHeaders(rowHeaders)).toEqual(expandedRowHeaders);
  // });

  // test.skip('returns correct headers with all colrowSpan = 1 when has empty header cell text', () => {
  //   const rowHeaders: Header[] = [
  ...
  //     [
  //       {
  //         colSpan: 2, // received 1 when shouldnt be
  //         tag: 'th',
  //         scope:'row',
  //         rowSpan: 1,
  //         text: 'A',
  ...
  //   const expandedRowHeaders: TableCellJson[][] = [
  //     [
  //       { tag: 'th', text: 'A', rowSpan: 8, scope:'rowgroup', colSpan: 1 },
  //       { tag: 'th', text: 'B', rowSpan: 4, scope:'rowgroup', colSpan: 2 },
  //       { tag: 'th', text: 'C', rowSpan: 2, scope:'rowgroup', colSpan: 1 },
  //       { tag: 'th', text: 'E', rowSpan: 1, scope:'row', colSpan: 1 },
  //     ],
  //     [{ tag: 'th', text: 'F', rowSpan: 1, scope:'row', colSpan: 1 }],
  //     [
  //       { tag: 'th', text: 'D', rowSpan: 2, scope:'rowgroup', colSpan: 1 },
  //       { tag: 'th', text: 'E', rowSpan: 1, scope:'row', colSpan: 1 },
  //     ],
  //     [{ tag: 'th', text: 'F', rowSpan: 1, scope:'row', colSpan: 1 }],
  //     [
  //       {tag: 'th', text: 'G', rowSpan: 4, scope:'rowgroup', colSpan: 2 },
  //       { tag: 'th', text: 'C', rowSpan: 2, scope:'rowgroup', colSpan: 1 },
  //       { tag: 'th', text: 'E', rowSpan: 1, scope:'row', colSpan: 1 },
  //     ],
  //     [{ tag: 'th', text: 'F', rowSpan: 1, scope:'row', colSpan: 1 }],
