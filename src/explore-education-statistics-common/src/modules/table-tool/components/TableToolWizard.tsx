      ...
      /* const dummyMeta: SubjectMeta = {
        filters: {
          ...
          NameOfCourseBeingStudied: {
            id: 'd881a5bd-4a89-461b-5a09-08dd45241022',
          ...
          SectorSubjectArea: {
            id: '29cdafd8-f969-4487-5a08-08dd45241022',
        ...
        filterHierarchies: [
          {
            rootFilterId: '16c91df8-c533-41bb-5a07-08dd45241022', // keep
            // add bottom tier filter legend here (used to name the hierarchy, EG: "qualifications")
            childFilterIds: [
              // remove
              '29cdafd8-f969-4487-5a08-08dd45241022',
              'd881a5bd-4a89-461b-5a09-08dd45241022',
            ],
            rootOptionIds: [
              // remove
