...
describe('formatPretty', () => {
  ...
  test('returns formatted string from string containing trailing zeroes', () => {
    ...
    expect(formatPretty('150000000.0000')).toBe('150,000,000.00');

    expect(formatPretty('150000000.10')).toBe('150,000,000.10');
    expect(formatPretty('150000000.100')).toBe('150,000,000.10');
    expect(formatPretty('150000000.1000')).toBe('150,000,000.10');
