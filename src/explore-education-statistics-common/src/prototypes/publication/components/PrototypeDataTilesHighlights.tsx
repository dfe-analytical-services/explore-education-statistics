          ...
          <form>
            ...
            <div className={styles.keyStat}>
              ...
              >
                ...
                <option value="Overall absence">Key - Overall absence</option>
              </select>
              ...
              <>
                <Details summary="Guidance text" open>
                  ...
                  <textarea
                    ...
                    rows={5}
                    placeholder={`${selectedKeyIndicator} is the adipisicing elit. Dolorum hic nobis voluptas quidem fugiat enim ipsa reprehenderit nulla.`}
                  />
                </Details>
                <button
                  type="button"
