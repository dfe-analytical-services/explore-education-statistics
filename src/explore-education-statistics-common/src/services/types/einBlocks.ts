...
export type EinBlockType = 'HtmlBlock' | 'GroupBlock';
export type EinContentBlock = EinHtmlBlock | EinGroupBlock;
...
export type EinGroupBlock = BaseBlock; // @MarkFix update and add subblocks
