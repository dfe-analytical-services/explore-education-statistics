...
import {Field, FieldProps, FormikFormProps, FormikProps, FormikValues} from 'formik';
...
const FormFieldFileSelector = <T extends {}>({name, form, error, formGroupClass, ...childProps}: Props<T>) => {
