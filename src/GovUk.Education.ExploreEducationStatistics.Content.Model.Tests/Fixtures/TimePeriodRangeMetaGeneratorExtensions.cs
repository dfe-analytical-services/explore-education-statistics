...
{
    public static Generator<TimePeriodRangeMeta> DefaultTimePeriodRangeMeta(
        this DataFixture fixture
    ) => fixture.Generator<TimePeriodRangeMeta>().WithDefaults();

    public static Generator<TimePeriodRangeMeta> WithDefaults(
    ...
    public static InstanceSetters<TimePeriodRangeMeta> SetDefaults(
    ...
    public static InstanceSetters<TimePeriodRangeMeta> SetStart(
        ...
        setters.Set(
            s => s.Start,
            new TimePeriodRangeBoundMeta { Period = period, TimeIdentifier = timeIdentifier }
        );
