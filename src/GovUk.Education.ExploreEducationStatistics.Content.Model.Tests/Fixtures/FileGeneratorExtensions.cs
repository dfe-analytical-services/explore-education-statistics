...
{
    public static Generator<File> DefaultFile(
        this DataFixture fixture,
        FileType? fileType = null
    ) => fixture.Generator<File>().WithDefaults(fileType);

    public static Generator<File> WithDefaults(
    ...
    public static InstanceSetters<File> SetDefaults(
    ...
    public static InstanceSetters<File> SetDataFileDefaults(this InstanceSetters<File> setters) =>
        setters
            ...
            .Set(
                f => f.DataSetFileMeta,
                (_, _, context) => context.Fixture.DefaultDataSetFileMeta()
            )
    ...
    public static InstanceSetters<File> SetAncillaryFileDefaults(
        this InstanceSetters<File> setters
    ) =>
        setters
            .SetDefaults()
