...
public static class UserGeneratorExtensions
{
    ...
    public static Generator<User> WithSoftDeleted(
        this Generator<User> generator,
    ...
    public static Generator<User> WithCreated(
        this Generator<User> generator,
        DateTimeOffset created
    ) => generator.ForInstance(d => d.SetCreated(created));

    public static Generator<User> WithCreatedById(
        this Generator<User> generator,
        Guid createdById
