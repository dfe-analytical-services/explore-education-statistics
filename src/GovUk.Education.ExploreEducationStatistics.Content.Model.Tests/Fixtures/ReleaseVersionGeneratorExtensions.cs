...
public static class ReleaseVersionGeneratorExtensions
{
    ...
    public static Generator<ReleaseVersion> WithIds(
        this Generator<ReleaseVersion> generator,
    ...
    [Obsolete(
        "Provide relationship with Publication via Release. This will be removed in EES-5818"
    )]
    ...
    public static Generator<ReleaseVersion> WithPublishScheduled(
        ...
        generator.ForInstance(releaseVersion =>
            releaseVersion.SetPublishScheduled(publishScheduled)
        );
    ...
    public static Generator<ReleaseVersion> WithPublishingOrganisations(
        ...
        generator.ForInstance(releaseVersion =>
            releaseVersion.SetPublishingOrganisations(publishingOrganisations)
        );
    ...
    {
        statuses.ForEach(
            (status, index) => generator.ForIndex(index, s => s.SetApprovalStatus(status))
        );
    ...
    public static Generator<ReleaseVersion> WithDataBlockVersions(
        ...
        generator.ForInstance(releaseVersion =>
            releaseVersion.SetDataBlockVersions(dataBlockVersions)
        );
    ...
    {
        return generator.ForInstance(releaseVersion =>
            releaseVersion.SetCreated(created, createdById)
        );
    }
    ...
    public static Generator<ReleaseVersion> WithPreviousVersionId(
        ...
        generator.ForInstance(releaseVersion =>
            releaseVersion.SetPreviousVersionId(previousVersionId)
        );
    ...
    public static Generator<ReleaseVersion> WithVersion(
        this Generator<ReleaseVersion> generator,
        int version
    ...
    public static Generator<ReleaseVersion> WithNotifySubscribers(
        ...
        generator.ForInstance(releaseVersion =>
            releaseVersion.SetNotifySubscribers(notifySubscribers)
        );
    ...
    public static Generator<ReleaseVersion> WithUpdatePublishedDate(
        ...
        generator.ForInstance(releaseVersion =>
            releaseVersion.SetUpdatePublishedDate(updatePublishedDate)
        );
    ...
    public static Generator<ReleaseVersion> WithPreReleaseAccessList(
        ...
        generator.ForInstance(releaseVersion =>
            releaseVersion.SetPreReleaseAccessList(preReleaseAccessList)
        );
    ...
    public static Generator<ReleaseVersion> WithRelatedInformation(
        ...
        generator.ForInstance(releaseVersion =>
            releaseVersion.SetRelatedInformation(relatedInformation)
        );
    ...
    public static Generator<ReleaseVersion> WithRelatedDashboardContent(
        ...
        generator.ForInstance(releaseVersion =>
            releaseVersion.SetRelatedDashboardsContent(content)
        );
                ...
                f =>
                    f.PickRandom(
                        EnumUtil
                            ...
                            .Except([ReleaseType.ExperimentalStatistics])
                    )
            )
    ...
    public static InstanceSetters<ReleaseVersion> SetPublishingOrganisations(
        ...
        setters.Set(
            releaseVersion => releaseVersion.PublishingOrganisations,
            publishingOrganisations.ToList()
        );
    ...
    public static InstanceSetters<ReleaseVersion> SetRelatedInformation(
        ...
        setters.Set(
            releaseVersion => releaseVersion.RelatedInformation,
            relatedInformation.ToList()
        );
