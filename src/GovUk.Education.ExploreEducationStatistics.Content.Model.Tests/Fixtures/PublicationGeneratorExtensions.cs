...
public static class PublicationGeneratorExtensions
{
    ...
    public static Generator<Publication> WithId(this Generator<Publication> generator, Guid id) =>
    ...
    public static Generator<Publication> WithContact(this Generator<Publication> generator, Contact contact) =>
    ...
    public static Generator<Publication> WithThemeId(this Generator<Publication> generator, Guid themeId) =>
        generator.ForInstance(s => s.SetThemeId(themeId));

    public static Generator<Publication> WithTheme(this Generator<Publication> generator, Theme theme) =>
    ...
    public static Generator<Publication> WithMethodologies(
        this Generator<Publication> generator,
        IReadOnlyList<PublicationMethodology> methodologies
    ...
    public static InstanceSetters<Publication> SetLatestPublishedReleaseVersion(
        ...
        setters
            .Set(p => p.LatestPublishedReleaseVersion, releaseVersion)
    ...
    public static Generator<Publication> WithThemes(this Generator<Publication> generator, IEnumerable<Theme> themes)
    {
        themes.ForEach((theme, index) => generator.ForIndex(index, s => s.SetTheme(theme)));
    ...
    private static InstanceSetters<Publication> SetReleases(
        ...
        setters
            ...
            .Set(
                ...
                (_, publication, context) =>
                    publication
                        .Releases.OrderByDescending(r => r.Year)
            ...
            .Set(
                p => p.LatestPublishedReleaseVersion,
                (_, publication, _) =>
                {
                    var releaseVersions = publication.Releases.SelectMany(r => r.Versions).ToList();
            ...
            .Set(
                p => p.LatestPublishedReleaseVersionId,
    ...
    public static InstanceSetters<Publication> SetSupersededBy(
        this InstanceSetters<Publication> setters,
        Publication? supersededBy
    ) => setters.Set(p => p.SupersededBy, supersededBy).SetSupersededById(supersededBy?.Id);
    ...
    private static InstanceSetters<Publication> SetMethodologies(
        ...
        setters
            .Set(p => p.Methodologies, methodologies)
            .Set(
                (_, publication, _) =>
                {
    ...
    public class ConditionalGeneratorDeclaration(bool condition, Generator<Publication> generator)
    {
        public Generator<Publication> Then(Func<Generator<Publication>, Generator<Publication>> action) =>
            condition ? action(generator) : generator;
    }
}
