...
public static class PublicationGeneratorExtensions
{
    ...
    public static InstanceSetters<Publication> SetDefaults(
            ...
            .Set(
                ...
                (_, publication, context) =>
                    publication
                        ...
                        .Select(release =>
                            context
                                .Fixture.DefaultReleaseSeriesItem()
            ...
            .Set(
                ...
                (_, publication, _) =>
                {
                    ...
                    return publishedVersions
                        ...
                        .ThenByDescending(releaseVersion =>
            ...
            (_, publication, context) =>
            {
                ...
                if (list.Any(rsi => !rsi.IsLegacyLink))
                {
                    throw new ArgumentException(
                        "List can only contain legacy links",
                        nameof(legacyLinks)
                    );
                }
    ...
    public static ConditionalGeneratorDeclaration If(
        this Generator<Publication> generator,
        bool condition
    ...
    {
        public Generator<Publication> Then(
            Func<Generator<Publication>, Generator<Publication>> action
