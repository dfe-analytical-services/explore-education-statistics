...
{
    public static Generator<UserPublicationInvite> DefaultUserPublicationInvite(
        this DataFixture fixture
    ) => fixture.Generator<UserPublicationInvite>().WithDefaults();

    public static Generator<UserPublicationInvite> WithDefaults(
        this Generator<UserPublicationInvite> generator
    ) => generator.ForInstance(s => s.SetDefaults());

    public static Generator<UserPublicationInvite> WithPublication(
        this Generator<UserPublicationInvite> generator,
        Publication publication
    ) => generator.ForInstance(s => s.SetPublication(publication));

    public static Generator<UserPublicationInvite> WithRole(
        this Generator<UserPublicationInvite> generator,
        PublicationRole role
    ) => generator.ForInstance(s => s.SetRole(role));

    public static Generator<UserPublicationInvite> WithRoles(
        this Generator<UserPublicationInvite> generator,
    ...
    public static InstanceSetters<UserPublicationInvite> SetDefaults(
