...
{
    public static Generator<PublicationRedirect> DefaultPublicationRedirect(
        this DataFixture fixture
    ) => fixture.Generator<PublicationRedirect>().WithDefaults();

    public static Generator<PublicationRedirect> WithDefaults(
        this Generator<PublicationRedirect> generator
    ) => generator.ForInstance(d => d.SetDefaults());

    public static InstanceSetters<PublicationRedirect> SetDefaults(
    ...
    public static InstanceSetters<PublicationRedirect> SetPublication(
        this InstanceSetters<PublicationRedirect> setters,
        Publication publication
    ) => setters.Set(pr => pr.Publication, publication).SetPublicationId(publication.Id);
