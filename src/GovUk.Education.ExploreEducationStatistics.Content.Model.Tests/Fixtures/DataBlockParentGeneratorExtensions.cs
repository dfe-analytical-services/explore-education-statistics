...
public static class DataBlockGeneratorExtensions
{
    ...
    public static Generator<DataBlockParent> WithDefaults(
    ...
    public static Generator<DataBlockParent> WithLatestPublishedVersion(
        ...
        generator.ForInstance(dataBlockParent =>
            dataBlockParent.SetLatestPublishedVersion(version)
        );
    ...
    public static InstanceSetters<DataBlockParent> SetDefaults(
