...
public static class ReleaseSeriesItemGeneratorExtensions
{
    ...
    public static Generator<ReleaseSeriesItem> DefaultLegacyReleaseSeriesItem(
        this DataFixture fixture
    ) => fixture.Generator<ReleaseSeriesItem>().WithLegacyDefaults();

    public static Generator<ReleaseSeriesItem> WithDefaults(
        this Generator<ReleaseSeriesItem> generator
    ) => generator.ForInstance(s => s.SetDefaults());

    public static Generator<ReleaseSeriesItem> WithLegacyDefaults(
        this Generator<ReleaseSeriesItem> generator
    ...
    public static InstanceSetters<ReleaseSeriesItem> SetDefaults(
        this InstanceSetters<ReleaseSeriesItem> setters
    ) => setters.SetDefault(rsi => rsi.Id);

    public static InstanceSetters<ReleaseSeriesItem> SetLegacyDefaults(
        this InstanceSetters<ReleaseSeriesItem> setters
    ) =>
        setters
            .SetDefaults()
