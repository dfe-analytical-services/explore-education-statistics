...
public static class DataBlockVersionGeneratorExtensions
{
    ...
    public static Generator<DataBlockVersion> WithDefaults(
    ...
    public static Generator<DataBlockVersion> WithOrder(
        this Generator<DataBlockVersion> generator,
        int order
    ) => generator.ForInstance(d => d.SetOrder(order));

    public static Generator<DataBlockVersion> WithVersion(
        this Generator<DataBlockVersion> generator,
        int version
    ...
    public static Generator<DataBlockVersion> WithName(
        this Generator<DataBlockVersion> generator,
        string? name
    ...
    public static InstanceSetters<DataBlockVersion> SetDefaults(
        ...
        setters
            ...
            .Set(
                d => d.ContentBlock,
                (_, dataBlockVersion) => new DataBlock { Id = dataBlockVersion.Id }
            )
