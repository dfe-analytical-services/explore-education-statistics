...
{
    public static Generator<Theme> DefaultTheme(this DataFixture fixture) => fixture.Generator<Theme>().WithDefaults();
    ...
    public static InstanceSetters<Theme> SetDefaults(this InstanceSetters<Theme> setters) =>
        setters.SetDefault(t => t.Id).SetDefault(t => t.Slug).SetDefault(t => t.Summary).SetDefault(t => t.Title);
    ...
    public static InstanceSetters<Theme> SetSlug(this InstanceSetters<Theme> setters, string slug) =>
        setters.Set(t => t.Slug, slug);

    public static InstanceSetters<Theme> SetSummary(this InstanceSetters<Theme> setters, string summary) =>
        setters.Set(t => t.Summary, summary);

    public static InstanceSetters<Theme> SetTitle(this InstanceSetters<Theme> setters, string title) =>
