...
public static class DataImportGeneratorExtensions
{
    ...
    public static Generator<DataImport> WithSubjectId(this Generator<DataImport> generator, Guid subjectId) =>
    ...
    public static Generator<DataImport> WithTotalRows(this Generator<DataImport> generator, int totalRows) =>
    ...
    public static InstanceSetters<DataImport> SetDefaults(this InstanceSetters<DataImport> setters) =>
        setters.SetDefault(d => d.Id).SetDefaultFiles("data");

    public static InstanceSetters<DataImport> SetSubjectId(this InstanceSetters<DataImport> setters, Guid subjectId) =>
    ...
    public static InstanceSetters<DataImport> SetDefaultFiles(
        ...
        setters
            .Set(
                ...
                (_, d, context) =>
                    context
                        .Fixture.DefaultFile(FileType.Data)
            ...
            .Set(
                ...
                (_, d, context) =>
                    context
                        .Fixture.DefaultFile(FileType.Metadata)
    ...
    public static InstanceSetters<DataImport> SetFile(this InstanceSetters<DataImport> setters, File file) =>
        setters.Set(d => d.File, file).Set(d => d.FileId, (_, d) => d.File.Id);
    ...
    public static InstanceSetters<DataImport> SetTotalRows(this InstanceSetters<DataImport> setters, int totalRows) =>
