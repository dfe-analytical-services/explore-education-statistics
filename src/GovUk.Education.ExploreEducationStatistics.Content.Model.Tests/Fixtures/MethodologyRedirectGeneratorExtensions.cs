...
public static class MethodologyRedirectGeneratorExtensions
{
    ...
    public static Generator<MethodologyRedirect> WithSlug(this Generator<MethodologyRedirect> generator, string slug) =>
    ...
    public static InstanceSetters<MethodologyRedirect> SetMethodologyVersion(
        this InstanceSetters<MethodologyRedirect> setters,
        MethodologyVersion methodologyVersion
    ) => setters.Set(mr => mr.MethodologyVersion, methodologyVersion).SetMethodologyVersionId(methodologyVersion.Id);
