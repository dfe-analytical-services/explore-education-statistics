...
{
    public static Generator<MethodologyRedirect> DefaultMethodologyRedirect(
        this DataFixture fixture
    ) => fixture.Generator<MethodologyRedirect>().WithDefaults();

    public static Generator<MethodologyRedirect> WithDefaults(
        this Generator<MethodologyRedirect> generator
    ) => generator.ForInstance(d => d.SetDefaults());

    public static InstanceSetters<MethodologyRedirect> SetDefaults(
    ...
    public static InstanceSetters<MethodologyRedirect> SetMethodologyVersion(
        ...
        setters
            .Set(mr => mr.MethodologyVersion, methodologyVersion)
