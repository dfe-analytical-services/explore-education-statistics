...
public static class ReleaseRedirectGeneratorExtensions
{
    ...
    public static Generator<ReleaseRedirect> WithSlug(this Generator<ReleaseRedirect> generator, string slug) =>
        generator.ForInstance(s => s.SetSlug(slug));

    public static Generator<ReleaseRedirect> WithRelease(this Generator<ReleaseRedirect> generator, Release release) =>
        generator.ForInstance(s => s.SetRelease(release));

    public static Generator<ReleaseRedirect> WithReleaseId(this Generator<ReleaseRedirect> generator, Guid releaseId) =>
