...
{
    public static Generator<UserPublicationRole> DefaultUserPublicationRole(
        this DataFixture fixture
    ) => fixture.Generator<UserPublicationRole>().WithDefaults();

    public static Generator<UserPublicationRole> WithDefaults(
    ...
    )
    {
        Publications.ForEach(
            (Publication, index) => generator.ForIndex(index, s => s.SetPublication(Publication))
        );

        return generator;
    }

    public static Generator<UserPublicationRole> WithUser(
        this Generator<UserPublicationRole> generator,
        User user
    ...
    public static InstanceSetters<UserPublicationRole> SetDefaults(
