...
{
    public static Generator<DataSetFileVersionGeographicLevel> DefaultDataSetFileVersionGeographicLevel(
        this DataFixture fixture
    ) => fixture.Generator<DataSetFileVersionGeographicLevel>().WithDefaults();

    public static Generator<DataSetFileVersionGeographicLevel> WithDefaults(
    ...
    ) => setters.SetDefault(p => p.DataSetFileVersionId);
