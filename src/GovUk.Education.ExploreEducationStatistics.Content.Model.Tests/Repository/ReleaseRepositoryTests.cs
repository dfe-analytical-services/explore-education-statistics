...
public class ReleaseRepositoryTests
{
    ...
    public class GetLatestPublishedReleaseVersionTests : ReleaseRepositoryTests
    {
        ...
        public async Task Success()
        {
            ...
            var expectedReleaseVersion = publications[0].Releases
                .Where(r => r is { Published: not null, Year: 2021 })
                .MaxBy(r => r.Version);
    ...
    private static async Task<string> AddTestData(Publication publication)
    {
        return await AddTestData(new List<Publication>
        {
            publication
        });
    }
