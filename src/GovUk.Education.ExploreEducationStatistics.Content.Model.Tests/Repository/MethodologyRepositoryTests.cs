...
namespace GovUk.Education.ExploreEducationStatistics.Content.Model.Tests.Repository
{
    ...
    {
        public class CreateMethodologyTests
        {
            [Fact]
        ...
        public class GetLatestByPublicationTests
        {
            [Fact]
        ...
        public class GetLatestPublishedByMethodologyParentTests
        {
            [Fact]
        ...
        public class GetLatestPublishedByPublicationTests
        {
            [Fact]
        ...
        public class IsPubliclyAccessibleTests
        {
            [Fact]
        ...
        public class PublicationTitleChangedTests
        {
            [Fact]
