...
{
    private static readonly string[] PublicApiDataSetVersionsSubPath =
    [
        "public-api",
        "data-set-versions",
    ];
    ...
    public string SourceDirectory =>
        pathResolver.BuildSourceDirectory(PublicApiDataSetVersionsSubPath);
    public string ReportsDirectory =>
        pathResolver.BuildReportsDirectory(PublicApiDataSetVersionsSubPath);
