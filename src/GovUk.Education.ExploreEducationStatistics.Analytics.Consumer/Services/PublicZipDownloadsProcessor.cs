...
namespace GovUk.Education.ExploreEducationStatistics.Analytics.Requests.Consumer.Services; // @MarkFix remove Requests

public class PublicZipDownloadsProcessor( // @MarkFix write tests for this
    ...
    ILogger<PublicZipDownloadsProcessor> logger) : IRequestFileProcessor
{
    public Task Process()
    {
        logger.LogInformation($"{nameof(PublicZipDownloadsProcessor)} triggered");
