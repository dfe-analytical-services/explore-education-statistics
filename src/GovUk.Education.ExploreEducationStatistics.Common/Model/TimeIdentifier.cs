...
using static GovUk.Education.ExploreEducationStatistics.Model.Database.TimePeriodLabelFormat;

namespace GovUk.Education.ExploreEducationStatistics.Model.Service
{
