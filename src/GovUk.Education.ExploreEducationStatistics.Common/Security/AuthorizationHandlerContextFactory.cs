...
{
    public static AuthorizationHandlerContext CreateAnonymousAuthContext<TRequirement, TResource>(
        TResource resource
    )
    ...
    public static AuthorizationHandlerContext CreateAuthContext<TRequirement>(
        ClaimsPrincipal user,
        object? resource
    )
        where TRequirement : IAuthorizationRequirement
