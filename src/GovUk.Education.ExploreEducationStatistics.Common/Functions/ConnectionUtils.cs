...
public static class ConnectionUtils
{
    ...
    {
        return GetConnectionString(name, $"{ConnectionTypeValues[ConnectionTypes.AZURE_STORAGE]}");
    }

    public static string GetAzureSqlConnectionString(string name)
    {
        return GetConnectionString(name, $"{ConnectionTypeValues[ConnectionTypes.AZURE_SQL]}");
    }

    public static string GetPostgreSqlConnectionString(string name)
    {
        return GetConnectionString(name, $"{ConnectionTypeValues[ConnectionTypes.AZURE_POSTGRESQL]}");
    }
