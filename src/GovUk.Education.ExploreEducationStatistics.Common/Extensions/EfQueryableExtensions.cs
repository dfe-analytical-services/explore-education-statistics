...
public static class EfQueryableExtensions
{
    ...
    /// leading comments.
    /// </returns>
    public static IQueryable<T> WithSqlServerOptions<T>(this IQueryable<T> source, string sqlOptionsString)
        where T : class? => source.TagWith($"WithOptions: {sqlOptionsString}");
}
