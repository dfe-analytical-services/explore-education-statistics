...
public static class GeographicLevelUtils
{
    private static readonly Lazy<IReadOnlyDictionary<GeographicLevel, GeographicCsvColumns>> GeographicLevelCsvColumns =
        new(() =>
            ...
            {
                { GeographicLevel.Country, new GeographicCsvColumns(Codes: ["country_code"], Name: "country_name") },
                {
                    GeographicLevel.EnglishDevolvedArea,
                    new GeographicCsvColumns(Codes: ["english_devolved_area_code"], Name: "english_devolved_area_name")
                },
                {
                ...
                },
                {
                    ...
                    new GeographicCsvColumns(Codes: ["opportunity_area_code"], Name: "opportunity_area_name")
                },
                {
                ...
                { GeographicLevel.Region, new GeographicCsvColumns(Codes: ["region_code"], Name: "region_name") },
                { GeographicLevel.RscRegion, new GeographicCsvColumns(Codes: [], Name: "rsc_region_lead_name") },
    ...
    public record SchoolCsvColumns() : GeographicCsvColumns(Codes: [Urn, LaEstab], Name: "school_name")
    {
    ...
    public record LocalAuthorityCsvColumns() : GeographicCsvColumns(Codes: [NewCode, OldCode], Name: "la_name")
    {
