...
public class FluentValidationLanguageManager : LanguageManager
{
    ...
    private static IEnumerable<Translation> Translations =>
        ...
        {
            new(
                Key: FluentValidationKeys.EmailValidator,
            ...
            new(
                Key: FluentValidationKeys.GreaterThanValidator,
                Message: "Must be greater than '{ComparisonValue}'."
            ),
            new(
            ...
            new(
                Key: FluentValidationKeys.LessThanValidator,
                Message: "Must be less than '{ComparisonValue}'."
            ),
            new(Key: FluentValidationKeys.NotEmptyValidator, Message: "Must not be empty."),
            new(
                Key: FluentValidationKeys.NotEqualValidator,
                Message: "Must not be equal to '{ComparisonValue}'."
            ),
            new(Key: FluentValidationKeys.NotNullValidator, Message: "Must not be empty."),
            new(
                Key: FluentValidationKeys.PredicateValidator,
                Message: "Must meet required condition."
            ),
            new(
                Key: FluentValidationKeys.AsyncPredicateValidator,
                Message: "Must meet required condition."
            ),
            new(
                Key: FluentValidationKeys.RegularExpressionValidator,
                Message: "Must be in correct format."
            ),
            new(
                Key: FluentValidationKeys.EqualValidator,
                Message: "Must be equal to '{ComparisonValue}'."
            ),
            new(
            ...
            new(
                Key: FluentValidationKeys.CreditCardValidator,
            ...
            new(
                Key: FluentValidationKeys.EnumValidator,
                Message: "Must be one of an allowed range of values."
            ),
        };
