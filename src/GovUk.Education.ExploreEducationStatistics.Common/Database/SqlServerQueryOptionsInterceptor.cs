...
/// aid with testing.
/// </param>
public class SqlServerQueryOptionsInterceptor(IQueryOptionsInterceptorSqlProcessor sqlProcessor) : DbCommandInterceptor
{
...
public partial class SqlServerQueryOptionsInterceptorSqlProcessor : IQueryOptionsInterceptorSqlProcessor
{
    ...
    private static readonly Regex LeadingCommentsRegex = LeadingCommentsRegexCompile();
    ...
    private static readonly Regex WithOptionsMarkerRegex = WithOptionsMarkerRegexCompile();
    ...
    public string Process(string sql)
    {
        ...
        if (bodyOptionMatch.Success)
        {
            ...
            var merged = existing.Concat(extractedItems).Distinct(StringComparer.OrdinalIgnoreCase).ToArray();
