...
public interface IDatabaseHelper
{
    ...
    /// changes to the database.
    /// </remarks>
    Task<TResult> DoInTransaction<TDbContext, TResult>(TDbContext context, Func<TDbContext, TResult> transactionalUnit)
        where TDbContext : DbContext;
    ...
    /// or rolled back.
    /// </summary>
    Task ExecuteWithExclusiveLock<TDbContext>(TDbContext dbContext, string lockName, Func<TDbContext, Task> action)
        where TDbContext : DbContext;
}
